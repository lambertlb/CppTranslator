...
namespace UNNAMED
{
	...
	class x_typedefRaw;
	typedef PointerType<x_typedefRaw>	x_typedef;
	class x_typedef1Raw;
	typedef PointerType<x_typedef1Raw>	x_typedef1;
}
...
namespace CABlock_NS
{
	...
	typedef PointerType<TestStructRaw>	TestStruct;
	struct TestStruct2Raw;
	typedef PointerType<TestStruct2Raw>	TestStruct2;
	struct TestStruct3Raw;
	typedef PointerType<TestStruct3Raw>	TestStruct3;
	class AbstractRaw;
