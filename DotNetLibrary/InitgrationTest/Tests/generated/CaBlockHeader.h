...
namespace UNNAMED
{
	...
	class x_typedefRaw : public ObjectRaw
	{
		public:
	...
	class x_typedef1Raw : public ObjectRaw
	{
		public:
		TestNameEnu x_friend();
		x_typedef1Raw();
...
namespace CABlock_NS
{
	...
	class BasicTestRaw : public ObjectRaw
	{
		...
		void RefMethod(TestAbstractRaw x_data);
	...
	struct TestStructRaw : public ObjectRaw
	{
		Int32 x_data;
		TestStructRaw(Int32 x_i);
	};

	struct TestStruct2Raw : public ObjectRaw
	{
		Int32 x_data;
		TestStruct2Raw();
	};

	struct TestStruct3Raw : public ObjectRaw
	{
		TestStruct2 x_ts;
		TestStruct3Raw();
	};
