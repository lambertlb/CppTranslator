...
IL_0000:
		...
		Int32 month = DateTimeValue(x_dateTime).get_Month();
		Int32 day = DateTimeValue(x_dateTime).get_Day();
		Int32 year = DateTimeValue(x_dateTime).get_Year();
		Int32 hours = DateTimeValue(x_dateTime).get_Hour();
		Int32 minutes = DateTimeValue(x_dateTime).get_Minute();
		Int32 seconds = DateTimeValue(x_dateTime).get_Second();
		x_dateTime2 = DateTimeValue(x_dateTime).ToLocalTime();
		Int32 month2 = DateTimeValue(x_dateTime2).get_Month();
		Int32 day2 = DateTimeValue(x_dateTime2).get_Day();
		Int32 year2 = DateTimeValue(x_dateTime2).get_Year();
		Int32 hours2 = DateTimeValue(x_dateTime2).get_Hour();
		Int32 minutes2 = DateTimeValue(x_dateTime2).get_Minute();
		Int32 seconds2 = DateTimeValue(x_dateTime2).get_Second();
		DateTime utcTime = DateTimeValue(x_dateTime2).ToUniversalTime();
		this->CxAssert((DateTimeValue(utcTime).Equals(x_dateTime)));
