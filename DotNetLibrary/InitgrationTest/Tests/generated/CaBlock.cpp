...
namespace CABlock_NS
{
	...
	void BasicTestRaw::IfThenElseTest()
	{
		...
		CxAssert(x_field1 == 5);
		CxAssert(ObjectRaw::Equals(null,null));
	}
	...
	void EncodingTestRaw::EncodingMethodsTest()
	{
		...
		PointerType<EncodingRaw> x_aSCII = Encoding::ASCII;
...
','"',''','Â'};
	...
	void StringTestRaw::DoMiscTest()
	{
		...
		CxAssert(x_array != null && x_array->get_Length() == x_text2->get_Length());
	...
	void TimeTestRaw::TestTimeSpan()
	{
		...
		CxAssert(TimeSpanRaw::FromDays(22).Ticks == 19008000000000);
		CxAssert(TimeSpanRaw::FromHours(10).Ticks == 360000000000);
		CxAssert(TimeSpanRaw::FromMilliseconds(100).Ticks == 1000000);
		CxAssert(TimeSpanRaw::FromMinutes(25).Ticks == 15000000000);
		CxAssert(TimeSpanRaw::FromSeconds(18).Ticks == 180000000);
		x_timeSpan = TimeSpanRaw::FromTicks(6500000);
		CxAssert(x_timeSpan.Ticks == 6500000);
		x_timeSpan = ((TimeSpan)x_timeSpan).Negate();
		CxAssert(x_timeSpan.Ticks == -6500000);
		CxAssert(((TimeSpan)x_timeSpan).Subtract(x_timeSpan2).Ticks == -6500200);
		CxAssert(TimeSpanRaw::Parse(new StringRaw("1.1:1:1")).Ticks == 900610000000);
		CxAssert(TimeSpanRaw::Parse(new StringRaw("1.1:1:1.200")).Ticks == 900612000000);
		CxAssert(TimeSpanRaw::Parse(new StringRaw("1:1:1")).Ticks == 36610000000);
		CxAssert(TimeSpanRaw::Parse(new StringRaw("22")).Ticks == 19008000000000);
	...
	void TimeTestRaw::DateTimeMethodTests()
	{
		...
		CxAssert(((DateTime)x_dateTime).Add(x_timeSpan).Ticks == 631945674301000000);
		CxAssert(((DateTime)x_dateTime).AddDays(1.5).Ticks == 631946898301000000);
		CxAssert(((DateTime)x_dateTime).AddHours(2.5).Ticks == 631945692301000000);
		CxAssert(((DateTime)x_dateTime).AddMilliseconds(159).Ticks == 631945602302590000);
		CxAssert(((DateTime)x_dateTime).AddMinutes(3.2).Ticks == 631945604221000000);
		CxAssert(((DateTime)x_dateTime).AddMonths(5).Ticks == 632077794301000000);
		CxAssert(((DateTime)x_dateTime).AddSeconds(6.66).Ticks == 631945602367600000);
		CxAssert(((DateTime)x_dateTime).AddTicks(666).Ticks == 631945602301000666);
		...
		CxAssert(((DateTime)x_dateTime).Subtract(x_dateTime2).Ticks == 72000000000);
		...
		CxAssert(0.Ticks == 0);
		CxAssert(3155378975999999999.Ticks == 3155378975999999999);
		Object x_obj = 0;
