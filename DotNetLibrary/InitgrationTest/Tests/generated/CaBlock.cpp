...
namespace UNNAMED
{
	TestNameEnu x_typedef::get_Friend()
	{
		return x_friend;
	}
	void x_typedef::set_Friend(TestNameEnu x_value )
	{
		x_friend = x_value;
	}
	x_typedef::x_typedef()
	...
	TestNameEnu x_typedef1::x_friend()
	{
		return x_friend_TestNameEnu;
	}
	x_typedef1::x_typedef1()
	{
	}
}
...
namespace CABlock_NS
{
	...
	void ArrayTest::Test()
	{
		...
		CxAssert(!Int32Value(x_num4).Equals(0));
	...
	{
		CxAssert(Int32(x_int3dArray->GetLength(2))).Equals(4));
		CxAssert(Int32(x_int3dArray->GetLowerBound(2))).Equals(0));
		CxAssert(Int32(x_int3dArray->GetUpperBound(2))).Equals(3));
	...
	void ArrayTest::ArrayMethodTests()
	{
		...
		CxAssert(Int32(x_length)).Equals(16));
		CxAssert(Int32(x_int1dArray->get_Rank())).Equals(1));
		CxAssert(Int32(x_int2dArray->get_Rank())).Equals(2));
		CxAssert(Int32(x_int3dArray->get_Rank())).Equals(3));
		...
		CxAssert(Double(x_num)).Equals(22));
		CxAssert((22).Equals(x_double3dArray->GetValue(1,1,3)));
		...
		CxAssert(Double((*x_array2->Address(1)))).Equals(2));
		x_array2->SetValue(2,1);
		CxAssert(Double((*x_array2->Address(1)))).Equals(2));
	}
	...
	void BasicTest::FieldTest()
	{
		...
		CxAssert(Int32(x_num)).Equals(x_field1));
		Int32 x_num2 = x_basicTest->x_field1;
		CxAssert(Int32(x_num2)).Equals(x_basicTest->x_field1));
		DateTime x_maxValue = DateTime3155378975999999999);
		CxAssert((x_maxValue).Equals(DateTime3155378975999999999)));
	...
	void BasicTest::SwitchTest()
	{
		...
		CxAssert(Int32(x_num)).Equals(1));
		CxAssert(Int32(x_field1)).Equals(2));
	}
	void BasicTest::IfThenElseTest()
	{
		x_field1 = 1;
		if ( Int32(x_field1)).Equals(1) )
		{
			x_field1 = 2;
			if ( Int32(x_field1)).Equals(3) )
			{
				x_field1 = 4;
			}
			else
		...
		CxAssert(Int32(x_field1)).Equals(5));
		CxAssert(ObjectRaw::Equals(nullptr,nullptr));
	}
	void BasicTest::StructTest()
	{
		TestStruct x_ts = TestStruct(2);
		CxAssert(Int32(x_ts.get_Data())).Equals(2));
		x_ts.set_Data(3);
		CxAssert(Int32(x_ts.get_Data())).Equals(3));
		x_ts = x_ts + 1;
		CxAssert(Int32(x_ts.get_Data())).Equals(4));
		CxAssert(Int32(( x_ts & 1 ).get_Data())).Equals(0));
	}
	void BasicTest::StructTest2()
	{
		TestStruct3 x_testStruct = TestStruct3();
		x_testStruct.x_ts.x_data = 6;
		CxAssert(Int32(x_testStruct.x_ts.x_data)).Equals(6));
		x_ts3.x_ts.x_data = 7;
		CxAssert(Int32(x_ts3.x_ts.x_data)).Equals(7));
	}
	void BasicTest::VirtualMethodTest()
	{
		TestAbstract* x_testAbstract = new TestAbstract();
		CxAssert(Int32(x_testAbstract->MustImplement())).Equals(2));
		CxAssert(Int32(x_testAbstract->DidImplement())).Equals(1));
	}
	void BasicTest::PassByReferenceTest()
	{
		...
		RefMethod(x_data);
		CxAssert(Int32(x_data)).Equals(1));
		RefMethod(x_data2);
		CxAssert(Int64(x_data2.get_Ticks())).Equals(1000));
		RefMethod(x_data3);
		CxAssert(Int64(x_data3.get_Ticks())).Equals(1000));
		RefMethod(x_data4);
		CxAssert((x_data4)->Equals((new String("Test"))));
		RefMethod(x_data5);
		CxAssert(Int32(x_data5->MustImplement())).Equals(2));
	}
	void BasicTest::RefMethod(Int32&  x_data)
	{
		if ( Int32(x_data)).Equals(0) )
		{
			x_data = 1;
		}
	}
	...
	{
		x_typedef* x_typedef = new typedef();
	...
	BigEndianBitConverterTest::BigEndianBitConverterTest(CABlock* x_caBlock)
	{
		this->x_caBlock = x_caBlock;
	}
	void BigEndianBitConverterTest::Test()
	{
		...
		x_caBlock->Send((new String("Doing BigEndianBitConverterTest")));
		x_caBlock->Send((new String("\tDoing BigEndianBitConverterMethodsTest")));
		Array* x_array = (new Array(ByteType,44))->Initialize((Byte*) TestArray0);
		CxAssert(BigEndianBitConverterRaw::ToBoolean(x_array,0));
		CxAssert(Char(BigEndianBitConverterRaw::ToChar(x_array,1))).Equals('A'));
		CxAssert(Double(BigEndianBitConverterRaw::ToDouble(x_array,3))).Equals(66.66));
		CxAssert(Int16(BigEndianBitConverterRaw::ToInt16(x_array,11))).Equals(6666));
		CxAssert(Int32(BigEndianBitConverterRaw::ToInt32(x_array,13))).Equals(-6666));
		CxAssert(Int64(BigEndianBitConverterRaw::ToInt64(x_array,17))).Equals(666666666));
		CxAssert(Double(BigEndianBitConverterRaw::ToSingle(x_array,25))).Equals(55));
		CxAssert(UInt16(BigEndianBitConverterRaw::ToUInt16(x_array,29))).Equals(5555));
		CxAssert(UInt32(BigEndianBitConverterRaw::ToUInt32(x_array,31))).Equals(5555555));
		CxAssert(UInt64(BigEndianBitConverterRaw::ToUInt64(x_array,35))).Equals(555555555));
		CxAssert(Int64(BigEndianBitConverterRaw::DoubleToInt64Bits(7777))).Equals(4665272916630306816));
		CxAssert(Double(BigEndianBitConverterRaw::Int64BitsToDouble(4665272916630306816))).Equals(7777));
		...
		CompareBits(BigEndianBitConverterRaw::GetBytes(6666),11,x_array);
		...
		CompareBits(BigEndianBitConverterRaw::GetBytes(5555),29,x_array);
	...
	void BigEndianBitConverterTest::CompareBits(Array* x_converted,Int32 x_startingIndex,Array* x_bytes)
	{
		for ( Int32 x_i = 0 ;  x_i < x_converted->get_Length() ;   x_i++ )
		{
			CxAssert(Byte((*x_converted->Address(x_i)))).Equals((*x_bytes->Address(x_i + x_startingIndex))));
		}
	}
	void BigEndianBitConverterTest::CxAssert(Boolean x_x)
	{
		if ( !x_x )
		{
			x_caBlock->TestFailed((new String("BigEndianBitConverterTest Failed")));
		}
	}
	void BigEndianBitConverterTest::CxAssert(Boolean x_x,Boolean x_y)
	{
		if ( !(x_x).Equals(x_y) )
		{
			x_caBlock->TestFailed((new String("BigEndianBitConverterTest Failed")));
	...
	BigEndianBitConverterTest::BigEndianBitConverterTest()
	{
	}
	...
	void BooleanTest::RunBooleanTest()
	{
		Boolean x_flag = true;
		Object* x_obj = x_flag;
		CxAssert(Int32(x_flag.CompareTo(true))).Equals(0));
		CxAssert(Int32(x_flag.CompareTo(x_obj))).Equals(0));
		CxAssert(x_flag.Equals(true));
		CxAssert(BooleanRaw::Parse((new String("True"))));
		CxAssert(((new String("True")))->Equals(x_flag.ToString()));
		CxAssert((Boolean::FalseString)->Equals((new String("False"))));
		CxAssert((Boolean::TrueString)->Equals((new String("True"))));
	}
	void BooleanTest::BoolOperators()
	{
		...
		CxAssert(x_flag = ( !Byte(( ( x_flag ? 1 : 0 ) | 1 ))).Equals(0) ));
		CxAssert(x_flag = x_flag);
	}
	...
	void BufferTest::Test()
	{
		...
		{
			if ( !Int32((*x_in1dArray->Address(x_i)))).Equals((*x_out1dArray->Address(x_i))) )
			{
				x_x = false;
				break;
			}
	...
	{
		Byte x_b = 5;
		CxAssert(Int32((x_b).CompareTo(5))).Equals(0));
		CxAssert(Int32((x_b).CompareTo(5))).Equals(0));
		CxAssert((x_b).Equals(5));
		CxAssert((x_b).Equals(5));
		CxAssert(Byte(ByteRaw::Parse((new String("77"))))).Equals(77));
		CxAssert(((new String("5")))->Equals((x_b).ToString()));
		x_b = Byte255);
		CxAssert(Byte(Byte255))).Equals(x_b));
		x_b = 0;
		CxAssert(Byte(x_b)).Equals(0));
		String* x_text = (Byte255)).ToString();
		CxAssert((x_text)->Equals((new String("255"))));
		CxAssert(Byte(ByteRaw::Parse(x_text))).Equals(Byte255)));
		String* x_text2 = ( 0 ).ToString();
		CxAssert((x_text2)->Equals((new String("0"))));
		CxAssert(Byte(ByteRaw::Parse(x_text2))).Equals(0));
		Int32 x_num = 50;
		Byte x_b2 = x_num;
		Object* x_obj = x_num;
		Int32 x_num2 = x_obj;
		CxAssert(Byte(x_b2)).Equals(50));
		CxAssert(Int32(x_num2)).Equals(50));
		x_b2 = Byte255);
		x_b2 = ( x_b2 + 1 );
		CxAssert(Byte(x_b2)).Equals(0));
		Object* x_obj2 = 5;
	...
	void ByteTest::DoUnSignedMath()
	{
		...
		CxAssert(x_num <= x_b);
		x_num = x_num + x_b;
		CxAssert(Int32(x_num)).Equals(61));
		CxAssert(Int32(x_b + x_b2)).Equals(180));
		Byte x_b5 = ( x_b - x_b2 );
		CxAssert(Byte(x_b5)).Equals(196));
		CxAssert(Byte(( x_b - x_b2 ))).Equals(196));
		CxAssert(Int32(x_b3 * x_b4)).Equals(72));
		CxAssert(Int32(x_b2 / x_b)).Equals(2));
		CxAssert(Int32(x_b >> 2)).Equals(15));
		CxAssert(Int32(x_b << 1)).Equals(120));
		Int32 x_num2 = 11;
		CxAssert(Int32(x_num2 % 5)).Equals(1));
		x_num2 = 8;
		CxAssert(( x_num2 | 1 ) == 9);
		CxAssert(( x_num2 & 1 ) == 0);
		CxAssert(Int32(++x_num2)).Equals(9));
		CxAssert(Int32(--x_num2)).Equals(8));
		CxAssert(( x_num2 = x_num2 * 2 ) == 16);
		CxAssert(( x_num2 = x_num2 / 2 ) == 8);
		CxAssert(( x_num2 = x_num2 % 2 ) == 0);
		CxAssert(( x_num2 = x_num2 | 4 ) == 4);
		CxAssert(( x_num2 = x_num2 & 4 ) == 4);
		CxAssert(Int32(-x_b)).Equals(-60));
		CxAssert(Byte(x_b)).Equals(60));
		Byte x_b6 = 0;
		CxAssert(Byte(( ~x_b6 ))).Equals(Byte255)));
	...
	void ByteTest::ByteOperators()
	{
		...
		Float x_num7 = 1;
		Double x_num8 = 1;
		CxAssert(Byte(x_b)).Equals(66));
		CxAssert(Int32(x_b + x_c)).Equals(67));
		CxAssert(Int32(x_b + x_b2)).Equals(67));
		CxAssert(Int32(x_b + x_b3)).Equals(67));
		CxAssert(Int32(x_b + x_num)).Equals(67));
		CxAssert(Int32(x_b + x_num2)).Equals(67));
		CxAssert(Int64(x_b + x_num3)).Equals(67));
		CxAssert(Int32(x_b + x_num4)).Equals(67));
		CxAssert(UInt32(x_b + x_num5)).Equals(67));
		CxAssert(UInt64(x_b + x_num6)).Equals(67));
		CxAssert(Single(x_b + x_num7)).Equals(67));
		CxAssert(Double(x_b + x_num8)).Equals(67));
		CxAssert(Int32(x_b - x_c)).Equals(65));
		CxAssert(Int32(x_b - x_b2)).Equals(65));
		CxAssert(Int32(x_b - x_b3)).Equals(65));
		CxAssert(Int32(x_b - x_num)).Equals(65));
		CxAssert(Int32(x_b - x_num2)).Equals(65));
		CxAssert(Int64(x_b - x_num3)).Equals(65));
		CxAssert(Int32(x_b - x_num4)).Equals(65));
		CxAssert(UInt32(x_b - x_num5)).Equals(65));
		CxAssert(UInt64(x_b - x_num6)).Equals(65));
		CxAssert(Single(x_b - x_num7)).Equals(65));
		CxAssert(Double(x_b - x_num8)).Equals(65));
		CxAssert(Int32(x_b * x_c)).Equals(66));
		CxAssert(Int32(x_b * x_b2)).Equals(66));
		CxAssert(Int32(x_b * x_b3)).Equals(66));
		CxAssert(Int32(x_b * x_num)).Equals(66));
		CxAssert(Int32(x_b * x_num2)).Equals(66));
		CxAssert(Int64(x_b * x_num3)).Equals(66));
		CxAssert(Int32(x_b * x_num4)).Equals(66));
		CxAssert(UInt32(x_b * x_num5)).Equals(66));
		CxAssert(UInt64(x_b * x_num6)).Equals(66));
		CxAssert(Single(x_b * x_num7)).Equals(66));
		CxAssert(Double(x_b * x_num8)).Equals(66));
		CxAssert(Int32(x_b / x_c)).Equals(66));
		CxAssert(Int32(x_b / x_b2)).Equals(66));
		CxAssert(Int32(x_b / x_b3)).Equals(66));
		CxAssert(Int32(x_b / x_num)).Equals(66));
		...
		CxAssert(Single(x_b / x_num7)).Equals(66));
		CxAssert(Double(x_b / x_num8)).Equals(66));
		CxAssert(Int32(x_b % x_c)).Equals(0));
		CxAssert(Int32(x_b % x_b2)).Equals(0));
		CxAssert(Int32(x_b % x_b3)).Equals(0));
		CxAssert(Int32(x_b % x_num)).Equals(0));
		CxAssert(Int32(x_b % x_num2)).Equals(0));
		CxAssert(Int64(x_b % x_num3)).Equals(0));
		CxAssert(Int32(x_b % x_num4)).Equals(0));
		CxAssert(UInt32(x_b % x_num5)).Equals(0));
		CxAssert(UInt64(x_b % x_num6)).Equals(0));
		CxAssert(Single(x_b % x_num7)).Equals(0));
		CxAssert(Double(x_b % x_num8)).Equals(0));
		CxAssert(( x_b & x_c ) == 0);
		CxAssert(( x_b & x_b2 ) == 0);
		CxAssert(( x_b & x_b3 ) == 0);
		...
		CxAssert(Byte(x_b++)).Equals(66));
		CxAssert(Byte(x_b--)).Equals(67));
		CxAssert(Int32(x_b << 1)).Equals(132));
		CxAssert(Int32(x_b >> 1)).Equals(33));
		CxAssert(Char(x_c)).Equals(x_b),false);
		CxAssert(Byte(x_b2)).Equals(x_b),false);
		CxAssert(SByte(x_b3)).Equals(x_b),false);
		CxAssert(Int16(x_num)).Equals(x_b),false);
		CxAssert(Int32(x_num2)).Equals(x_b),false);
		CxAssert(Int64(x_num3)).Equals(x_b),false);
		CxAssert(UInt16(x_num4)).Equals(x_b),false);
		CxAssert(UInt32(x_num5)).Equals(x_b),false);
		CxAssert(UInt64(x_num6)).Equals(x_b),false);
		CxAssert(Single(x_num7)).Equals(x_b),false);
		CxAssert(Double(x_num8)).Equals(x_b),false);
		CxAssert(!Char(x_c)).Equals(x_b));
		CxAssert(!Byte(x_b2)).Equals(x_b));
		CxAssert(!SByte(x_b3)).Equals(x_b));
		CxAssert(!Int16(x_num)).Equals(x_b));
		CxAssert(!Int32(x_num2)).Equals(x_b));
		CxAssert(!Int64(x_num3)).Equals(x_b));
		CxAssert(!UInt16(x_num4)).Equals(x_b));
		CxAssert(!UInt32(x_num5)).Equals(x_b));
		CxAssert(!UInt64(x_num6)).Equals(x_b));
		CxAssert(!Single(x_num7)).Equals(x_b));
		CxAssert(!Double(x_num8)).Equals(x_b));
		CxAssert(x_c <= x_b);
		CxAssert(x_b2 <= x_b);
		CxAssert(x_b3 <= x_b);
		CxAssert(x_num <= x_b);
	...
	void ByteTest::ByteArrayTests()
	{
		...
		{
			(*x_array->Address(x_i)) = x_i;
		}
		for ( Int32 x_j = 0 ;  x_j < 10 ;   x_j++ )
		{
			(*x_array2->Address(x_j)) = (*x_array->Address(x_j));
		}
		CxAssert(Byte((*x_array2->Address(0)))).Equals(0));
		CxAssert(Byte((*x_array2->Address(9)))).Equals(9));
		...
		CxAssert(Int32((*x_array3->Address(0)))).Equals(16843009));
		CxAssert(Int32((*x_array3->Address(9)))).Equals(16843009));
		Array* x_array4 = (new Array(ByteType,5))->Initialize((Byte*) ByteArrayTestsArray0);
		CxAssert(Int32(x_array4->get_Length())).Equals(5));
		CxAssert(Byte((*x_array4->Address(3)))).Equals(4));
		Array* x_array5 = (new Array(ByteType,4))->Initialize((Byte*) ByteArrayTestsArray1);
		CxAssert(Byte((*x_array5->Address(1)))).Equals(2));
		Array* x_array6 = (new Array(ByteType,2,4))->Initialize((Byte*) ByteArrayTestsArray2);
		CxAssert(Byte((*x_array6->Address(0,2)))).Equals(3));
		Array* x_array7 = (new Array(ByteType,2,2,4))->Initialize((Byte*) ByteArrayTestsArray3);
		CxAssert(Byte((*x_array7->Address(0,0,3)))).Equals(4));
		(*x_array7->Address(0,0,3)) = 6;
		CxAssert(Byte((*x_array7->Address(0,0,3)))).Equals(6));
		x_array7->SetValue(4,0,0,3);
		CxAssert(Byte((*x_array7->Address(0,0,3)))).Equals(4));
	}
	void ByteTest::ByteMiscTests()
	{
		Byte x_b = 0;
		Byte x_val = 1;
		CxAssert(Byte(MathRaw::Max(x_b,x_val))).Equals(1));
		CxAssert(Byte(MathRaw::Min(x_b,x_val))).Equals(0));
	...
	void CharTest::CharMethodsTest()
	{
		...
		Char x_c = 'A';
		CxAssert((x_c).CompareTo('B') < 0);
		CxAssert((x_c).Equals('A'));
		Double x_numericValue = CharRaw::GetNumericValue('5');
		CxAssert(Double(x_numericValue)).Equals(5));
		x_numericValue = CharRaw::GetNumericValue(x_s,2);
		CxAssert(Double(x_numericValue)).Equals(3));
		...
		CxAssert(Char(CharRaw::ToLower('A'))).Equals('a'));
		CxAssert(Char(CharRaw::ToUpper('a'))).Equals('A'));
		CxAssert((new String("a"))->Equals(('a').ToString()));
		CxAssert((new String("a"))->Equals(CharRaw::ToString('a')));
		CxAssert(('a').Equals(CharRaw::Parse((new String("a")))));
		Object* x_obj = x_c;
		CxAssert(('A').Equals(x_obj));
		CxAssert(('A').Equals(x_obj));
		CxAssert(Int32(('A').CompareTo(x_obj))).Equals(0));
	...
	void CharTest::CharOperators()
	{
		...
		Int64 x_num3 = 1;
		Double x_num4 = 1;
		CxAssert(Char(x_c)).Equals('B'));
		CxAssert(Int32(x_c + x_c2)).Equals(67));
		CxAssert(Int32(x_c + x_num)).Equals(67));
		CxAssert(UInt32(x_c + x_num2)).Equals(67));
		CxAssert(Int64(x_c + x_num3)).Equals(67));
		CxAssert(Double(x_c + x_num4)).Equals(67));
		CxAssert(Int32(x_c - x_c2)).Equals(65));
		CxAssert(Int32(x_c - x_num)).Equals(65));
		CxAssert(UInt32(x_c - x_num2)).Equals(65));
		CxAssert(Int64(x_c - x_num3)).Equals(65));
		CxAssert(Double(x_c - x_num4)).Equals(65));
		CxAssert(Int32(x_c * x_c2)).Equals(66));
		CxAssert(Int32(x_c * x_num)).Equals(66));
		CxAssert(UInt32(x_c * x_num2)).Equals(66));
		CxAssert(Int64(x_c * x_num3)).Equals(66));
		CxAssert(Double(x_c * x_num4)).Equals(66));
		CxAssert(Int32(x_c / x_c2)).Equals(66));
		CxAssert(Int32(x_c / x_num)).Equals(66));
		CxAssert(UInt32(x_c / x_num2)).Equals(66));
		CxAssert(Int64(x_c / x_num3)).Equals(66));
		CxAssert(Double(x_c / x_num4)).Equals(66));
		CxAssert(Int32(x_c % x_c2)).Equals(0));
		CxAssert(Int32(x_c % x_num)).Equals(0));
		CxAssert(UInt32(x_c % x_num2)).Equals(0));
		CxAssert(Int64(x_c % x_num3)).Equals(0));
		CxAssert(Double(x_c % x_num4)).Equals(0));
		CxAssert(( x_c & x_c2 ) == 0);
		...
		CxAssert(Char(x_c++)).Equals('B'));
		CxAssert(Char(x_c--)).Equals('C'));
		CxAssert(UInt32(x_c << 1)).Equals(132));
		CxAssert(Int32(x_c >> 1)).Equals(33));
		CxAssert(Char(x_c2)).Equals(x_c),false);
		CxAssert(Int32(x_num)).Equals(x_c),false);
		CxAssert(UInt32(x_num2)).Equals(x_c),false);
		CxAssert(Int64(x_num3)).Equals(x_c),false);
		CxAssert(Double(x_num4)).Equals(x_c),false);
		CxAssert(!Char(x_c2)).Equals(x_c));
		CxAssert(!Int32(x_num)).Equals(x_c));
		CxAssert(!UInt32(x_num2)).Equals(x_c));
		CxAssert(!Int64(x_num3)).Equals(x_c));
		CxAssert(!Double(x_num4)).Equals(x_c));
		CxAssert(x_c2 <= x_c);
		CxAssert(x_num <= x_c);
		CxAssert(x_num2 <= x_c);
		CxAssert(x_num3 <= x_c);
	...
	void CharTest::CharArrayTests()
	{
		...
		CxAssert(Int32(x_array->get_Length())).Equals(5));
		CxAssert(Char((*x_array->Address(3)))).Equals('4'));
		Array* x_array2 = (new Array(CharType,4))->Initialize((Char*) CharArrayTestsArray1);
		CxAssert(Char((*x_array2->Address(1)))).Equals('2'));
		Array* x_array3 = (new Array(CharType,2,4))->Initialize((Char*) CharArrayTestsArray2);
		CxAssert(Char((*x_array3->Address(0,2)))).Equals('3'));
		Array* x_array4 = (new Array(CharType,2,2,4))->Initialize((Char*) CharArrayTestsArray3);
		CxAssert(Char((*x_array4->Address(0,0,3)))).Equals('4'));
		(*x_array4->Address(0,0,3)) = '6';
		CxAssert(Char((*x_array4->Address(0,0,3)))).Equals('6'));
	...
	void CharTest::CharMiscTests()
	{
		Char x_c = '0';
		Char x_val = '1';
		CxAssert(UInt16(MathRaw::Max(x_c,x_val))).Equals(49));
		CxAssert(UInt16(MathRaw::Min(x_c,x_val))).Equals(48));
		StringBuilder* x_stringBuilder = new StringBuilder();
	...
	{
		Double x_num = 3.159;
		CxAssert(Int32((x_num).CompareTo(3.159))).Equals(0));
		CxAssert(Int32((x_num).CompareTo(3.159))).Equals(0));
		CxAssert((x_num).Equals(3.159));
		CxAssert(Double(DoubleRaw::Parse((new String("3.159"))))).Equals(3.159));
		CxAssert(((x_num).ToString())->Equals((new String("3.159"))));
		...
		Object* x_obj = x_num;
		CxAssert(Double(x_obj)).Equals(10000));
		x_num = Double::Epsilon;
		CxAssert(Double(x_num)).Equals(Double::Epsilon));
		x_num = Double1.79769313486232E+308);
		CxAssert(Double(x_num)).Equals(Double1.79769313486232E+308)));
		x_num = Double-1.79769313486232E+308);
		CxAssert(Double(x_num)).Equals(Double-1.79769313486232E+308)));
		x_obj = 5;
	...
	void DoubleTest::DoDoubleMath()
	{
		...
		CxAssert(Double(x_num2)).Equals(2));
		x_num = 2;
	...
	void DoubleTest::DoubleOperators()
	{
		...
		Int64 x_num4 = 1;
		Double x_num5 = 1;
		CxAssert(Double(x_num)).Equals(66));
		CxAssert(Double(x_num + x_c)).Equals(67));
		CxAssert(Double(x_num + x_num2)).Equals(67));
		CxAssert(Double(x_num + x_num3)).Equals(67));
		CxAssert(Double(x_num + x_num4)).Equals(67));
		CxAssert(Double(x_num + x_num5)).Equals(67));
		CxAssert(Double(x_num - x_c)).Equals(65));
		CxAssert(Double(x_num - x_num2)).Equals(65));
		CxAssert(Double(x_num - x_num3)).Equals(65));
		CxAssert(Double(x_num - x_num4)).Equals(65));
		CxAssert(Double(x_num - x_num5)).Equals(65));
		CxAssert(Double(x_num * x_c)).Equals(66));
		CxAssert(Double(x_num * x_num2)).Equals(66));
		CxAssert(Double(x_num * x_num3)).Equals(66));
		CxAssert(Double(x_num * x_num4)).Equals(66));
		...
		CxAssert(Double(x_num / x_num4)).Equals(66));
		CxAssert(Double(x_num / x_num5)).Equals(66));
		CxAssert(Double(x_num % x_c)).Equals(0));
		CxAssert(Double(x_num % x_num2)).Equals(0));
		CxAssert(Double(x_num % x_num3)).Equals(0));
		CxAssert(Double(x_num % x_num4)).Equals(0));
		...
		CxAssert(Double(x_num++)).Equals(66));
		CxAssert(Double(x_num--)).Equals(67));
		CxAssert(Double(x_c)).Equals(x_num),false);
		...
		CxAssert(Double(x_num5)).Equals(x_num),false);
		CxAssert(!Double(x_c)).Equals(x_num));
		CxAssert(!Double(x_num2)).Equals(x_num));
		CxAssert(!Double(x_num3)).Equals(x_num));
		CxAssert(!Double(x_num4)).Equals(x_num));
		CxAssert(!Double(x_num5)).Equals(x_num));
		CxAssert(x_c <= x_num);
		CxAssert(x_num2 <= x_num);
		CxAssert(x_num3 <= x_num);
		CxAssert(x_num4 <= x_num);
	...
	void DoubleTest::DoubleNanTest()
	{
		...
		CxAssert(x_num <= x_num2,false);
		CxAssert(x_num >= x_num2,false);
		CxAssert(Double(x_num)).Equals(x_num2),false);
		CxAssert(Double(x_num)).Equals(x_num),false);
		CxAssert(x_num2 < x_num,false);
		CxAssert(x_num2 > x_num,false);
		CxAssert(x_num2 <= x_num,false);
		CxAssert(x_num2 >= x_num,false);
		CxAssert(!Double(x_num)).Equals(x_num2));
		CxAssert(!Double(x_num)).Equals(x_num));
		x_num = Double::NaN;
		x_num2 = Double::NaN;
		if ( Double(x_num)).Equals(x_num2) )
		{
			DoubleTestFailed();
		}
		else
		...
		CxAssert((Double::NaN).Equals(Double::NaN));
	}
	...
	void DoubleTest::DoubleMiscTests()
	{
		Double x_num = -1;
		Double x_val = 1;
		CxAssert(Double(MathRaw::Abs(x_num))).Equals(1));
		CxAssert(Double(MathRaw::Max(x_num,x_val))).Equals(1));
		CxAssert(Double(MathRaw::Min(x_num,x_val))).Equals(-1));
	...
	void EncodingTest::EncodingMethodsTest()
	{
		...
		CxAssert(Int32(x_aSCII->GetByteCount(x_s))).Equals(7));
		...
		CxAssert(Int32(x_aSCII->GetByteCount(x_s2))).Equals(13));
	...
	Boolean EncodingTest::CompareBytes(Array* x_bytes,Array* x_myCharsAsBytes)
	{
		...
		{
			if ( !Byte((*x_bytes->Address(x_i)))).Equals((*x_myCharsAsBytes->Address(x_i))) )
			{
				return false;
			}
		}
	...
	void EnumTest::Test1(TestEnum x_testEnum)
	{
		...
		if ( !Int32(x_num)).Equals(5) )
		{
			EnumTestFailed();
		}
		Double x_num2 = x_testEnum;
		if ( !Double(x_num2)).Equals(5) )
		{
			EnumTestFailed();
		}
	}
	...
	void CABlock::RunTests(FredEnum x_fre)
	{
		...
		x_encodingTest->Test();
		BigEndianBitConverterTest* x_bigEndianBitConverterTest = new BigEndianBitConverterTest(this);
	...
	void Int16Test::Int16MethodsTest()
	{
		...
		CxAssert(Int32((x_num).CompareTo(5))).Equals(0));
		CxAssert((x_num).Equals(5));
		CxAssert((x_num).Equals(5));
		CxAssert(Int16(Int16Raw::Parse((new String("-55"))))).Equals(-55));
		CxAssert(((new String("-75")))->Equals(( -75 ).ToString()));
		String* x_text = (Int1632767)).ToString();
		CxAssert((x_text)->Equals((new String("32767"))));
		CxAssert(Int16(Int16Raw::Parse(x_text))).Equals(Int1632767)));
		String* x_text2 = (Int16-32768)).ToString();
		CxAssert((x_text2)->Equals((new String("-32768"))));
		CxAssert(Int16(Int16Raw::Parse(x_text2))).Equals(Int16-32768)));
		Int64 x_num2 = Int649223372036854775807);
		x_num = x_num2;
		CxAssert(Int16(x_num)).Equals(-1));
		Object* x_obj = 5;
		CxAssert(x_obj->Equals(5));
		CxAssert((x_obj->ToString())->Equals((new String("5"))));
	}
	void Int16Test::Int16MathTest()
	{
		Int16 x_num = 600;
		Int16 x_num2 = 1200;
		CxAssert(Int32(x_num + x_num2)).Equals(1800));
		CxAssert(Int32(x_num - x_num2)).Equals(-600));
		CxAssert(Int32(x_num * x_num2)).Equals(720000));
		CxAssert(Int32(x_num2 / x_num)).Equals(2));
		CxAssert(Int32(x_num >> 2)).Equals(150));
		CxAssert(Int32(x_num << 1)).Equals(1200));
		Int32 x_num3 = 11;
		CxAssert(Int32(x_num3 % 5)).Equals(1));
		x_num3 = 8;
		CxAssert(( x_num3 | 1 ) == 9);
		CxAssert(( x_num3 & 1 ) == 0);
		CxAssert(Int32(++x_num3)).Equals(9));
		CxAssert(Int32(--x_num3)).Equals(8));
		CxAssert(( x_num3 = x_num3 * 2 ) == 16);
		CxAssert(( x_num3 = x_num3 / 2 ) == 8);
		CxAssert(( x_num3 = x_num3 % 2 ) == 0);
		CxAssert(( x_num3 = x_num3 | 4 ) == 4);
		CxAssert(( x_num3 = x_num3 & 4 ) == 4);
		CxAssert(Int32(-x_num)).Equals(-600));
		CxAssert(Int16(x_num)).Equals(600));
		x_num3 = 0;
		CxAssert(Int32(~x_num3)).Equals(-1));
		CxAssert(Int32(++x_num3)).Equals(1));
		CxAssert(Int32(--x_num3)).Equals(0));
	...
	void Int16Test::Int16Operators()
	{
		...
		Float x_num7 = 1;
		Double x_num8 = 1;
		CxAssert(Int16(x_num)).Equals(66));
		CxAssert(Int32(x_num + x_c)).Equals(67));
		CxAssert(Int32(x_num + x_b)).Equals(67));
		CxAssert(Int32(x_num + x_b2)).Equals(67));
		CxAssert(Int32(x_num + x_num2)).Equals(67));
		CxAssert(Int32(x_num + x_num3)).Equals(67));
		CxAssert(Int64(x_num + x_num4)).Equals(67));
		CxAssert(Int32(x_num + x_num5)).Equals(67));
		CxAssert(Int64(x_num + x_num6)).Equals(67));
		CxAssert(Single(x_num + x_num7)).Equals(67));
		CxAssert(Double(x_num + x_num8)).Equals(67));
		CxAssert(Int32(x_num - x_c)).Equals(65));
		CxAssert(Int32(x_num - x_b)).Equals(65));
		CxAssert(Int32(x_num - x_b2)).Equals(65));
		CxAssert(Int32(x_num - x_num2)).Equals(65));
		CxAssert(Int32(x_num - x_num3)).Equals(65));
		CxAssert(Int64(x_num - x_num4)).Equals(65));
		CxAssert(Int32(x_num - x_num5)).Equals(65));
		CxAssert(Int64(x_num - x_num6)).Equals(65));
		CxAssert(Single(x_num - x_num7)).Equals(65));
		CxAssert(Double(x_num - x_num8)).Equals(65));
		CxAssert(Int32(x_num * x_c)).Equals(66));
		CxAssert(Int32(x_num * x_b)).Equals(66));
		CxAssert(Int32(x_num * x_b2)).Equals(66));
		CxAssert(Int32(x_num * x_num2)).Equals(66));
		CxAssert(Int32(x_num * x_num3)).Equals(66));
		CxAssert(Int64(x_num * x_num4)).Equals(66));
		CxAssert(Int32(x_num * x_num5)).Equals(66));
		CxAssert(Int64(x_num * x_num6)).Equals(66));
		CxAssert(Single(x_num * x_num7)).Equals(66));
		...
		CxAssert(Single(x_num / x_num7)).Equals(66));
		CxAssert(Double(x_num / x_num8)).Equals(66));
		CxAssert(Int32(x_num % x_c)).Equals(0));
		CxAssert(Int32(x_num % x_b)).Equals(0));
		CxAssert(Int32(x_num % x_b2)).Equals(0));
		CxAssert(Int32(x_num % x_num2)).Equals(0));
		CxAssert(Int32(x_num % x_num3)).Equals(0));
		CxAssert(Int64(x_num % x_num4)).Equals(0));
		CxAssert(Int32(x_num % x_num5)).Equals(0));
		CxAssert(Int64(x_num % x_num6)).Equals(0));
		CxAssert(Single(x_num % x_num7)).Equals(0));
		...
		CxAssert(( x_num ^ x_num5 ) == 67);
		CxAssert(( x_num ^ x_num6 ) == 67);
		CxAssert(Int32(~x_num)).Equals(-67));
		CxAssert(x_c < x_num);
		CxAssert(x_b < x_num);
		CxAssert(x_b2 < x_num);
		CxAssert(x_num2 < x_num);
		...
		CxAssert(( x_num = ( x_num - 1 ) ) == 66);
		CxAssert(Int16(x_num++)).Equals(66));
		CxAssert(Int16(x_num--)).Equals(67));
		CxAssert(Int32(x_num << 1)).Equals(132));
		CxAssert(Int32(x_num >> 1)).Equals(33));
		CxAssert(Char(x_c)).Equals(x_num),false);
		CxAssert(Byte(x_b)).Equals(x_num),false);
		CxAssert(SByte(x_b2)).Equals(x_num),false);
		CxAssert(Int16(x_num2)).Equals(x_num),false);
		CxAssert(Int32(x_num3)).Equals(x_num),false);
		CxAssert(Int64(x_num4)).Equals(x_num),false);
		CxAssert(UInt16(x_num5)).Equals(x_num),false);
		CxAssert(UInt32(x_num6)).Equals(x_num),false);
		CxAssert(Single(x_num7)).Equals(x_num),false);
		CxAssert(Double(x_num8)).Equals(x_num),false);
		CxAssert(!Char(x_c)).Equals(x_num));
		CxAssert(!Byte(x_b)).Equals(x_num));
		CxAssert(!SByte(x_b2)).Equals(x_num));
		CxAssert(!Int16(x_num2)).Equals(x_num));
		CxAssert(!Int32(x_num3)).Equals(x_num));
		CxAssert(!Int64(x_num4)).Equals(x_num));
		CxAssert(!UInt16(x_num5)).Equals(x_num));
		CxAssert(!UInt32(x_num6)).Equals(x_num));
		CxAssert(!Single(x_num7)).Equals(x_num));
		CxAssert(!Double(x_num8)).Equals(x_num));
		CxAssert(x_c <= x_num);
		CxAssert(x_b <= x_num);
		CxAssert(x_b2 <= x_num);
		CxAssert(x_num2 <= x_num);
		...
		x_num = 66;
		Int16 x_num9 = 0;
		CxAssert(Int16(x_num9)).Equals(0));
		CxAssert(Int16(x_num9)).Equals(0));
		CxAssert(x_num3 <= 2);
		CxAssert(x_num3 >= -2);
	}
	...
	void Int16Test::Int16MiscTests()
	{
		Int16 x_num = -1;
		Int16 x_val = 1;
		CxAssert(Int16(MathRaw::Abs(x_num))).Equals(1));
		CxAssert(Int16(MathRaw::Max(x_num,x_val))).Equals(1));
		CxAssert(Int16(MathRaw::Min(x_num,x_val))).Equals(-1));
		CxAssert(MathRaw::Sign(x_num) < 0);
		StringBuilder* x_stringBuilder = new StringBuilder();
		x_stringBuilder->Append(x_num);
		CxAssert((x_stringBuilder->ToString())->Equals((new String("-1"))));
	...
	void Int32Test::Int32Conversion()
	{
		...
		Int32 x_num3 = x_num;
		CxAssert(Int32(x_num3)).Equals(3));
	}
	void Int32Test::Int32MethodsTest()
	{
		...
		CxAssert((x_num).Equals(5));
		CxAssert((x_num).Equals(5));
		CxAssert(Int32(Int32Raw::Parse((new String("-55"))))).Equals(-55));
		CxAssert(((new String("-75")))->Equals(( -75 ).ToString()));
		String* x_text = (Int322147483647)).ToString();
		CxAssert((x_text)->Equals((new String("2147483647"))));
		CxAssert(Int32(Int32Raw::Parse(x_text))).Equals(Int322147483647)));
		String* x_text2 = (Int32-2147483648)).ToString();
		CxAssert((x_text2)->Equals((new String("-2147483648"))));
		CxAssert(Int32(Int32Raw::Parse(x_text2))).Equals(Int32-2147483648)));
		Int64 x_num2 = Int649223372036854775807);
		x_num = x_num2;
		CxAssert(Int32(x_num)).Equals(-1));
		Object* x_obj = 5;
	...
	void Int32Test::Int32MathTest()
	{
		Int32 x_num = 60000;
		Int32 x_num2 = 120000;
		CxAssert(Int32(x_num + x_num2)).Equals(180000));
		CxAssert(Int32(x_num - x_num2)).Equals(-60000));
		CxAssert(Int32(x_num * x_num2)).Equals(-1389934592));
		CxAssert(Int32(x_num2 / x_num)).Equals(2));
		CxAssert(Int32(x_num >> 2)).Equals(15000));
		CxAssert(Int32(x_num << 1)).Equals(120000));
		Int32 x_num3 = 11;
		CxAssert(Int32(x_num3 % 5)).Equals(1));
		x_num3 = 8;
		CxAssert(( x_num3 | 1 ) == 9);
		...
		CxAssert(( x_num3 = x_num3 | 4 ) == 4);
		CxAssert(( x_num3 = x_num3 & 4 ) == 4);
		CxAssert(Int32(-x_num)).Equals(-60000));
		CxAssert(Int32(x_num)).Equals(60000));
		x_num3 = 0;
		CxAssert(Int32(~x_num3)).Equals(-1));
		CxAssert(Int32(++x_num3)).Equals(1));
	...
	void Int32Test::Int32Operators()
	{
		...
		Int64 x_num4 = 1;
		Double x_num5 = 1;
		CxAssert(Int32(x_num)).Equals(66));
		CxAssert(Int32(x_num + x_c)).Equals(67));
		CxAssert(Int32(x_num + x_num2)).Equals(67));
		CxAssert(Int64(x_num + x_num3)).Equals(67));
		CxAssert(Int64(x_num + x_num4)).Equals(67));
		CxAssert(Int64(( x_num + x_num5 ))).Equals(67));
		CxAssert(Int32(x_num - x_c)).Equals(65));
		CxAssert(Int32(x_num - x_num2)).Equals(65));
		CxAssert(Int64(x_num - x_num3)).Equals(65));
		CxAssert(Int64(x_num - x_num4)).Equals(65));
		CxAssert(Int64(( x_num - x_num5 ))).Equals(65));
		CxAssert(Int32(x_num * x_c)).Equals(66));
		CxAssert(Int32(x_num * x_num2)).Equals(66));
		CxAssert(Int64(x_num * x_num3)).Equals(66));
		CxAssert(Int64(x_num * x_num4)).Equals(66));
		CxAssert(Int64(( x_num * x_num5 ))).Equals(66));
		CxAssert(Int32(x_num / x_c)).Equals(66));
		CxAssert(Int32(x_num / x_num2)).Equals(66));
		CxAssert(Int64(x_num / x_num3)).Equals(66));
		CxAssert(Int64(x_num / x_num4)).Equals(66));
		...
		CxAssert(Int32(x_num % x_c)).Equals(0));
		CxAssert(Int32(x_num % x_num2)).Equals(0));
		CxAssert(Int64(x_num % x_num3)).Equals(0));
		CxAssert(Int64(x_num % x_num4)).Equals(0));
		CxAssert(Int64(( x_num % x_num5 ))).Equals(0));
		CxAssert(( x_num & x_c ) == 0);
		CxAssert(( x_num & x_num2 ) == 0);
		CxAssert(( x_num & x_num3 ) == 0);
		CxAssert(( x_num & x_num4 ) == 0);
		...
		CxAssert(Int32(x_num >> 1)).Equals(33));
		CxAssert(Char(x_c)).Equals(x_num),false);
		CxAssert(Int32(x_num2)).Equals(x_num),false);
		CxAssert(UInt32(x_num3)).Equals(x_num),false);
		CxAssert(Int64(x_num4)).Equals(x_num),false);
		CxAssert(Double(x_num5)).Equals(x_num),false);
		CxAssert(!Char(x_c)).Equals(x_num));
		CxAssert(!Int32(x_num2)).Equals(x_num));
		CxAssert(!UInt32(x_num3)).Equals(x_num));
		CxAssert(!Int64(x_num4)).Equals(x_num));
		CxAssert(!Double(x_num5)).Equals(x_num));
		CxAssert(x_c <= x_num);
		CxAssert(x_num2 <= x_num);
		...
		x_num = 66;
		Int32 x_num6 = 0;
		CxAssert(Int32(x_num6)).Equals(0));
		CxAssert(Int32(x_num6)).Equals(0));
		CxAssert(x_num2 <= 2);
		CxAssert(x_num2 >= -2);
	}
	void Int32Test::Int32ArrayTests()
	{
		...
		CxAssert(Int32(x_array->get_Length())).Equals(5));
		CxAssert(Int32((*x_array->Address(3)))).Equals(4));
		Array* x_array2 = (new Array(Int32Type,4))->Initialize((Int32*) Int32ArrayTestsArray1);
		CxAssert(Int32((*x_array2->Address(1)))).Equals(2));
		Array* x_array3 = (new Array(Int32Type,2,4))->Initialize((Int32*) Int32ArrayTestsArray2);
		CxAssert(Int32((*x_array3->Address(0,2)))).Equals(3));
		Array* x_array4 = (new Array(Int32Type,2,2,4))->Initialize((Int32*) Int32ArrayTestsArray3);
		CxAssert(Int32((*x_array4->Address(0,0,3)))).Equals(4));
		(*x_array4->Address(0,0,3)) = 6;
		CxAssert(Int32((*x_array4->Address(0,0,3)))).Equals(6));
		x_array4->SetValue(4,0,0,3);
		CxAssert(Int32((*x_array4->Address(0,0,3)))).Equals(4));
		CxAssert((((*x_array4->Address(0,0,3))).ToString())->Equals((new String("4"))));
	}
	void Int32Test::Int32MiscTests()
	{
		Int32 x_num = -1;
		Int32 x_val = 1;
		CxAssert(Int32(MathRaw::Abs(x_num))).Equals(1));
		CxAssert(Int32(MathRaw::Max(x_num,x_val))).Equals(1));
		CxAssert(Int32(MathRaw::Min(x_num,x_val))).Equals(-1));
		CxAssert(MathRaw::Sign(x_num) < 0);
		StringBuilder* x_stringBuilder = new StringBuilder();
		x_stringBuilder->Append(x_num);
		CxAssert((x_stringBuilder->ToString())->Equals((new String("-1"))));
	...
	void Int64Test::Int64MethodsTest()
	{
		...
		CxAssert((x_num).Equals(5));
		CxAssert((x_num).Equals(5));
		CxAssert(Int64(Int64Raw::Parse((new String("-55"))))).Equals(-55));
		String* x_text = (Int649223372036854775807)).ToString();
		CxAssert((x_text)->Equals((new String("9223372036854775807"))));
		CxAssert(Int64(Int64Raw::Parse(x_text))).Equals(Int649223372036854775807)));
		String* x_text2 = (Int64-9223372036854775808)).ToString();
		CxAssert((x_text2)->Equals((new String("-9223372036854775808"))));
		CxAssert(Int64(Int64Raw::Parse(x_text2))).Equals(Int64-9223372036854775808)));
		Object* x_obj = 5;
		CxAssert(x_obj->Equals(5));
		CxAssert((x_obj->ToString())->Equals((new String("5"))));
	}
	void Int64Test::Int64MathTest()
	{
		...
		CxAssert(Int64(x_num + x_num2)).Equals(180000000));
		CxAssert(Int64(x_num - x_num2)).Equals(-60000000));
		CxAssert(Int64(x_num * x_num2)).Equals(7200000000000000));
		CxAssert(Int64(x_num * x_num2)).Equals(7200000000000000));
		CxAssert(Int64(x_num2 / x_num)).Equals(2));
		CxAssert(Int64(x_num << 1)).Equals(120000000));
		Int32 x_num3 = 11;
		CxAssert(Int32(x_num3 % 5)).Equals(1));
		x_num3 = 8;
		CxAssert(( x_num3 | 1 ) == 9);
		...
		CxAssert(( x_num3 = x_num3 | 4 ) == 4);
		CxAssert(( x_num3 = x_num3 & 4 ) == 4);
		CxAssert(Int64(-x_num)).Equals(-60000000));
		CxAssert(Int64(x_num)).Equals(60000000));
		x_num3 = 0;
		CxAssert(Int32(~x_num3)).Equals(-1));
		CxAssert(Int32(++x_num3)).Equals(1));
	...
	void Int64Test::Int64Operators()
	{
		...
		Int64 x_num4 = 1;
		Double x_num5 = 1;
		CxAssert(Int64(x_num)).Equals(66));
		CxAssert(Int64(x_num + x_c)).Equals(67));
		CxAssert(Int64(x_num + x_num2)).Equals(67));
		CxAssert(Int64(x_num + x_num3)).Equals(67));
		CxAssert(Int64(x_num + x_num4)).Equals(67));
		CxAssert(Double(x_num + x_num5)).Equals(67));
		CxAssert(Int64(x_num - x_c)).Equals(65));
		CxAssert(Int64(x_num - x_num2)).Equals(65));
		CxAssert(Int64(x_num - x_num3)).Equals(65));
		CxAssert(Int64(x_num - x_num4)).Equals(65));
		CxAssert(Double(x_num - x_num5)).Equals(65));
		CxAssert(Int64(x_num * x_c)).Equals(66));
		CxAssert(Int64(x_num * x_num2)).Equals(66));
		CxAssert(Int64(x_num * x_num3)).Equals(66));
		CxAssert(Int64(x_num * x_num4)).Equals(66));
		CxAssert(Double(x_num * x_num5)).Equals(66));
		CxAssert(Int64(x_num / x_c)).Equals(66));
		...
		CxAssert(Int64(x_num / x_num4)).Equals(66));
		CxAssert(Double(x_num / x_num5)).Equals(66));
		CxAssert(Int64(x_num % x_c)).Equals(0));
		CxAssert(Int64(x_num % x_num2)).Equals(0));
		CxAssert(Int64(x_num % x_num3)).Equals(0));
		CxAssert(Int64(x_num % x_num4)).Equals(0));
		CxAssert(Double(x_num % x_num5)).Equals(0));
		CxAssert(( x_num & x_c ) == 0);
		...
		CxAssert(( x_num ^ x_num3 ) == 67);
		CxAssert(( x_num ^ x_num4 ) == 67);
		CxAssert(Int64(~x_num)).Equals(-67));
		CxAssert(x_c < x_num);
		CxAssert(x_num2 < x_num);
		CxAssert(x_num3 < x_num);
		CxAssert(x_num4 < x_num);
		...
		CxAssert(Int64(x_num++)).Equals(66));
		CxAssert(Int64(x_num--)).Equals(67));
		CxAssert(Int64(x_num << 1)).Equals(132));
		CxAssert(Int64(x_num >> 1)).Equals(33));
		CxAssert(Char(x_c)).Equals(x_num),false);
		CxAssert(Int32(x_num2)).Equals(x_num),false);
		CxAssert(UInt32(x_num3)).Equals(x_num),false);
		CxAssert(Int64(x_num4)).Equals(x_num),false);
	...
	void Int64Test::Int64MiscTests()
	{
		Int64 x_num = -1;
		Int64 x_val = 1;
		CxAssert(Int64(MathRaw::Abs(x_num))).Equals(1));
		CxAssert(Int64(MathRaw::Max(x_num,x_val))).Equals(1));
		CxAssert(Int64(MathRaw::Min(x_num,x_val))).Equals(-1));
		CxAssert(MathRaw::Sign(x_num) < 0);
		StringBuilder* x_stringBuilder = new StringBuilder();
		x_stringBuilder->Append(x_num);
		CxAssert((x_stringBuilder->ToString())->Equals((new String("-1"))));
	...
	void MathTest::DoMathTest()
	{
		...
		CxAssert(MathRaw::Abs(1),1);
		CxAssert(Int32(MathRaw::Abs(-1))).Equals(1));
		CxAssert(Int32(MathRaw::Abs(1))).Equals(1));
		CxAssert(Int64(MathRaw::Abs(-1))).Equals(1));
		CxAssert(Int64(MathRaw::Abs(1))).Equals(1));
		...
		CxAssert(Int32(MathRaw::Max(1,2))).Equals(2));
		CxAssert(Int64(MathRaw::Max(1,2))).Equals(2));
		CxAssert(UInt32(MathRaw::Max(1,2))).Equals(2));
		CxAssert(MathRaw::Min(1.1,1.2),1.1);
		CxAssert(Int32(MathRaw::Min(1,2))).Equals(1));
		CxAssert(Int64(MathRaw::Min(1,2))).Equals(1));
		CxAssert(UInt32(MathRaw::Min(1,2))).Equals(1));
		...
		CxAssert(MathRaw::Round(-1.5),-2);
		CxAssert(MathRaw::Round(-2.5),-2);
		CxAssert(MathRaw::Round(Double1.79769313486232E+308)),Double1.79769313486232E+308));
		CxAssert(MathRaw::Round(Double-1.79769313486232E+308)),Double-1.79769313486232E+308));
		CxAssert(Int32(MathRaw::Sign(2))).Equals(1));
		CxAssert(Int32(MathRaw::Sign(0))).Equals(0));
		CxAssert(Int32(MathRaw::Sign(-2))).Equals(-1));
		CxAssert(Int32(MathRaw::Sign(2))).Equals(1));
		CxAssert(Int32(MathRaw::Sign(0))).Equals(0));
		CxAssert(Int32(MathRaw::Sign(-2))).Equals(-1));
		...
		CxAssert(Int32(MathRaw::Sign(0))).Equals(0));
		CxAssert(Int32(MathRaw::Sign(-2))).Equals(-1));
		CxAssert(Int32(MathRaw::Sign(Double::Epsilon))).Equals(1));
		...
		Double x_num = Math::E;
		CxAssert(Double(Math::E)).Equals(x_num));
		Double x_num2 = Math::PI;
		CxAssert(Double(Math::PI)).Equals(x_num2));
		CxAssert(Double(MathRaw::Truncate(x_num2))).Equals(3));
	}
	...
	void SByteTest::SByteMethodsTest()
	{
		...
		CxAssert((x_b).Equals(5));
		CxAssert((x_b).Equals(5));
		CxAssert(SByte(SByteRaw::Parse((new String("-55"))))).Equals(-55));
		CxAssert(((new String("-75")))->Equals(( -75 ).ToString()));
		String* x_text = (SByte127)).ToString();
		CxAssert((x_text)->Equals((new String("127"))));
		CxAssert(SByte(SByteRaw::Parse(x_text))).Equals(SByte127)));
		String* x_text2 = (SByte-128)).ToString();
		CxAssert((x_text2)->Equals((new String("-128"))));
		CxAssert(SByte(SByteRaw::Parse(x_text2))).Equals(SByte-128)));
		Int64 x_num = Int649223372036854775807);
		x_b = x_num;
		CxAssert(SByte(x_b)).Equals(-1));
		Object* x_obj = 5;
		CxAssert(x_obj->Equals(5));
		CxAssert((x_obj->ToString())->Equals((new String("5"))));
	}
	void SByteTest::SByteMathTest()
	{
		SByte x_b = 6;
		SByte x_b2 = 12;
		CxAssert(Int32(x_b + x_b2)).Equals(18));
		CxAssert(Int32(x_b - x_b2)).Equals(-6));
		CxAssert(Int32(x_b * x_b2)).Equals(72));
		CxAssert(Int32(x_b2 / x_b)).Equals(2));
		CxAssert(Int32(x_b >> 2)).Equals(1));
		CxAssert(Int32(x_b << 1)).Equals(12));
		Int32 x_num = 11;
		CxAssert(Int32(x_num % 5)).Equals(1));
		x_num = 8;
		CxAssert(( x_num | 1 ) == 9);
		CxAssert(( x_num & 1 ) == 0);
		CxAssert(Int32(++x_num)).Equals(9));
		CxAssert(Int32(--x_num)).Equals(8));
		CxAssert(( x_num = x_num * 2 ) == 16);
		CxAssert(( x_num = x_num / 2 ) == 8);
		CxAssert(( x_num = x_num % 2 ) == 0);
		CxAssert(( x_num = x_num | 4 ) == 4);
		CxAssert(( x_num = x_num & 4 ) == 4);
		CxAssert(Int32(-x_b)).Equals(-6));
		CxAssert(SByte(x_b)).Equals(6));
		x_num = 0;
		CxAssert(Int32(~x_num)).Equals(-1));
		CxAssert(Int32(++x_num)).Equals(1));
		CxAssert(Int32(--x_num)).Equals(0));
		CxAssert(x_b < x_b2);
		CxAssert(x_b <= x_b2);
		CxAssert(x_b2 > x_b);
		CxAssert(x_b2 >= x_b);
	...
	void SByteTest::SByteOperators()
	{
		...
		Float x_num5 = 1;
		Double x_num6 = 1;
		CxAssert(SByte(x_b)).Equals(66));
		CxAssert(Int32(x_b + x_c)).Equals(67));
		CxAssert(Int32(x_b + x_b2)).Equals(67));
		CxAssert(Int32(x_b + x_b3)).Equals(67));
		CxAssert(Int32(x_b + x_b4)).Equals(67));
		CxAssert(Int32(x_b + x_num)).Equals(67));
		CxAssert(Int64(x_b + x_num2)).Equals(67));
		CxAssert(Int32(x_b + x_num3)).Equals(67));
		CxAssert(Int64(x_b + x_num4)).Equals(67));
		CxAssert(Single(x_b + x_num5)).Equals(67));
		CxAssert(Double(x_b + x_num6)).Equals(67));
		CxAssert(Int32(x_b - x_c)).Equals(65));
		CxAssert(Int32(x_b - x_b2)).Equals(65));
		CxAssert(Int32(x_b - x_b3)).Equals(65));
		CxAssert(Int32(x_b - x_b4)).Equals(65));
		CxAssert(Int32(x_b - x_num)).Equals(65));
		CxAssert(Int64(x_b - x_num2)).Equals(65));
		CxAssert(Int32(x_b - x_num3)).Equals(65));
		CxAssert(Int64(x_b - x_num4)).Equals(65));
		CxAssert(Single(x_b - x_num5)).Equals(65));
		CxAssert(Double(x_b - x_num6)).Equals(65));
		CxAssert(Int32(x_b * x_c)).Equals(66));
		CxAssert(Int32(x_b * x_b2)).Equals(66));
		CxAssert(Int32(x_b * x_b3)).Equals(66));
		CxAssert(Int32(x_b * x_b4)).Equals(66));
		CxAssert(Int32(x_b * x_num)).Equals(66));
		CxAssert(Int64(x_b * x_num2)).Equals(66));
		CxAssert(Int32(x_b * x_num3)).Equals(66));
		CxAssert(Int64(x_b * x_num4)).Equals(66));
		CxAssert(Single(x_b * x_num5)).Equals(66));
		...
		CxAssert(Int32(x_b % x_b2)).Equals(0));
		CxAssert(Int32(x_b % x_b3)).Equals(0));
		CxAssert(Int32(x_b % x_b4)).Equals(0));
		CxAssert(Int32(x_b % x_num)).Equals(0));
		CxAssert(Int64(x_b % x_num2)).Equals(0));
		CxAssert(Int32(x_b % x_num3)).Equals(0));
		CxAssert(Int64(x_b % x_num4)).Equals(0));
		CxAssert(Single(x_b % x_num5)).Equals(0));
		...
		CxAssert(( x_b = ( x_b - 1 ) ) == 66);
		CxAssert(SByte(x_b++)).Equals(66));
		CxAssert(SByte(x_b--)).Equals(67));
		CxAssert(Int32(x_b << 1)).Equals(132));
		CxAssert(Int32(x_b >> 1)).Equals(33));
		CxAssert(Char(x_c)).Equals(x_b),false);
		CxAssert(Byte(x_b2)).Equals(x_b),false);
		CxAssert(SByte(x_b3)).Equals(x_b),false);
		CxAssert(SByte(x_b4)).Equals(x_b),false);
		CxAssert(Int32(x_num)).Equals(x_b),false);
		CxAssert(Int64(x_num2)).Equals(x_b),false);
		CxAssert(UInt16(x_num3)).Equals(x_b),false);
		CxAssert(UInt32(x_num4)).Equals(x_b),false);
		CxAssert(Single(x_num5)).Equals(x_b),false);
		CxAssert(Double(x_num6)).Equals(x_b),false);
		CxAssert(!Char(x_c)).Equals(x_b));
		CxAssert(!Byte(x_b2)).Equals(x_b));
		CxAssert(!SByte(x_b3)).Equals(x_b));
		CxAssert(!SByte(x_b4)).Equals(x_b));
		CxAssert(!Int32(x_num)).Equals(x_b));
		CxAssert(!Int64(x_num2)).Equals(x_b));
		CxAssert(!UInt16(x_num3)).Equals(x_b));
		CxAssert(!UInt32(x_num4)).Equals(x_b));
		CxAssert(!Single(x_num5)).Equals(x_b));
		CxAssert(!Double(x_num6)).Equals(x_b));
		CxAssert(x_c <= x_b);
		CxAssert(x_b2 <= x_b);
		CxAssert(x_b3 <= x_b);
		CxAssert(x_b4 <= x_b);
	...
	void SByteTest::SByteMiscTests()
	{
		SByte x_b = -1;
		SByte x_val = 1;
		CxAssert(SByte(MathRaw::Abs(x_b))).Equals(1));
		CxAssert(SByte(MathRaw::Max(x_b,x_val))).Equals(1));
		CxAssert(SByte(MathRaw::Min(x_b,x_val))).Equals(-1));
	...
	void SingleTest::DoSingleMethodsTest()
	{
		...
		CxAssert(Int32((x_num).CompareTo(3.159))).Equals(0));
		CxAssert((x_num).Equals(3.159));
		CxAssert(SingleRaw::Parse((new String("3.159"))),3.15899991989136);
		CxAssert(((x_num).ToString())->Equals((new String("3.159"))));
		CxAssert(SingleRaw::Parse((x_num).ToString()),x_num);
		x_num = 1E+07;
		...
		CxAssert(Double(x_obj)).Equals(10000));
		x_num = Float::Epsilon;
		CxAssert(Single(x_num)).Equals(Float::Epsilon));
		x_num = Single3.402823E+38);
		CxAssert(Single(x_num)).Equals(Single3.402823E+38)));
		x_num = Single-3.402823E+38);
		CxAssert(Single(x_num)).Equals(Single-3.402823E+38)));
		x_obj = 5;
		CxAssert(x_obj->Equals(5));
		CxAssert((x_obj->ToString())->Equals((new String("5"))));
	}
	...
	void SingleTest::SingleOperators()
	{
		...
		Int64 x_num4 = 1;
		Double x_num5 = 1;
		CxAssert(Single(x_num)).Equals(66));
		CxAssert(Single(x_num + x_c)).Equals(67));
		CxAssert(Single(x_num + x_num2)).Equals(67));
		CxAssert(Single(x_num + x_num3)).Equals(67));
		CxAssert(Single(x_num + x_num4)).Equals(67));
		CxAssert(Double(x_num + x_num5)).Equals(67));
		CxAssert(Single(x_num - x_c)).Equals(65));
		CxAssert(Single(x_num - x_num2)).Equals(65));
		CxAssert(Single(x_num - x_num3)).Equals(65));
		CxAssert(Single(x_num - x_num4)).Equals(65));
		CxAssert(Double(x_num - x_num5)).Equals(65));
		CxAssert(Single(x_num * x_c)).Equals(66));
		CxAssert(Single(x_num * x_num2)).Equals(66));
		CxAssert(Single(x_num * x_num3)).Equals(66));
		CxAssert(Single(x_num * x_num4)).Equals(66));
		CxAssert(Double(x_num * x_num5)).Equals(66));
		CxAssert(Single(x_num / x_c)).Equals(66));
		CxAssert(Single(x_num / x_num2)).Equals(66));
		CxAssert(Single(x_num / x_num3)).Equals(66));
		CxAssert(Single(x_num / x_num4)).Equals(66));
		CxAssert(Double(x_num / x_num5)).Equals(66));
		CxAssert(Single(x_num % x_c)).Equals(0));
		CxAssert(Single(x_num % x_num2)).Equals(0));
		CxAssert(Single(x_num % x_num3)).Equals(0));
		CxAssert(Single(x_num % x_num4)).Equals(0));
		CxAssert(Double(x_num % x_num5)).Equals(0));
		CxAssert(x_c < x_num);
		CxAssert(x_num2 < x_num);
		CxAssert(x_num3 < x_num);
		...
		CxAssert(( x_num = x_num - 1 ) == 66);
		CxAssert(Single(x_num++)).Equals(66));
		CxAssert(Single(x_num--)).Equals(67));
		CxAssert(Single(x_c)).Equals(x_num),false);
		CxAssert(Single(x_num2)).Equals(x_num),false);
		CxAssert(Single(x_num3)).Equals(x_num),false);
		CxAssert(Single(x_num4)).Equals(x_num),false);
		CxAssert(Double(x_num5)).Equals(x_num),false);
		CxAssert(!Single(x_c)).Equals(x_num));
		CxAssert(!Single(x_num2)).Equals(x_num));
		CxAssert(!Single(x_num3)).Equals(x_num));
		CxAssert(!Single(x_num4)).Equals(x_num));
		CxAssert(!Double(x_num5)).Equals(x_num));
		CxAssert(x_c <= x_num);
		CxAssert(x_num2 <= x_num);
		CxAssert(x_num3 <= x_num);
	...
	void SingleTest::SingleNanTest()
	{
		...
		CxAssert(x_num <= x_num2,false);
		CxAssert(x_num >= x_num2,false);
		CxAssert(Single(x_num)).Equals(x_num2),false);
		CxAssert(Single(x_num)).Equals(x_num),false);
		CxAssert(x_num2 < x_num,false);
		CxAssert(x_num2 > x_num,false);
		CxAssert(x_num2 <= x_num,false);
		CxAssert(x_num2 >= x_num,false);
		CxAssert(!Single(x_num)).Equals(x_num2));
		CxAssert(!Single(x_num)).Equals(x_num));
		x_num = Float::NaN;
		x_num2 = Float::NaN;
		if ( Single(x_num)).Equals(x_num2) )
		{
			SingleTestFailed();
		}
		else
		...
		CxAssert((Float::NaN).Equals(Float::NaN));
	}
	void SingleTest::SingleArrayTest()
	{
		...
		CxAssert(Single((*x_array->Address(1)))).Equals(2));
		Array* x_array2 = (new Array(FloatType,2,4))->Initialize((Float*) SingleArrayTestArray1);
		CxAssert(Single((*x_array2->Address(0,2)))).Equals(3));
		Array* x_array3 = (new Array(FloatType,2,2,4))->Initialize((Float*) SingleArrayTestArray2);
		CxAssert(Single((*x_array3->Address(0,0,3)))).Equals(4));
		(*x_array3->Address(0,0,3)) = 22;
		CxAssert(Single((*x_array3->Address(0,0,3)))).Equals(22));
	...
	void SingleTest::SingleMiscTests()
	{
		Float x_num = -1;
		Float x_val = 1;
		CxAssert(Single(MathRaw::Abs(x_num))).Equals(1));
		CxAssert(Single(MathRaw::Max(x_num,x_val))).Equals(1));
		CxAssert(Single(MathRaw::Min(x_num,x_val))).Equals(-1));
		CxAssert(MathRaw::Sign(x_num) < 0);
		StringBuilder* x_stringBuilder = new StringBuilder();
		x_stringBuilder->Append(x_num);
		CxAssert((x_stringBuilder->ToString())->Equals((new String("-1"))));
...
','"',''','Â'};
		CxAssert(Int32(x_sb->get_Length())).Equals(0));
		x_sb = new StringBuilder(100);
		CxAssert(Int32(x_sb->get_Capacity())).Equals(100));
		x_sb = new StringBuilder((new String("Test")));
		CxAssert((x_sb->ToString())->Equals((new String("Test"))));
		x_sb = new StringBuilder(20,25);
		CxAssert(Int32(x_sb->get_Capacity())).Equals(20) && Int32(x_sb->get_MaxCapacity())).Equals(25));
		x_sb = new StringBuilder((new String("Test")),20);
		CxAssert((x_sb->ToString())->Equals((new String("Test"))) && Int32(x_sb->get_Capacity())).Equals(20));
		x_sb = new StringBuilder((new String("test1234")),1,4,20);
		CxAssert((x_sb->ToString())->Equals((new String("est1"))) && Int32(x_sb->get_Capacity())).Equals(20));
	...
	void StringBuilderTest::DoSBPropertyTest()
	{
		...
		CxAssert(Int32(x_sb->get_Capacity())).Equals(20) && Int32(x_sb->get_MaxCapacity())).Equals(Int322147483647)));
		CxAssert(Char((*x_sb->Address(7)))).Equals('1'));
		CxAssert(Int32(x_sb->get_Length())).Equals(10));
		x_sb->set_Length(7);
		CxAssert(Int32(x_sb->get_Length())).Equals(7));
		x_sb->set_Capacity(22);
		CxAssert(Int32(x_sb->get_Capacity())).Equals(22));
		(*x_sb->Address(0)) = 't';
	...
	void StringBuilderTest::DoSBAppendTest()
	{
		...
		Array* x_array = (new Array(Object*Type,4))->Initialize((Object**) DoSBAppendTestArray1);
		x_sb->set_Length(0);
		CxAssert((x_sb->AppendFormat((new String("y={0}{1}{2}{3}")),x_array)->AppendFormat())->Equals((new String("y=0123"))));
		x_sb->set_Length(0);
		CxAssert((x_sb->AppendFormat((new String("y={0}{1}")),(*x_array->Address(0)),(*x_array->Address(1)))->AppendFormat())->Equals((new String("y=01"))));
		x_sb->set_Length(0);
		CxAssert((x_sb->AppendFormat((new String("y={0}{1}{2}")),(*x_array->Address(0)),(*x_array->Address(1)),(*x_array->Address(2)))->AppendFormat())->Equals((new String("y=012"))));
		x_sb->set_Length(0);
	...
	void StringTest::DoIndexTest()
	{
		...
		CxAssert(Int32(x_text->get_Length())).Equals(5));
		CxAssert(Char((*x_text->Address(0)))).Equals('1'));
		CxAssert(Char((*x_text->Address(1)))).Equals('2'));
		CxAssert(Char((*x_text->Address(2)))).Equals('3'));
		CxAssert(Char((*x_text->Address(3)))).Equals('4'));
		CxAssert(Char((*x_text->Address(4)))).Equals('5'));
	}
	void StringTest::DoMiscTest()
	{
		static Object* DoMiscTestArray0[3] = {1,2,3};
		String* x_text = new String*(' ',10);
		CxAssert(Int32(x_text->get_Length())).Equals(10));
		...
		{
			CxAssert(Char((*x_array->Address(x_num)))).Equals(x_c));
			x_num++;
		}
		x_array = x_text2->ToCharArray();
		CxAssert(x_array != nullptr && Int32(x_array->get_Length())).Equals(x_text2->get_Length()));
		...
		CxAssert(Int32(StringRaw::Compare((new String("abc")),(new String("ABC")),true))).Equals(0));
		CxAssert(Int32(StringRaw::Compare((new String("1abce")),1,(new String("abc")),0,3))).Equals(0));
		CxAssert(Int32(StringRaw::Compare((new String("1abce")),1,(new String("ABC")),0,3,true))).Equals(0));
		CxAssert(Int32(StringRaw::CompareOrdinal((new String("abc")),(new String("abc"))))).Equals(0));
		CxAssert(Int32(StringRaw::CompareOrdinal((new String("1abce")),1,(new String("abc")),0,3))).Equals(0));
		x_a2 = StringRaw::Copy(x_text2);
		CxAssert((x_a2)->Equals(x_text2));
		x_a2 = StringRaw::Format((new String("1 = {{{0,-4}}} 2 = {1,4} 3 = {2}!")),1,2,3);
		...
		x_a2 = StringRaw::Format((new String("1 = {{{0,-4}}} 2 = {1,4}!")),1,2);
		CxAssert((x_a2)->Equals((new String("1 = {1   } 2 =    2!"))));
		x_a2 = StringRaw::Format((new String("1 = {{{0,-4}}}!")),1);
		CxAssert((x_a2)->Equals((new String("1 = {1   }!"))));
		Array* x_args = (new Array(Object*Type,3))->Initialize((Object**) DoMiscTestArray0);
		x_a2 = StringRaw::Format((new String("1 = {{{0,-4}}} 2 = {1,4} 3 = {2}!")),x_args);
		CharEnumerator* x_enumerator = x_a2->GetEnumerator();
		Int32 x_num2 = 0;
		while (x_enumerator->MoveNext() )
		{
			Char x_current = x_enumerator->get_Current();
			CxAssert(Char(x_current)).Equals((*x_a2->Address(x_num2++))));
		}
		x_enumerator->Reset();
		Double x_num3 = 2;
	...
	{
		String* x_text = (new String("12345"));
		CxAssert(StringRaw::Equals(x_text,(new String("12345"))));
	...
	void StringTest::DoParsingTest()
	{
		...
		CxAssert(Int32(x_array->get_Length())).Equals(3));
		CxAssert(((new String("12")))->Equals((*x_array->Address(0))));
		CxAssert(((new String("34")))->Equals((*x_array->Address(1))));
		CxAssert(((new String("56")))->Equals((*x_array->Address(2))));
		...
		CxAssert(Int32(x_array->get_Length())).Equals(5));
		CxAssert(((new String("42")))->Equals((*x_array->Address(0))));
		CxAssert(((new String("")))->Equals((*x_array->Address(1))));
		CxAssert(((new String("12")))->Equals((*x_array->Address(2))));
		CxAssert(((new String("")))->Equals((*x_array->Address(3))));
		CxAssert(((new String("19")))->Equals((*x_array->Address(4))));
		x_array = x_text2->Split(x_separator,2);
		CxAssert(Int32(x_array->get_Length())).Equals(2));
		CxAssert(((new String("42")))->Equals((*x_array->Address(0))));
		CxAssert(((new String(" 12, 19")))->Equals((*x_array->Address(1))));
		...
		CxAssert(Int32(x_text->IndexOfAny(x_array2))).Equals(3));
		CxAssert(Int32(x_text->IndexOfAny(x_array2,1))).Equals(3));
		CxAssert(Int32(x_text->IndexOfAny(x_array2,1,3))).Equals(3));
		CxAssert(Int32(x_text->IndexOf('5'))).Equals(6));
		CxAssert(Int32(x_text->IndexOf(' ',3))).Equals(5));
		CxAssert(Int32(x_text->IndexOf(' ',3,3))).Equals(5));
		CxAssert(Int32(x_text->IndexOf((new String("56"))))).Equals(6));
		CxAssert(Int32(x_text->IndexOf((new String(" ")),3))).Equals(5));
		CxAssert(Int32(x_text->IndexOf((new String(" ")),3,3))).Equals(5));
		String* x_text6 = (new String("11223311"));
		CxAssert(Int32(x_text6->LastIndexOf('1'))).Equals(7));
		CxAssert(Int32(x_text6->LastIndexOf('1',4))).Equals(1));
		CxAssert(Int32(x_text6->LastIndexOf('1',4,4))).Equals(1));
		CxAssert(Int32(x_text6->LastIndexOf((new String("11"))))).Equals(6));
		CxAssert(Int32(x_text6->LastIndexOf((new String("11")),4))).Equals(0));
		CxAssert(Int32(x_text6->LastIndexOf((new String("11")),4,5))).Equals(0));
		(*x_array2->Address(0)) = '1';
		(*x_array2->Address(1)) = '2';
		CxAssert(Int32(x_text6->LastIndexOfAny(x_array2))).Equals(7));
		CxAssert(Int32(x_text6->LastIndexOfAny(x_array2,4))).Equals(3));
		CxAssert(Int32(x_text6->LastIndexOfAny(x_array2,4,4))).Equals(3));
		...
		CxAssert((StringRaw::Join((new String(",")),x_value))->Equals((new String("1,2,3"))));
		CxAssert((StringRaw::Join((new String(",")),x_value,1,2))->Equals((new String("2,3"))));
		x_text6 = x_text->Insert(3,(new String("111")));
		CxAssert((x_text6)->Equals((new String("12 11134 56"))));
		String* x_text7 = (new String("3.33"));
		if ( !Int32(x_text7->CompareTo((new String("3.33"))))).Equals(0) )
		{
			CxAssert(false);
		}
	}
	void StringTest::DoConcatTest()
	{
		...
		Array* x_array = (new Array(Object*Type,4))->Initialize((Object**) DoConcatTestArray0);
		String* x_a = StringRaw::Concat((*x_array->Address(0)));
		CxAssert((x_a)->Equals((new String("1 "))));
		x_a = StringRaw::Concat(x_array);
		CxAssert((x_a)->Equals((new String("1 2 3 4"))));
		Array* x_array2 = (new Array(String*Type,4))->Initialize((String**) DoConcatTestArray1);
		x_a = StringRaw::Concat(x_array2);
		CxAssert((x_a)->Equals((new String("1 2 3 4"))));
		x_a = StringRaw::Concat((*x_array->Address(0)),(*x_array->Address(1)));
		CxAssert((x_a)->Equals((new String("1 2 "))));
		x_a = (*x_array2->Address(0)) + (*x_array2->Address(1));
		CxAssert((x_a)->Equals((new String("1 2 "))));
		x_a = StringRaw::Concat((*x_array->Address(0)),(*x_array->Address(1)),(*x_array->Address(2)));
		CxAssert((x_a)->Equals((new String("1 2 3 "))));
		x_a = (*x_array2->Address(0)) + (*x_array2->Address(1)) + (*x_array2->Address(2));
		CxAssert((x_a)->Equals((new String("1 2 3 "))));
		x_a = (*x_array2->Address(0)) + (*x_array2->Address(1)) + (*x_array2->Address(2)) + (*x_array2->Address(3));
		CxAssert((x_a)->Equals((new String("1 2 3 4"))));
	}
	...
	void TimeTest::TestTimeSpan()
	{
		...
		CxAssert(Int64(x_timeSpan2.get_Ticks())).Equals(200));
		...
		CxAssert(Int64(x_timeSpan.get_Ticks())).Equals(200));
		CxAssert(TimeSpanRaw::Equals(x_timeSpan,x_timeSpan2));
		CxAssert(x_timeSpan.Equals(x_timeSpan2));
		CxAssert(Int64(TimeSpanRaw::FromDays(22).get_Ticks())).Equals(19008000000000));
		CxAssert(Int64(TimeSpanRaw::FromHours(10).get_Ticks())).Equals(360000000000));
		CxAssert(Int64(TimeSpanRaw::FromMilliseconds(100).get_Ticks())).Equals(1000000));
		CxAssert(Int64(TimeSpanRaw::FromMinutes(25).get_Ticks())).Equals(15000000000));
		CxAssert(Int64(TimeSpanRaw::FromSeconds(18).get_Ticks())).Equals(180000000));
		x_timeSpan = TimeSpanRaw::FromTicks(6500000);
		CxAssert(Int64(x_timeSpan.get_Ticks())).Equals(6500000));
		x_timeSpan = x_timeSpan.Negate();
		CxAssert(Int64(x_timeSpan.get_Ticks())).Equals(-6500000));
		CxAssert(Int64(x_timeSpan.Subtract(x_timeSpan2).get_Ticks())).Equals(-6500200));
		CxAssert(Int64(TimeSpanRaw::Parse((new String("1.1:1:1"))).get_Ticks())).Equals(900610000000));
		CxAssert(Int64(TimeSpanRaw::Parse((new String("1.1:1:1.200"))).get_Ticks())).Equals(900612000000));
		CxAssert(Int64(TimeSpanRaw::Parse((new String("1:1:1"))).get_Ticks())).Equals(36610000000));
		CxAssert(Int64(TimeSpanRaw::Parse((new String("22"))).get_Ticks())).Equals(19008000000000));
		x_timeSpan = TimeSpanRaw::Parse((new String("1.2:3:4.200")));
		String* x_a = x_timeSpan.ToString();
		CxAssert((x_a)->Equals((new String("1.02:03:04.2000000"))));
		CxAssert(Int32(x_timeSpan.get_Days())).Equals(1));
		CxAssert(Int32(x_timeSpan.get_Hours())).Equals(2));
		CxAssert(Int32(x_timeSpan.get_Minutes())).Equals(3));
		CxAssert(Int32(x_timeSpan.get_Seconds())).Equals(4));
		CxAssert(Int32(x_timeSpan.get_Milliseconds())).Equals(200));
		CxAssert(Int64(x_timeSpan.get_Ticks())).Equals(937842000000));
		...
		CxAssert(Int64(( x_timeSpan2 + x_timeSpan2 ).get_Ticks())).Equals(400));
		...
		CxAssert(Int64(x_timeSpan.get_Ticks())).Equals(100));
		x_timeSpan = -x_timeSpan;
		CxAssert(Int64(x_timeSpan.get_Ticks())).Equals(-100));
		CxAssert(Int64(( +x_timeSpan ).get_Ticks())).Equals(-100));
		CxAssert(Int64(TimeSpan(1000).get_Ticks())).Equals(1000));
		CxAssert(Int64(TimeSpan(10,11,30).get_Ticks())).Equals(366900000000));
		CxAssert(Int64(TimeSpan(3,10,11,30).get_Ticks())).Equals(2958900000000));
		CxAssert(Int64(TimeSpan(3,10,11,30,100).get_Ticks())).Equals(2958901000000));
		CxAssert(Int64(TimeSpan(3,10,11,30,100).get_Ticks())).Equals(2958901000000));
		x_timeSpan = TimeSpan(71,3,12,13);
		CxAssert(Int64(x_timeSpan.get_Ticks())).Equals(61459330000000));
		String* x_text = x_timeSpan.ToString();
		CxAssert(x_text->Equals((new String("71.03:12:13"))));
		x_timeSpan = TimeSpan(-71,3,12,13);
		CxAssert(Int64(x_timeSpan.get_Ticks())).Equals(-61228670000000));
		String* x_text2 = x_timeSpan.ToString();
		CxAssert(x_text2->Equals((new String("-70.20:47:47"))));
		x_timeSpan = TimeSpanRaw::Parse((new String("-71.03:12:13")));
		CxAssert(Int64(x_timeSpan.get_Ticks())).Equals(-61459330000000));
		String* x_text3 = x_timeSpan.ToString();
		CxAssert(x_text3->Equals((new String("-71.03:12:13"))));
		Object* x_obj = TimeSpan::MinValue;
		CxAssert(Int64(( x_obj ).get_Ticks())).Equals(TimeSpan::MinValue.get_Ticks()));
		TimeSpan x_minValue = TimeSpan::MinValue;
		CxAssert(x_minValue.Equals(x_obj));
		CxAssert(Int32(TimeSpan::MinValue.CompareTo(x_obj))).Equals(0));
		Int64 x_num = 864000000000;
		CxAssert(Int64(864000000000)).Equals(x_num));
		x_num = 36000000000;
		CxAssert(Int64(36000000000)).Equals(x_num));
		x_num = 600000000;
		CxAssert(Int32(600000000)).Equals(x_num));
		x_num = 10000000;
		CxAssert(Int32(10000000)).Equals(x_num));
		x_num = 10000;
		CxAssert(Int32(10000)).Equals(x_num));
	...
	{
		CxAssert(Int64(DateTime().get_Ticks())).Equals(0));
		CxAssert(Int64(DateTime(1200).get_Ticks())).Equals(1200));
		CxAssert(Int64(DateTime(2003,7,23).get_Ticks())).Equals(631945152000000000));
		CxAssert(Int64(DateTime(2003,7,23,12,30,30).get_Ticks())).Equals(631945602300000000));
		DateTime x_dateTime = DateTime(2003,7,23,12,30,30,100);
		CxAssert(Int64(x_dateTime.get_Ticks())).Equals(631945602301000000));
		CxAssert(Int64(x_dateTime.get_Date().get_Ticks())).Equals(631945152000000000));
		Int32 x_day = x_dateTime.get_Day();
		CxAssert(Int32(x_day)).Equals(23));
		...
		CxAssert(Int32(x_dayOfYear)).Equals(204));
		Int32 x_hour = x_dateTime.get_Hour();
		CxAssert(Int32(x_hour)).Equals(12));
		Int32 x_millisecond = x_dateTime.get_Millisecond();
		CxAssert(Int32(x_millisecond)).Equals(100));
		Int32 x_minute = x_dateTime.get_Minute();
		CxAssert(Int32(x_minute)).Equals(30));
		Int32 x_month = x_dateTime.get_Month();
		CxAssert(Int32(x_month)).Equals(7));
		...
		CxAssert(Int32(x_second)).Equals(30));
		CxAssert(Int64(x_dateTime.get_TimeOfDay().get_Ticks())).Equals(450301000000));
		...
		CxAssert(Int32(x_year)).Equals(2003));
	}
	void TimeTest::DateTimeMethodTests()
	{
		DateTime x_dateTime = DateTime(2003,7,23,12,30,30,100);
		TimeSpan x_timeSpan = TimeSpan(0,2,0,0);
		CxAssert(Int64(x_dateTime.Add(x_timeSpan).get_Ticks())).Equals(631945674301000000));
		CxAssert(Int64(x_dateTime.AddDays(1.5).get_Ticks())).Equals(631946898301000000));
		CxAssert(Int64(x_dateTime.AddHours(2.5).get_Ticks())).Equals(631945692301000000));
		CxAssert(Int64(x_dateTime.AddMilliseconds(159).get_Ticks())).Equals(631945602302590000));
		CxAssert(Int64(x_dateTime.AddMinutes(3.2).get_Ticks())).Equals(631945604221000000));
		CxAssert(Int64(x_dateTime.AddMonths(5).get_Ticks())).Equals(632077794301000000));
		CxAssert(Int64(x_dateTime.AddSeconds(6.66).get_Ticks())).Equals(631945602367600000));
		CxAssert(Int64(x_dateTime.AddTicks(666).get_Ticks())).Equals(631945602301000666));
		DateTime x_dateTime2 = x_dateTime.AddYears(3);
		CxAssert(Int64(x_dateTime2.get_Ticks())).Equals(632892546301000000));
		CxAssert(DateTimeRaw::Compare(x_dateTime2,x_dateTime) > 0);
		CxAssert(x_dateTime.CompareTo(x_dateTime2) < 0);
		CxAssert(Int32(DateTimeRaw::DaysInMonth(2003,1))).Equals(31));
		...
		CxAssert(Int64(x_dateTime2.get_Ticks())).Equals(631945530301000000));
		CxAssert(Int64(x_dateTime.Subtract(x_dateTime2).get_Ticks())).Equals(72000000000));
		x_dateTime2 = x_dateTime.ToLocalTime();
		x_dateTime2 = x_dateTime.ToUniversalTime();
		x_dateTime2 = x_dateTime + x_timeSpan;
		CxAssert(Int64(x_dateTime2.get_Ticks())).Equals(631945674301000000));
		...
		x_dateTime2 = x_dateTime - x_timeSpan;
		CxAssert(Int64(x_dateTime2.get_Ticks())).Equals(631945530301000000));
		CxAssert(Int64(( x_dateTime - x_dateTime2 ).get_Ticks())).Equals(72000000000));
		x_dateTime2 = DateTime(2003,7,23,14,2,30,100);
		CxAssert(Int64(x_dateTime2.get_Ticks())).Equals(631945657501000000));
		CxAssert(Int32(x_dateTime2.get_Hour())).Equals(14));
		...
		CxAssert(Int64(x_dateTime2.get_Ticks())).Equals(631945236011000000));
		CxAssert(Int32(x_dateTime2.get_Hour())).Equals(2));
		x_text = x_dateTime2.ToString();
		CxAssert(x_text->Equals((new String("7/23/2003 2:20:01 AM"))));
		CxAssert(Int64(DateTime0).get_Ticks())).Equals(0));
		CxAssert(Int64(DateTime3155378975999999999).get_Ticks())).Equals(3155378975999999999));
		Object* x_obj = DateTime0);
		CxAssert(Int64(( x_obj ).get_Ticks())).Equals(0));
		CxAssert(DateTime0).Equals(x_obj));
		CxAssert(Int32(DateTime0).CompareTo(x_obj))).Equals(0));
		CxAssert(x_obj->Equals(DateTime0)));
		CxAssert((x_obj->ToString())->Equals(DateTime0).ToString()));
		CxAssert(!(x_dateTime2).Equals(x_dateTime));
	}
	...
	void UInt16Test::UInt16MethodsTest()
	{
		...
		CxAssert((x_num).Equals(5));
		CxAssert((x_num).Equals(5));
		CxAssert(UInt16(UInt16Raw::Parse((new String("77"))))).Equals(77));
		CxAssert(((new String("5")))->Equals((x_num).ToString()));
		x_num = UInt1665535);
		CxAssert(UInt16(UInt1665535))).Equals(x_num));
		x_num = 0;
		CxAssert(UInt16(x_num)).Equals(0));
		String* x_text = (UInt1665535)).ToString();
		CxAssert((x_text)->Equals((new String("65535"))));
		CxAssert(UInt16(UInt16Raw::Parse(x_text))).Equals(UInt1665535)));
		String* x_text2 = ( 0 ).ToString();
		CxAssert((x_text2)->Equals((new String("0"))));
		CxAssert(UInt16(UInt16Raw::Parse(x_text2))).Equals(0));
		Object* x_obj = 5;
		CxAssert(x_obj->Equals(5));
		CxAssert((x_obj->ToString())->Equals((new String("5"))));
	}
	void UInt16Test::DoUnSignedMath()
	{
		...
		CxAssert(x_num3 <= x_num);
		x_num3 = x_num3 + x_num;
		CxAssert(Int32(x_num3)).Equals(601));
		CxAssert(Int32(x_num + x_num2)).Equals(1800));
		CxAssert(Int32(x_num - x_num2)).Equals(-600));
		CxAssert(Int32(x_num * x_num2)).Equals(720000));
		CxAssert(Int32(x_num2 / x_num)).Equals(2));
		...
		CxAssert(Int32(x_num << 1)).Equals(1200));
		Int32 x_num4 = 11;
		CxAssert(Int32(x_num4 % 5)).Equals(1));
		x_num4 = 8;
		CxAssert(( x_num4 | 1 ) == 9);
		CxAssert(( x_num4 & 1 ) == 0);
		CxAssert(Int32(++x_num4)).Equals(9));
		CxAssert(Int32(--x_num4)).Equals(8));
		...
		CxAssert(( x_num4 = x_num4 & 4 ) == 4);
		CxAssert(Int32(-x_num)).Equals(-600));
		CxAssert(UInt16(x_num)).Equals(600));
		UInt32 x_num5 = 0;
		CxAssert(UInt32(~x_num5)).Equals(UInt324294967295)));
		CxAssert(UInt32(++x_num5)).Equals(1));
		CxAssert(UInt32(--x_num5)).Equals(0));
	}
	void UInt16Test::UInt16Operators()
	{
		...
		Int64 x_num4 = 1;
		Double x_num5 = 1;
		CxAssert(UInt16(x_num)).Equals(66));
		CxAssert(Int32(x_num + x_c)).Equals(67));
		CxAssert(Int32(x_num + x_num2)).Equals(67));
		CxAssert(Int32(x_num + x_num3)).Equals(67));
		CxAssert(Int64(x_num + x_num4)).Equals(67));
		...
		CxAssert(( x_num = ( x_num - 1 ) ) == 66);
		CxAssert(UInt16(x_num++)).Equals(66));
		CxAssert(UInt16(x_num--)).Equals(67));
		CxAssert(Int32(x_num << 1)).Equals(132));
		CxAssert(Int32(x_num >> 1)).Equals(33));
		CxAssert(Char(x_c)).Equals(x_num),false);
		CxAssert(Int32(x_num2)).Equals(x_num),false);
		CxAssert(UInt16(x_num3)).Equals(x_num),false);
		CxAssert(Int64(x_num4)).Equals(x_num),false);
		CxAssert(Double(x_num5)).Equals(x_num),false);
		CxAssert(!Char(x_c)).Equals(x_num));
		CxAssert(!Int32(x_num2)).Equals(x_num));
		CxAssert(!UInt16(x_num3)).Equals(x_num));
		CxAssert(!Int64(x_num4)).Equals(x_num));
		CxAssert(!Double(x_num5)).Equals(x_num));
		CxAssert(x_c <= x_num);
		CxAssert(x_num2 <= x_num);
	...
	void UInt16Test::UInt16MiscTests()
	{
		UInt16 x_num = 0;
		UInt16 x_num2 = 1;
		CxAssert(UInt16(MathRaw::Max(x_num,x_num2))).Equals(1));
		CxAssert(UInt16(MathRaw::Min(x_num,x_num2))).Equals(0));
		StringBuilder* x_stringBuilder = new StringBuilder();
	...
	void UInt32Test::UInt32MethodsTest()
	{
		...
		CxAssert((x_num).Equals(5));
		CxAssert((x_num).Equals(5));
		CxAssert(UInt32(UInt32Raw::Parse((new String("77"))))).Equals(77));
		CxAssert(((new String("5")))->Equals((x_num).ToString()));
		x_num = UInt324294967295);
		CxAssert(Int32(-1)).Equals(x_num));
		x_num = 0;
		CxAssert(UInt32(x_num)).Equals(0));
		String* x_text = (UInt324294967295)).ToString();
		CxAssert((x_text)->Equals((new String("4294967295"))));
		CxAssert(UInt32(UInt32Raw::Parse(x_text))).Equals(UInt324294967295)));
		String* x_text2 = (0).ToString();
		CxAssert((x_text2)->Equals((new String("0"))));
		CxAssert(UInt32(UInt32Raw::Parse(x_text2))).Equals(0));
		Object* x_obj = 5;
		CxAssert(x_obj->Equals(5));
		CxAssert((x_obj->ToString())->Equals((new String("5"))));
	}
	void UInt32Test::DoUnSignedMath()
	{
		...
		CxAssert(x_num3 <= x_num);
		x_num3 = x_num3 + x_num;
		CxAssert(Int32(x_num3)).Equals(60001));
		CxAssert(UInt32(x_num + x_num2)).Equals(180000));
		CxAssert(UInt32(x_num - x_num2)).Equals(4294907296));
		CxAssert(UInt32(x_num * x_num2)).Equals(2905032704));
		CxAssert(UInt32(x_num2 / x_num)).Equals(2));
		CxAssert(UInt32(x_num >> 2)).Equals(15000));
		CxAssert(UInt32(x_num << 1)).Equals(120000));
		Int32 x_num4 = 11;
		CxAssert(Int32(x_num4 % 5)).Equals(1));
		x_num4 = 8;
		CxAssert(( x_num4 | 1 ) == 9);
		...
		CxAssert(( x_num4 = x_num4 | 4 ) == 4);
		CxAssert(( x_num4 = x_num4 & 4 ) == 4);
		CxAssert(Int64(0 - x_num)).Equals(-60000));
		CxAssert(UInt32(x_num)).Equals(60000));
		UInt32 x_num5 = 0;
		CxAssert(UInt32(~x_num5)).Equals(UInt324294967295)));
		CxAssert(UInt32(++x_num5)).Equals(1));
		CxAssert(UInt32(--x_num5)).Equals(0));
	...
	void UInt32Test::UInt32Operators()
	{
		...
		Int64 x_num4 = 1;
		Double x_num5 = 1;
		CxAssert(UInt32(x_num)).Equals(66));
		CxAssert(UInt32(x_num + x_c)).Equals(67));
		CxAssert(Int64(x_num + x_num2)).Equals(67));
		CxAssert(UInt32(x_num + x_num3)).Equals(67));
		CxAssert(Int64(x_num + x_num4)).Equals(67));
		CxAssert(Double(x_num + x_num5)).Equals(67));
		CxAssert(UInt32(x_num - x_c)).Equals(65));
		CxAssert(Int64(x_num - x_num2)).Equals(65));
		CxAssert(UInt32(x_num - x_num3)).Equals(65));
		CxAssert(Int64(x_num - x_num4)).Equals(65));
		CxAssert(Double(x_num - x_num5)).Equals(65));
		CxAssert(UInt32(x_num * x_c)).Equals(66));
		CxAssert(Int64(x_num * x_num2)).Equals(66));
		CxAssert(UInt32(x_num * x_num3)).Equals(66));
		CxAssert(Int64(x_num * x_num4)).Equals(66));
		CxAssert(Double(x_num * x_num5)).Equals(66));
		CxAssert(UInt32(x_num / x_c)).Equals(66));
		CxAssert(Int64(x_num / x_num2)).Equals(66));
		...
		CxAssert(Int64(x_num / x_num4)).Equals(66));
		CxAssert(Double(x_num / x_num5)).Equals(66));
		CxAssert(UInt32(x_num % x_c)).Equals(0));
		CxAssert(Int64(x_num % x_num2)).Equals(0));
		CxAssert(UInt32(x_num % x_num3)).Equals(0));
		CxAssert(Int64(x_num % x_num4)).Equals(0));
		CxAssert(Double(x_num % x_num5)).Equals(0));
		CxAssert(( x_num & x_c ) == 0);
		CxAssert(( x_num & x_num2 ) == 0);
		...
		CxAssert(( x_num ^ x_num3 ) == 67);
		CxAssert(( x_num ^ x_num4 ) == 67);
		CxAssert(UInt32(~x_num)).Equals(4294967229));
		CxAssert(x_c < x_num);
		CxAssert(x_num2 < x_num);
		CxAssert(x_num3 < x_num);
		CxAssert(x_num4 < x_num);
		...
		CxAssert(x_num4 > x_num,false);
		CxAssert(x_num5 > x_num,false);
		CxAssert(UInt32(++x_num)).Equals(67));
		CxAssert(UInt32(--x_num)).Equals(66));
		CxAssert(UInt32(x_num++)).Equals(66));
		CxAssert(UInt32(x_num--)).Equals(67));
		CxAssert(UInt32(x_num << 1)).Equals(132));
		CxAssert(UInt32(x_num >> 1)).Equals(33));
		CxAssert(Char(x_c)).Equals(x_num),false);
		CxAssert(Int32(x_num2)).Equals(x_num),false);
		CxAssert(UInt32(x_num3)).Equals(x_num),false);
		CxAssert(Int64(x_num4)).Equals(x_num),false);
	...
	void UInt32Test::UInt32MiscTests()
	{
		UInt32 x_val = 0;
		UInt32 x_num = 1;
		CxAssert(UInt32(MathRaw::Max(x_val,x_num))).Equals(1));
		CxAssert(UInt32(MathRaw::Min(x_val,x_num))).Equals(0));
		StringBuilder* x_stringBuilder = new StringBuilder();
		x_stringBuilder->Append(x_num);
		CxAssert((x_stringBuilder->ToString())->Equals((new String("1"))));
	}
	...
	void UInt64Test::UInt64MethodsTest()
	{
		...
		CxAssert((x_num).Equals(5));
		CxAssert((x_num).Equals(5));
		CxAssert(UInt64(UInt64Raw::Parse((new String("77"))))).Equals(77));
		CxAssert(((new String("5")))->Equals((x_num).ToString()));
		x_num = UInt6418446744073709551615);
		CxAssert(UInt64(UInt6418446744073709551615))).Equals(x_num));
		x_num = 0;
		CxAssert(UInt64(x_num)).Equals(0));
		String* x_text = (UInt6418446744073709551615)).ToString();
		CxAssert((x_text)->Equals((new String("18446744073709551615"))));
		CxAssert(UInt64(UInt64Raw::Parse(x_text))).Equals(UInt6418446744073709551615)));
		String* x_text2 = (0).ToString();
		CxAssert((x_text2)->Equals((new String("0"))));
		CxAssert(UInt64(UInt64Raw::Parse(x_text2))).Equals(0));
		Object* x_obj = 5;
		CxAssert(x_obj->Equals(5));
		CxAssert((x_obj->ToString())->Equals((new String("5"))));
	}
	void UInt64Test::UInt64UnSignedMath()
	{
		...
		CxAssert(x_num3 <= x_num);
		x_num3 = x_num3 + x_num;
		CxAssert(UInt64(x_num3)).Equals(60001));
		CxAssert(UInt64(x_num + x_num2)).Equals(180000));
		UInt64 x_num4 = x_num - x_num2;
		CxAssert(UInt64(x_num - x_num2)).Equals(18446744073709491616));
		UInt64 x_num5 = x_num * x_num2;
		CxAssert(UInt64(x_num * x_num2)).Equals(7200000000));
		CxAssert(UInt64(x_num2 / x_num)).Equals(2));
		CxAssert(UInt64(x_num >> 2)).Equals(15000));
		CxAssert(UInt64(x_num << 1)).Equals(120000));
		Int32 x_num6 = 11;
		CxAssert(Int32(x_num6 % 5)).Equals(1));
		x_num6 = 8;
		CxAssert(( x_num6 | 1 ) == 9);
		CxAssert(( x_num6 & 1 ) == 0);
		CxAssert(Int32(++x_num6)).Equals(9));
		CxAssert(Int32(--x_num6)).Equals(8));
		CxAssert(( x_num6 = x_num6 * 2 ) == 16);
		CxAssert(( x_num6 = x_num6 / 2 ) == 8);
		CxAssert(( x_num6 = x_num6 % 2 ) == 0);
		CxAssert(( x_num6 = x_num6 | 4 ) == 4);
		CxAssert(( x_num6 = x_num6 & 4 ) == 4);
		CxAssert(UInt64(x_num)).Equals(60000));
		UInt32 x_num7 = 0;
		CxAssert(UInt32(~x_num7)).Equals(UInt324294967295)));
		CxAssert(UInt32(++x_num7)).Equals(1));
		CxAssert(UInt32(--x_num7)).Equals(0));
	}
	void UInt64Test::UInt64Operators()
	{
		...
		Float x_num8 = 1;
		Double x_num9 = 1;
		CxAssert(UInt64(x_num)).Equals(66));
		CxAssert(UInt64(x_num + x_c)).Equals(67));
		CxAssert(UInt64(x_num + x_b)).Equals(67));
		CxAssert(Int64(x_num + x_b2)).Equals(67));
		CxAssert(Int64(x_num + x_num2)).Equals(67));
		CxAssert(Int64(x_num + x_num3)).Equals(67));
		CxAssert(Int64(x_num + x_num4)).Equals(67));
		CxAssert(UInt64(x_num + x_num5)).Equals(67));
		CxAssert(UInt64(x_num + x_num6)).Equals(67));
		CxAssert(UInt64(x_num + x_num7)).Equals(67));
		CxAssert(Single(x_num + x_num8)).Equals(67));
		CxAssert(Double(x_num + x_num9)).Equals(67));
		CxAssert(UInt64(x_num - x_c)).Equals(65));
		CxAssert(UInt64(x_num - x_b)).Equals(65));
		CxAssert(Int64(x_num - x_b2)).Equals(65));
		CxAssert(Int64(x_num - x_num2)).Equals(65));
		CxAssert(Int64(x_num - x_num3)).Equals(65));
		CxAssert(Int64(x_num - x_num4)).Equals(65));
		CxAssert(UInt64(x_num - x_num5)).Equals(65));
		CxAssert(UInt64(x_num - x_num6)).Equals(65));
		CxAssert(UInt64(x_num - x_num7)).Equals(65));
		CxAssert(Single(x_num - x_num8)).Equals(65));
		CxAssert(Double(x_num - x_num9)).Equals(65));
		CxAssert(UInt64(x_num * x_c)).Equals(66));
		CxAssert(UInt64(x_num * x_b)).Equals(66));
		CxAssert(Int64(x_num * x_b2)).Equals(66));
		CxAssert(Int64(x_num * x_num2)).Equals(66));
		CxAssert(Int64(x_num * x_num3)).Equals(66));
		CxAssert(Int64(x_num * x_num4)).Equals(66));
		CxAssert(UInt64(x_num * x_num5)).Equals(66));
		CxAssert(UInt64(x_num * x_num6)).Equals(66));
		CxAssert(UInt64(x_num * x_num7)).Equals(66));
		CxAssert(Single(x_num * x_num8)).Equals(66));
		CxAssert(Double(x_num * x_num9)).Equals(66));
		CxAssert(UInt64(x_num / x_c)).Equals(66));
		CxAssert(UInt64(x_num / x_b)).Equals(66));
		CxAssert(UInt64(x_num / x_b2)).Equals(66));
		CxAssert(UInt64(x_num / x_num2)).Equals(66));
		CxAssert(UInt64(x_num / x_num3)).Equals(66));
		CxAssert(UInt64(x_num / x_num4)).Equals(66));
		CxAssert(UInt64(x_num / x_num5)).Equals(66));
		CxAssert(UInt64(x_num / x_num6)).Equals(66));
		CxAssert(UInt64(x_num / x_num7)).Equals(66));
		CxAssert(Single(x_num / x_num8)).Equals(66));
		CxAssert(Double(x_num / x_num9)).Equals(66));
		CxAssert(UInt64(x_num % x_c)).Equals(0));
		CxAssert(UInt64(x_num % x_b)).Equals(0));
		CxAssert(UInt64(x_num % x_b2)).Equals(0));
		CxAssert(UInt64(x_num % x_num2)).Equals(0));
		CxAssert(UInt64(x_num % x_num3)).Equals(0));
		CxAssert(UInt64(x_num % x_num4)).Equals(0));
		CxAssert(UInt64(x_num % x_num5)).Equals(0));
		CxAssert(UInt64(x_num % x_num6)).Equals(0));
		CxAssert(UInt64(x_num % x_num7)).Equals(0));
		CxAssert(Single(x_num % x_num8)).Equals(0));
		...
		CxAssert(UInt64(++x_num)).Equals(67));
		CxAssert(UInt64(--x_num)).Equals(66));
		CxAssert(UInt64(x_num++)).Equals(66));
		CxAssert(UInt64(x_num--)).Equals(67));
		CxAssert(UInt64(x_num << 1)).Equals(132));
		CxAssert(UInt64(x_num >> 1)).Equals(33));
		CxAssert(Char(x_c)).Equals(x_num),false);
		CxAssert(Byte(x_b)).Equals(x_num),false);
		...
		CxAssert(UInt16(x_num5)).Equals(x_num),false);
		CxAssert(UInt32(x_num6)).Equals(x_num),false);
		CxAssert(UInt64(x_num7)).Equals(x_num),false);
		CxAssert(Single(x_num8)).Equals(x_num),false);
		CxAssert(Double(x_num9)).Equals(x_num),false);
		CxAssert(!Char(x_c)).Equals(x_num));
		CxAssert(!Byte(x_b)).Equals(x_num));
		...
		CxAssert(!UInt16(x_num5)).Equals(x_num));
		CxAssert(!UInt32(x_num6)).Equals(x_num));
		CxAssert(!UInt64(x_num7)).Equals(x_num));
		CxAssert(!Single(x_num8)).Equals(x_num));
		CxAssert(!Double(x_num9)).Equals(x_num));
		CxAssert(x_c <= x_num);
		CxAssert(x_b <= x_num);
		CxAssert(x_b2 <= x_num);
		CxAssert(x_num2 <= x_num);
	...
	void UInt64Test::UInt64MiscTests()
	{
		UInt64 x_num = 0;
		UInt64 x_num2 = 1;
		CxAssert(UInt64(MathRaw::Max(x_num,x_num2))).Equals(1));
		CxAssert(UInt64(MathRaw::Min(x_num,x_num2))).Equals(0));
		StringBuilder* x_stringBuilder = new StringBuilder();
		x_stringBuilder->Append(x_num2);
		CxAssert((x_stringBuilder->ToString())->Equals((new String("1"))));
		x_stringBuilder->Insert(1,x_num);
