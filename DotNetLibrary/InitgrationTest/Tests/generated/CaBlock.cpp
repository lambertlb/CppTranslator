...
leaveBlock3:
		...
		this->x_timeSpan3dArray->SetValue((new TimeSpan(x_timeSpan)), x_indices);
		...
		this->x_timeSpan3dArray->SetValue((new TimeSpan(x_timeSpan)), 0, 0, 0);
...
IL_0000:
		...
		this->CxAssert(DateTime::Equals(x_maxValue, DateTime::MaxValue));
...
IL_0000:
		...
		this->CxAssert((x_data2.get_Ticks() == 1000));
		this->RefMethod(x_data3);
		this->CxAssert((x_data3.get_Ticks() == 1000));
...
IL_0000:
		...
		this->CxAssert(((TimeSpan(x_obj->get_AsTimeSpan())).get_Ticks() == (TimeSpan::MinValue).get_Ticks()));
...
IL_0000:
		...
		this->CxAssert(((TimeSpan(x_dateTime.get_TimeOfDay())).get_Ticks() == 450301000000));
...
IL_0000:
		...
		this->CxAssert(((x_dateTime.Add(x_timeSpan.get_Ticks())).get_Ticks() == 631945674301000000));
		...
		x_dateTime2 = x_dateTime.Subtract(x_timeSpan.get_Ticks());
		this->CxAssert((x_dateTime2.get_Ticks() == 631945530301000000));
		this->CxAssert(((TimeSpan(x_dateTime.Subtract(x_dateTime2))).get_Ticks() == 72000000000));
		x_dateTime2 = x_dateTime.ToLocalTime();
		x_dateTime2 = x_dateTime.ToUniversalTime();
		x_dateTime2 = DateTime::op_Addition(x_dateTime,x_timeSpan.get_Ticks());
		...
		x_dateTime2 = DateTime::op_Subtraction(x_dateTime,x_timeSpan.get_Ticks());
		this->CxAssert((x_dateTime2.get_Ticks() == 631945530301000000));
		...
		this->CxAssert(((DateTime(x_obj->get_AsDateTime())).get_Ticks() == 0));
