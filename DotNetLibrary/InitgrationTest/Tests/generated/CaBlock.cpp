...
namespace CABlock_NS
{
	...
	void ArrayTest::MiscTest()
	{
		...
		CxAssert((Int32Value(x_int3dArray->GetLowerBound(2))).Equals(0));
	...
	void BasicTest::StructTest()
	{
		...
		CxAssert((Int32Value(( x_ts & 1 ).get_Data())).Equals(0));
	}
	...
	void BooleanTest::RunBooleanTest()
	{
		Boolean x_flag = true;
		Object* x_obj = new BooleanValue(x_flag);
		CxAssert((Int32Value(x_flag.CompareTo(true))).Equals(0));
		CxAssert((Int32Value(x_flag.CompareTo(x_obj))).Equals(0));
		CxAssert(x_flag.Equals(true));
		CxAssert(Boolean::Parse((new String("True"))));
	...
	void BooleanTest::BoolOperators()
	{
		...
		CxAssert(x_flag = ( !(ByteValue(( ( x_flag ? 1 : 0 ) | 1 ))).Equals(0) ));
		CxAssert(x_flag = x_flag);
	}
	...
	{
		Byte x_b = 5;
		CxAssert((Int32Value(((ByteValue)x_b).CompareTo(5))).Equals(0));
		CxAssert((Int32Value(((ByteValue)x_b).CompareTo(5))).Equals(0));
		CxAssert(((ByteValue)x_b).Equals(5));
		CxAssert(((ByteValue)x_b).Equals(5));
		CxAssert((ByteValue(Byte::Parse((new String("77"))))).Equals(77));
		CxAssert((((new String("5"))))->Equals(((ByteValue)x_b).ToString()));
		x_b = Byte::MaxValue;
		CxAssert((ByteValue(Byte::MaxValue)).Equals(x_b));
		x_b = 0;
		CxAssert((ByteValue(x_b)).Equals(0));
		String* x_text = ((ByteValue)Byte::MaxValue).ToString();
		CxAssert(((x_text))->Equals((new String("255"))));
		CxAssert((ByteValue(Byte::Parse(x_text))).Equals(Byte::MaxValue));
		String* x_text2 = ( 0 ).ToString();
		CxAssert(((x_text2))->Equals((new String("0"))));
		CxAssert((ByteValue(Byte::Parse(x_text2))).Equals(0));
		Int32 x_num = 50;
		Byte x_b2 = x_num;
		...
		x_b2 = Byte::MaxValue;
		x_b2 = ( x_b2 + 1 );
		CxAssert((ByteValue(x_b2)).Equals(0));
		Object* x_obj2 = 5;
	...
	void ByteTest::DoUnSignedMath()
	{
		...
		Byte x_b6 = 0;
		CxAssert((ByteValue(( ~x_b6 ))).Equals(Byte::MaxValue));
	...
	void ByteTest::ByteOperators()
	{
		...
		CxAssert((SingleValue(x_b / x_num7)).Equals(66));
		CxAssert((DoubleValue(x_b / x_num8)).Equals(66));
		CxAssert((Int32Value(x_b % x_c)).Equals(0));
		CxAssert((Int32Value(x_b % x_b2)).Equals(0));
		CxAssert((Int32Value(x_b % x_b3)).Equals(0));
		CxAssert((Int32Value(x_b % x_num)).Equals(0));
		CxAssert((Int32Value(x_b % x_num2)).Equals(0));
		CxAssert((Int64Value(x_b % x_num3)).Equals(0));
		CxAssert((Int32Value(x_b % x_num4)).Equals(0));
		CxAssert((UInt32Value(x_b % x_num5)).Equals(0));
		CxAssert((UInt64Value(x_b % x_num6)).Equals(0));
		CxAssert((SingleValue(x_b % x_num7)).Equals(0));
		CxAssert((DoubleValue(x_b % x_num8)).Equals(0));
		CxAssert(( x_b & x_c ) == 0);
		CxAssert(( x_b & x_b2 ) == 0);
		CxAssert(( x_b & x_b3 ) == 0);
	...
	void ByteTest::ByteArrayTests()
	{
		...
		CxAssert((ByteValue(((*((Byte*)x_array2->Address(0)))))).Equals(0));
	...
	void ByteTest::ByteMiscTests()
	{
		...
		CxAssert((ByteValue(Math::Min(x_b,x_val))).Equals(0));
	...
	void CharTest::CharMethodsTest()
	{
		...
		CxAssert((CharValue(Char::ToLower('A'))).Equals('a'));
		CxAssert((CharValue(Char::ToUpper('a'))).Equals('A'));
		CxAssert((new String("a"))->Equals(((CharValue)'a').ToString()));
		CxAssert((new String("a"))->Equals(Char::ToString('a')));
		CxAssert(((CharValue)'a').Equals(Char::Parse((new String("a")))));
		Object* x_obj = new CharValue(x_c);
		CxAssert(((CharValue)'A').Equals(x_obj));
		CxAssert(((CharValue)'A').Equals(x_obj));
		CxAssert((Int32Value(((CharValue)'A').CompareTo(x_obj))).Equals(0));
	...
	void CharTest::CharOperators()
	{
		...
		CxAssert((Int64Value(x_c / x_num3)).Equals(66));
		CxAssert((DoubleValue(x_c / x_num4)).Equals(66));
		CxAssert((Int32Value(x_c % x_c2)).Equals(0));
		CxAssert((Int32Value(x_c % x_num)).Equals(0));
		CxAssert((UInt32Value(x_c % x_num2)).Equals(0));
		CxAssert((Int64Value(x_c % x_num3)).Equals(0));
		CxAssert((DoubleValue(x_c % x_num4)).Equals(0));
		CxAssert(( x_c & x_c2 ) == 0);
	...
	{
		Double x_num = 3.159;
		CxAssert((Int32Value(((DoubleValue)x_num).CompareTo(3.159))).Equals(0));
		CxAssert((Int32Value(((DoubleValue)x_num).CompareTo(new DoubleValue(3.159)))).Equals(0));
		CxAssert(((DoubleValue)x_num).Equals(3.159));
		CxAssert((DoubleValue(Double::Parse((new String("3.159"))))).Equals(3.159));
		CxAssert(((((DoubleValue)x_num).ToString()))->Equals((new String("3.159"))));
		String* x_text = ((DoubleValue)Double::MinValue).ToString();
		...
		CxAssert((DoubleValue(x_obj)).Equals(10000));
		x_num = Double::Epsilon;
		CxAssert((DoubleValue(x_num)).Equals(Double::Epsilon));
		x_num = Double::MaxValue;
		CxAssert((DoubleValue(x_num)).Equals(Double::MaxValue));
		x_num = Double::MinValue;
		CxAssert((DoubleValue(x_num)).Equals(Double::MinValue));
	...
	void DoubleTest::DoubleOperators()
	{
		...
		CxAssert((DoubleValue(x_num / x_num4)).Equals(66));
		CxAssert((DoubleValue(x_num / x_num5)).Equals(66));
		CxAssert((DoubleValue(x_num % x_c)).Equals(0));
		CxAssert((DoubleValue(x_num % x_num2)).Equals(0));
		CxAssert((DoubleValue(x_num % x_num3)).Equals(0));
		CxAssert((DoubleValue(x_num % x_num4)).Equals(0));
		CxAssert((DoubleValue(x_num % x_num5)).Equals(0));
		CxAssert(x_c < x_num);
	...
	void DoubleTest::DoubleNanTest()
	{
		...
		CxAssert(((DoubleValue)Double::NaN).Equals(Double::NaN));
	}
	void DoubleTest::DoubleArrayTest()
	{
		...
		((*((Double*)x_array2->Address(0,2)))) = Double::NaN;
		CxAssert(Double::IsNaN(((*((Double*)x_array2->Address(0,2))))));
	...
	{
		Int16 x_num = 5;
		CxAssert((Int32Value(((Int16Value)x_num).CompareTo(5))).Equals(0));
		CxAssert((Int32Value(((Int16Value)x_num).CompareTo(5))).Equals(0));
		CxAssert(((Int16Value)x_num).Equals(5));
		CxAssert(((Int16Value)x_num).Equals(5));
		CxAssert((Int16Value(Int16::Parse((new String("-55"))))).Equals(-55));
		CxAssert((((new String("-75"))))->Equals(( -75 ).ToString()));
		String* x_text = ((Int16Value)Int16::MaxValue).ToString();
		CxAssert(((x_text))->Equals((new String("32767"))));
		CxAssert((Int16Value(Int16::Parse(x_text))).Equals(Int16::MaxValue));
		String* x_text2 = ((Int16Value)Int16::MinValue).ToString();
		CxAssert(((x_text2))->Equals((new String("-32768"))));
		CxAssert((Int16Value(Int16::Parse(x_text2))).Equals(Int16::MinValue));
		Int64 x_num2 = Int64::MaxValue;
		x_num = x_num2;
	...
	void Int16Test::Int16MathTest()
	{
		...
		CxAssert((Int32Value(++x_num3)).Equals(1));
		CxAssert((Int32Value(--x_num3)).Equals(0));
	...
	void Int16Test::Int16Operators()
	{
		...
		CxAssert((SingleValue(x_num / x_num7)).Equals(66));
		CxAssert((DoubleValue(x_num / x_num8)).Equals(66));
		CxAssert((Int32Value(x_num % x_c)).Equals(0));
		CxAssert((Int32Value(x_num % x_b)).Equals(0));
		CxAssert((Int32Value(x_num % x_b2)).Equals(0));
		CxAssert((Int32Value(x_num % x_num2)).Equals(0));
		CxAssert((Int32Value(x_num % x_num3)).Equals(0));
		CxAssert((Int64Value(x_num % x_num4)).Equals(0));
		CxAssert((Int32Value(x_num % x_num5)).Equals(0));
		CxAssert((Int64Value(x_num % x_num6)).Equals(0));
		CxAssert((SingleValue(x_num % x_num7)).Equals(0));
		CxAssert((DoubleValue(x_num % x_num8)).Equals(0));
		...
		x_num = 66;
		Int16 x_num9 = 0;
		CxAssert((Int16Value(x_num9)).Equals(0));
		CxAssert((Int16Value(x_num9)).Equals(0));
		CxAssert(x_num3 <= 2);
		CxAssert(x_num3 >= -2);
	}
	...
	{
		Int32 x_num = 5;
		CxAssert((Int32Value(((Int32Value)x_num).CompareTo(5))).Equals(0));
		CxAssert((Int32Value(((Int32Value)x_num).CompareTo(new Int32Value(5)))).Equals(0));
		CxAssert(((Int32Value)x_num).Equals(5));
		CxAssert(((Int32Value)x_num).Equals(new Int32Value(5)));
		CxAssert((Int32Value(Int32::Parse((new String("-55"))))).Equals(-55));
		CxAssert((((new String("-75"))))->Equals(( -75 ).ToString()));
		String* x_text = ((Int32Value)Int32::MaxValue).ToString();
		CxAssert(((x_text))->Equals((new String("2147483647"))));
		CxAssert((Int32Value(Int32::Parse(x_text))).Equals(Int32::MaxValue));
		String* x_text2 = ((Int32Value)Int32::MinValue).ToString();
		CxAssert(((x_text2))->Equals((new String("-2147483648"))));
		CxAssert((Int32Value(Int32::Parse(x_text2))).Equals(Int32::MinValue));
		Int64 x_num2 = Int64::MaxValue;
		x_num = x_num2;
		CxAssert((Int32Value(x_num)).Equals(-1));
	...
	void Int32Test::Int32Operators()
	{
		...
		CxAssert((Int32Value(x_num % x_c)).Equals(0));
		CxAssert((Int32Value(x_num % x_num2)).Equals(0));
		CxAssert((Int64Value(x_num % x_num3)).Equals(0));
		CxAssert((Int64Value(x_num % x_num4)).Equals(0));
		CxAssert((Int64Value(( x_num % x_num5 ))).Equals(0));
		CxAssert(( x_num & x_c ) == 0);
		CxAssert(( x_num & x_num2 ) == 0);
		CxAssert(( x_num & x_num3 ) == 0);
		CxAssert(( x_num & x_num4 ) == 0);
		...
		x_num = 66;
		Int32 x_num6 = 0;
		CxAssert((Int32Value(x_num6)).Equals(0));
		CxAssert((Int32Value(x_num6)).Equals(0));
		CxAssert(x_num2 <= 2);
		CxAssert(x_num2 >= -2);
	}
	...
	{
		Int64 x_num = 5;
		CxAssert((Int32Value(((Int64Value)x_num).CompareTo(5))).Equals(0));
		CxAssert((Int32Value(((Int64Value)x_num).CompareTo(new Int64Value(5)))).Equals(0));
		CxAssert(((Int64Value)x_num).Equals(5));
		CxAssert(((Int64Value)x_num).Equals(new Int64Value(5)));
		CxAssert((Int64Value(Int64::Parse((new String("-55"))))).Equals(-55));
		String* x_text = ((Int64Value)Int64::MaxValue).ToString();
		CxAssert(((x_text))->Equals((new String("9223372036854775807"))));
		CxAssert((Int64Value(Int64::Parse(x_text))).Equals(Int64::MaxValue));
		String* x_text2 = ((Int64Value)Int64::MinValue).ToString();
		CxAssert(((x_text2))->Equals((new String("-9223372036854775808"))));
		CxAssert((Int64Value(Int64::Parse(x_text2))).Equals(Int64::MinValue));
	...
	void Int64Test::Int64Operators()
	{
		...
		CxAssert((Int64Value(x_num / x_num4)).Equals(66));
		CxAssert((DoubleValue(x_num / x_num5)).Equals(66));
		CxAssert((Int64Value(x_num % x_c)).Equals(0));
		CxAssert((Int64Value(x_num % x_num2)).Equals(0));
		CxAssert((Int64Value(x_num % x_num3)).Equals(0));
		CxAssert((Int64Value(x_num % x_num4)).Equals(0));
		CxAssert((DoubleValue(x_num % x_num5)).Equals(0));
		CxAssert(( x_num & x_c ) == 0);
	...
	void MathTest::DoMathTest()
	{
		...
		CxAssert(Math::Round(Double::NaN),Double::NaN);
		CxAssert(Math::Round(3.45,1),3.4);
		CxAssert(Math::Round(3.46,1),3.5);
		CxAssert(Math::Round(-0.123456789,1),-0.1);
		CxAssert(Math::Round(Double::NaN,1),Double::NaN);
		CxAssert(Math::Round(1.5),2);
		CxAssert(Math::Round(2.5),2);
		CxAssert(Math::Round(-1.5),-2);
		CxAssert(Math::Round(-2.5),-2);
		CxAssert(Math::Round(Double::MaxValue),Double::MaxValue);
		CxAssert(Math::Round(Double::MinValue),Double::MinValue);
		CxAssert((Int32Value(Math::Sign(2))).Equals(1));
		CxAssert((Int32Value(Math::Sign(0))).Equals(0));
		CxAssert((Int32Value(Math::Sign(-2))).Equals(-1));
		CxAssert((Int32Value(Math::Sign(2))).Equals(1));
		CxAssert((Int32Value(Math::Sign(0))).Equals(0));
		CxAssert((Int32Value(Math::Sign(-2))).Equals(-1));
		...
		CxAssert((Int32Value(Math::Sign(0))).Equals(0));
		CxAssert((Int32Value(Math::Sign(-2))).Equals(-1));
		CxAssert((Int32Value(Math::Sign(Double::Epsilon))).Equals(1));
	...
	{
		SByte x_b = 5;
		CxAssert((Int32Value(((SByteValue)x_b).CompareTo(5))).Equals(0));
		CxAssert((Int32Value(((SByteValue)x_b).CompareTo(5))).Equals(0));
		CxAssert(((SByteValue)x_b).Equals(5));
		CxAssert(((SByteValue)x_b).Equals(5));
		CxAssert((SByteValue(SByte::Parse((new String("-55"))))).Equals(-55));
		CxAssert((((new String("-75"))))->Equals(( -75 ).ToString()));
		String* x_text = ((SByteValue)SByte::MaxValue).ToString();
		CxAssert(((x_text))->Equals((new String("127"))));
		CxAssert((SByteValue(SByte::Parse(x_text))).Equals(SByte::MaxValue));
		String* x_text2 = ((SByteValue)SByte::MinValue).ToString();
		CxAssert(((x_text2))->Equals((new String("-128"))));
		CxAssert((SByteValue(SByte::Parse(x_text2))).Equals(SByte::MinValue));
		Int64 x_num = Int64::MaxValue;
		x_b = x_num;
	...
	void SByteTest::SByteMathTest()
	{
		...
		CxAssert((Int32Value(~x_num)).Equals(-1));
		CxAssert((Int32Value(++x_num)).Equals(1));
		CxAssert((Int32Value(--x_num)).Equals(0));
		CxAssert(x_b < x_b2);
		CxAssert(x_b <= x_b2);
		CxAssert(x_b2 > x_b);
		CxAssert(x_b2 >= x_b);
	...
	void SByteTest::SByteOperators()
	{
		...
		CxAssert((Int32Value(x_b % x_b2)).Equals(0));
		CxAssert((Int32Value(x_b % x_b3)).Equals(0));
		CxAssert((Int32Value(x_b % x_b4)).Equals(0));
		CxAssert((Int32Value(x_b % x_num)).Equals(0));
		CxAssert((Int64Value(x_b % x_num2)).Equals(0));
		CxAssert((Int32Value(x_b % x_num3)).Equals(0));
		CxAssert((Int64Value(x_b % x_num4)).Equals(0));
		CxAssert((SingleValue(x_b % x_num5)).Equals(0));
		CxAssert((DoubleValue(x_b % x_num6)).Equals(0));
		CxAssert(( x_b & x_c ) == 0);
		CxAssert(( x_b & x_b2 ) == 0);
		CxAssert(( x_b & x_b3 ) == 0);
		CxAssert(( x_b & x_b4 ) == 0);
		...
		x_b = 66;
		SByte x_b5 = 0;
		CxAssert((SByteValue(x_b5)).Equals(0));
		CxAssert((SByteValue(x_b5)).Equals(0));
		CxAssert(x_num <= 2);
		CxAssert(x_num >= -2);
	}
	...
	{
		Single x_num = 3.159;
		CxAssert((Int32Value(((SingleValue)x_num).CompareTo(3.159))).Equals(0));
		CxAssert((Int32Value(((SingleValue)x_num).CompareTo(new SingleValue(3.159)))).Equals(0));
		CxAssert(((SingleValue)x_num).Equals(3.159));
		CxAssert(Single::Parse((new String("3.159"))),3.15899991989136);
		CxAssert(((((SingleValue)x_num).ToString()))->Equals((new String("3.159"))));
		CxAssert(Single::Parse(((SingleValue)x_num).ToString()),x_num);
		x_num = 1E+07;
		...
		CxAssert((DoubleValue(x_obj)).Equals(10000));
		x_num = Float::Epsilon;
		CxAssert((SingleValue(x_num)).Equals(Float::Epsilon));
		x_num = Float::MaxValue;
		CxAssert((SingleValue(x_num)).Equals(Float::MaxValue));
		x_num = Float::MinValue;
		CxAssert((SingleValue(x_num)).Equals(Float::MinValue));
	...
	void SingleTest::SingleOperators()
	{
		...
		CxAssert((SingleValue(x_num / x_num4)).Equals(66));
		CxAssert((DoubleValue(x_num / x_num5)).Equals(66));
		CxAssert((SingleValue(x_num % x_c)).Equals(0));
		CxAssert((SingleValue(x_num % x_num2)).Equals(0));
		CxAssert((SingleValue(x_num % x_num3)).Equals(0));
		CxAssert((SingleValue(x_num % x_num4)).Equals(0));
		CxAssert((DoubleValue(x_num % x_num5)).Equals(0));
		CxAssert(x_c < x_num);
		CxAssert(x_num2 < x_num);
		CxAssert(x_num3 < x_num);
	...
	{
		Single x_num = Float::NaN;
		Single x_num2 = 1;
		CxAssert(Single::IsNaN(x_num));
		CxAssert(Single::IsInfinity(Float::PositiveInfinity));
		CxAssert(Single::IsNegativeInfinity(Float::NegativeInfinity));
		CxAssert(Single::IsPositiveInfinity(Float::PositiveInfinity));
		CxAssert(Single::IsNaN(x_num * x_num2));
		CxAssert(Single::IsNaN(x_num / x_num2));
		CxAssert(Single::IsNaN(x_num + x_num2));
		CxAssert(Single::IsNaN(x_num - x_num2));
		CxAssert(Single::IsNaN(x_num % x_num2));
		...
		CxAssert(((SingleValue)Float::NaN).Equals(Float::NaN));
	}
	void SingleTest::SingleArrayTest()
	{
		...
		((*((Single*)x_array2->Address(0,2)))) = Float::NaN;
		CxAssert(Single::IsNaN(((*((Single*)x_array2->Address(0,2))))));
...
','"',''','Â'};
		CxAssert((Int32Value(x_sb->get_Length())).Equals(0));
	...
	void StringBuilderTest::DoSBPropertyTest()
	{
		...
		CxAssert((Int32Value(x_sb->get_Capacity())).Equals(20) && (Int32Value(x_sb->get_MaxCapacity())).Equals(Int32::MaxValue));
	...
	void StringTest::DoMiscTest()
	{
		...
		CxAssert((Int32Value(String::Compare((new String("abc")),(new String("ABC")),true))).Equals(0));
		CxAssert((Int32Value(String::Compare((new String("1abce")),1,(new String("abc")),0,3))).Equals(0));
		CxAssert((Int32Value(String::Compare((new String("1abce")),1,(new String("ABC")),0,3,true))).Equals(0));
		CxAssert((Int32Value(String::CompareOrdinal((new String("abc")),(new String("abc"))))).Equals(0));
		CxAssert((Int32Value(String::CompareOrdinal((new String("1abce")),1,(new String("abc")),0,3))).Equals(0));
	...
	void StringTest::DoParsingTest()
	{
		...
		CxAssert((Int32Value(x_text6->LastIndexOf((new String("11")),4))).Equals(0));
		CxAssert((Int32Value(x_text6->LastIndexOf((new String("11")),4,5))).Equals(0));
		...
		if ( !(Int32Value(x_text7->CompareTo((new String("3.33"))))).Equals(0) )
		{
			CxAssert(false);
		}
	}
	...
	void TimeTest::TestTimeSpan()
	{
		...
		CxAssert((Int64Value(( x_obj ).get_Ticks())).Equals(TimeSpan::MinValue.get_Ticks()));
		TimeSpan x_minValue = TimeSpan::MinValue;
		CxAssert(x_minValue.Equals(x_obj));
		CxAssert((Int32Value(TimeSpan::MinValue.CompareTo(x_obj))).Equals(0));
	...
	{
		CxAssert((Int64Value(DateTime().get_Ticks())).Equals(0));
	...
	void TimeTest::DateTimeMethodTests()
	{
		...
		CxAssert((Int64Value(DateTime::MinValue.get_Ticks())).Equals(0));
		CxAssert((Int64Value(DateTime::MaxValue.get_Ticks())).Equals(3155378975999999999));
		Object* x_obj = DateTime::MinValue;
		CxAssert((Int64Value(( x_obj ).get_Ticks())).Equals(0));
		CxAssert(DateTime::MinValue.Equals(x_obj));
		CxAssert((Int32Value(DateTime::MinValue.CompareTo(x_obj))).Equals(0));
	...
	{
		UInt16 x_num = 5;
		CxAssert((Int32Value(((UInt16Value)x_num).CompareTo(5))).Equals(0));
		CxAssert((Int32Value(((UInt16Value)x_num).CompareTo(5))).Equals(0));
		CxAssert(((UInt16Value)x_num).Equals(5));
		CxAssert(((UInt16Value)x_num).Equals(5));
		CxAssert((UInt16Value(UInt16::Parse((new String("77"))))).Equals(77));
		CxAssert((((new String("5"))))->Equals(((UInt16Value)x_num).ToString()));
		x_num = UInt16::MaxValue;
		CxAssert((UInt16Value(UInt16::MaxValue)).Equals(x_num));
		x_num = 0;
		CxAssert((UInt16Value(x_num)).Equals(0));
		String* x_text = ((UInt16Value)UInt16::MaxValue).ToString();
		CxAssert(((x_text))->Equals((new String("65535"))));
		CxAssert((UInt16Value(UInt16::Parse(x_text))).Equals(UInt16::MaxValue));
		String* x_text2 = ( 0 ).ToString();
		CxAssert(((x_text2))->Equals((new String("0"))));
		CxAssert((UInt16Value(UInt16::Parse(x_text2))).Equals(0));
		Object* x_obj = 5;
		CxAssert(x_obj->Equals(5));
		CxAssert(((x_obj->ToString()))->Equals((new String("5"))));
	}
	void UInt16Test::DoUnSignedMath()
	{
		...
		UInt32 x_num5 = 0;
		CxAssert((UInt32Value(~x_num5)).Equals(UInt32::MaxValue));
		CxAssert((UInt32Value(++x_num5)).Equals(1));
		CxAssert((UInt32Value(--x_num5)).Equals(0));
	}
	...
	void UInt16Test::UInt16MiscTests()
	{
		...
		CxAssert((UInt16Value(Math::Min(x_num,x_num2))).Equals(0));
		StringBuilder* x_stringBuilder = new StringBuilder();
	...
	{
		UInt32 x_num = 5;
		CxAssert((Int32Value(((UInt32Value)x_num).CompareTo(5))).Equals(0));
		CxAssert((Int32Value(((UInt32Value)x_num).CompareTo(new UInt32Value(5)))).Equals(0));
		CxAssert(((UInt32Value)x_num).Equals(5));
		CxAssert(((UInt32Value)x_num).Equals(new UInt32Value(5)));
		CxAssert((UInt32Value(UInt32::Parse((new String("77"))))).Equals(77));
		CxAssert((((new String("5"))))->Equals(((UInt32Value)x_num).ToString()));
		x_num = UInt32::MaxValue;
		CxAssert((Int32Value(-1)).Equals(x_num));
		x_num = 0;
		CxAssert((UInt32Value(x_num)).Equals(0));
		String* x_text = ((UInt32Value)UInt32::MaxValue).ToString();
		CxAssert(((x_text))->Equals((new String("4294967295"))));
		CxAssert((UInt32Value(UInt32::Parse(x_text))).Equals(UInt32::MaxValue));
		String* x_text2 = ((UInt32Value)0).ToString();
		CxAssert(((x_text2))->Equals((new String("0"))));
		CxAssert((UInt32Value(UInt32::Parse(x_text2))).Equals(0));
	...
	void UInt32Test::UInt32Operators()
	{
		...
		CxAssert((Int64Value(x_num / x_num4)).Equals(66));
		CxAssert((DoubleValue(x_num / x_num5)).Equals(66));
		CxAssert((UInt32Value(x_num % x_c)).Equals(0));
		CxAssert((Int64Value(x_num % x_num2)).Equals(0));
		CxAssert((UInt32Value(x_num % x_num3)).Equals(0));
		CxAssert((Int64Value(x_num % x_num4)).Equals(0));
		CxAssert((DoubleValue(x_num % x_num5)).Equals(0));
		CxAssert(( x_num & x_c ) == 0);
		CxAssert(( x_num & x_num2 ) == 0);
	...
	void UInt32Test::UInt32MiscTests()
	{
		...
		CxAssert((UInt32Value(Math::Min(x_val,x_num))).Equals(0));
		StringBuilder* x_stringBuilder = new StringBuilder();
		x_stringBuilder->Append(x_num);
		CxAssert(((x_stringBuilder->ToString()))->Equals((new String("1"))));
	}
	...
	{
		UInt64 x_num = 5;
		CxAssert((Int32Value(((UInt64Value)x_num).CompareTo(5))).Equals(0));
		CxAssert((Int32Value(((UInt64Value)x_num).CompareTo(new UInt64Value(5)))).Equals(0));
		CxAssert(((UInt64Value)x_num).Equals(5));
		CxAssert(((UInt64Value)x_num).Equals(new UInt64Value(5)));
		CxAssert((UInt64Value(UInt64::Parse((new String("77"))))).Equals(77));
		CxAssert((((new String("5"))))->Equals(((UInt64Value)x_num).ToString()));
		x_num = UInt64::MaxValue;
		CxAssert((UInt64Value(UInt64::MaxValue)).Equals(x_num));
		x_num = 0;
		CxAssert((UInt64Value(x_num)).Equals(0));
		String* x_text = ((UInt64Value)UInt64::MaxValue).ToString();
		CxAssert(((x_text))->Equals((new String("18446744073709551615"))));
		CxAssert((UInt64Value(UInt64::Parse(x_text))).Equals(UInt64::MaxValue));
		String* x_text2 = ((UInt64Value)0).ToString();
		CxAssert(((x_text2))->Equals((new String("0"))));
		CxAssert((UInt64Value(UInt64::Parse(x_text2))).Equals(0));
	...
	void UInt64Test::UInt64UnSignedMath()
	{
		...
		UInt32 x_num7 = 0;
		CxAssert((UInt32Value(~x_num7)).Equals(UInt32::MaxValue));
		CxAssert((UInt32Value(++x_num7)).Equals(1));
		CxAssert((UInt32Value(--x_num7)).Equals(0));
	}
	void UInt64Test::UInt64Operators()
	{
		...
		CxAssert((SingleValue(x_num / x_num8)).Equals(66));
		CxAssert((DoubleValue(x_num / x_num9)).Equals(66));
		CxAssert((UInt64Value(x_num % x_c)).Equals(0));
		CxAssert((UInt64Value(x_num % x_b)).Equals(0));
		CxAssert((UInt64Value(x_num % x_b2)).Equals(0));
		CxAssert((UInt64Value(x_num % x_num2)).Equals(0));
		CxAssert((UInt64Value(x_num % x_num3)).Equals(0));
		CxAssert((UInt64Value(x_num % x_num4)).Equals(0));
		CxAssert((UInt64Value(x_num % x_num5)).Equals(0));
		CxAssert((UInt64Value(x_num % x_num6)).Equals(0));
		CxAssert((UInt64Value(x_num % x_num7)).Equals(0));
		CxAssert((SingleValue(x_num % x_num8)).Equals(0));
		CxAssert((DoubleValue(x_num % x_num9)).Equals(0));
		CxAssert(( x_num & x_c ) == 0);
		CxAssert(( x_num & x_b ) == 0);
		CxAssert(( x_num & x_b2 ) == 0);
		CxAssert(( x_num & x_num2 ) == 0);
	...
	void UInt64Test::UInt64MiscTests()
	{
		...
		CxAssert((UInt64Value(Math::Min(x_num,x_num2))).Equals(0));
		StringBuilder* x_stringBuilder = new StringBuilder();
		x_stringBuilder->Append(x_num2);
		CxAssert(((x_stringBuilder->ToString()))->Equals((new String("1"))));
		x_stringBuilder->Insert(1,x_num);
