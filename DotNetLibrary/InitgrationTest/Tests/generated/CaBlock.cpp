...
namespace CABlock_NS
{
	...
	void BooleanTestRaw::RunBooleanTest()
	{
		Boolean x_flag = true;
		Object x_obj = (new BooleanBox(new BooleanBox(x_flag) ));
		CxAssert(x_flag.CompareTo(true).Equals(0));
		CxAssert(x_flag.CompareTo(x_obj).Equals(0));
	...
	{
		Byte x_b = 5;
		CxAssert(x_b.CompareTo(5).Equals(0));
		CxAssert(x_b.CompareTo((new ByteBox(5 ))).Equals(0));
		CxAssert(x_b.Equals(5));
		CxAssert(x_b.Equals((new ByteBox(5 ))));
		...
		Int32 x_num = 50;
		Byte x_b2 = x_num;
		Object x_obj = (new Int32Box(new Int32Box(x_num) ));
	...
	void ByteTestRaw::ByteOperators()
	{
		...
		CxAssert(x_b + x_num7.Equals(67));
		CxAssert(x_b + x_num8.Equals(67));
		...
		CxAssert(x_b - x_num7.Equals(65));
		CxAssert(x_b - x_num8.Equals(65));
		...
		CxAssert(x_b * x_num7.Equals(66));
		CxAssert(x_b * x_num8.Equals(66));
		CxAssert(x_b / x_c.Equals(66));
		CxAssert(x_b / x_b2.Equals(66));
		CxAssert(x_b / x_b3.Equals(66));
		CxAssert(x_b / x_num.Equals(66));
		...
		CxAssert(x_b / x_num7.Equals(66));
		CxAssert(x_b / x_num8.Equals(66));
		CxAssert(x_b % x_c.Equals(0));
		CxAssert(x_b % x_b2.Equals(0));
		CxAssert(x_b % x_b3.Equals(0));
		CxAssert(x_b % x_num.Equals(0));
		CxAssert(x_b % x_num2.Equals(0));
		CxAssert(x_b % x_num3.Equals(0));
		CxAssert(x_b % x_num4.Equals(0));
		CxAssert(x_b % x_num5.Equals(0));
		CxAssert(x_b % x_num6.Equals(0));
		CxAssert(x_b % x_num7.Equals(0));
		CxAssert(x_b % x_num8.Equals(0));
		CxAssert(( x_b & x_c ) == 0);
		CxAssert(( x_b & x_b2 ) == 0);
		CxAssert(( x_b & x_b3 ) == 0);
	...
	void CharTestRaw::CharMethodsTest()
	{
		...
		CxAssert('A'.CompareTo(x_obj).Equals(0));
	...
	void CharTestRaw::CharOperators()
	{
		...
		CxAssert(( x_c ^ x_num2 ) == 67);
		CxAssert(( x_c ^ x_num3 ) == 67);
		CxAssert(~x_c.Equals(4294967229));
		CxAssert(x_c2 < x_c);
		CxAssert(x_num < x_c);
		CxAssert(x_num2 < x_c);
		CxAssert(x_num3 < x_c);
		...
		CxAssert(x_c << 1.Equals(132));
		CxAssert(x_c >> 1.Equals(33));
	...
	{
		Double x_num = 3.159;
		CxAssert(x_num.CompareTo(3.159).Equals(0));
		CxAssert(x_num.CompareTo((new DoubleBox(3.159 ))).Equals(0));
	...
	{
		Int16 x_num = 5;
		CxAssert(x_num.CompareTo(5).Equals(0));
		CxAssert(x_num.CompareTo((new Int16Box(5 ))).Equals(0));
		CxAssert(x_num.Equals(5));
		CxAssert(x_num.Equals((new Int16Box(5 ))));
	...
	void Int16TestRaw::Int16Operators()
	{
		...
		CxAssert(x_num + x_num8.Equals(67));
		CxAssert(x_num - x_c.Equals(65));
		...
		CxAssert(x_num - x_num8.Equals(65));
		CxAssert(x_num * x_c.Equals(66));
		...
		CxAssert(x_num * x_num8.Equals(66));
		CxAssert(x_num / x_c.Equals(66));
		CxAssert(x_num / x_b.Equals(66));
		CxAssert(x_num / x_b2.Equals(66));
		CxAssert(x_num / x_num2.Equals(66));
		...
		CxAssert(x_num % x_num8.Equals(0));
	...
	void Int32TestRaw::Int32MethodsTest()
	{
		Int32 x_num = 5;
		CxAssert(x_num.CompareTo(5).Equals(0));
		CxAssert(x_num.CompareTo((new Int32Box(5 ))).Equals(0));
		CxAssert(x_num.Equals(5));
	...
	void Int64TestRaw::Int64MethodsTest()
	{
		Int64 x_num = 5;
		CxAssert(x_num.CompareTo(5).Equals(0));
		CxAssert(x_num.CompareTo((new Int64Box(5 ))).Equals(0));
		CxAssert(x_num.Equals(5));
	...
	void SByteTestRaw::SByteMethodsTest()
	{
		SByte x_b = 5;
		CxAssert(x_b.CompareTo(5).Equals(0));
		CxAssert(x_b.CompareTo((new SByteBox(5 ))).Equals(0));
		CxAssert(x_b.Equals(5));
		CxAssert(x_b.Equals((new SByteBox(5 ))));
	...
	void SingleTestRaw::DoSingleMethodsTest()
	{
		Float x_num = 3.159;
		CxAssert(x_num.CompareTo(3.159).Equals(0));
		CxAssert(x_num.CompareTo((new SingleBox(3.159 ))).Equals(0));
		CxAssert(x_num.Equals(3.159));
		...
		CxAssert(( Single ) x_obj->get_AsSingle().Equals(10000));
		x_num = Float::Epsilon;
...
','"',''','Â'};
	...
	void StringBuilderTestRaw::DoSBPropertyTest()
	{
		...
		CxAssert(x_sb->get_Capacity().Equals(20) && x_sb->get_MaxCapacity().Equals(((Int32)2147483647)));
	...
	void TimeTestRaw::TestTimeSpan()
	{
		...
		CxAssert(x_timeSpan.CompareTo((new TimeSpanBox(new TimeSpanBox(x_timeSpan2) ))) < 0);
		...
		CxAssert(TimeSpan::MinValue.CompareTo(x_obj).Equals(0));
	...
	void TimeTestRaw::DateTimeMethodTests()
	{
		...
		CxAssert(x_dateTime.Add(x_timeSpan).get_Ticks().Equals(631945674301000000));
		CxAssert(x_dateTime.AddDays(1.5).get_Ticks().Equals(631946898301000000));
		CxAssert(x_dateTime.AddHours(2.5).get_Ticks().Equals(631945692301000000));
		CxAssert(x_dateTime.AddMilliseconds(159).get_Ticks().Equals(631945602302590000));
		CxAssert(x_dateTime.AddMinutes(3.2).get_Ticks().Equals(631945604221000000));
		CxAssert(x_dateTime.AddMonths(5).get_Ticks().Equals(632077794301000000));
		CxAssert(x_dateTime.AddSeconds(6.66).get_Ticks().Equals(631945602367600000));
		CxAssert(x_dateTime.AddTicks(666).get_Ticks().Equals(631945602301000666));
		...
		CxAssert(x_dateTime.Subtract(x_dateTime2).get_Ticks().Equals(72000000000));
		...
		CxAssert(((DateTime)0).get_Ticks().Equals(0));
		CxAssert(((DateTime)3155378975999999999).get_Ticks().Equals(3155378975999999999));
	...
	void UInt16TestRaw::UInt16MethodsTest()
	{
		UInt16 x_num = 5;
		CxAssert(x_num.CompareTo(5).Equals(0));
		CxAssert(x_num.CompareTo((new UInt16Box(5 ))).Equals(0));
		CxAssert(x_num.Equals(5));
		CxAssert(x_num.Equals((new UInt16Box(5 ))));
	...
	void UInt32TestRaw::UInt32MethodsTest()
	{
		UInt32 x_num = 5;
		CxAssert(x_num.CompareTo(5).Equals(0));
		CxAssert(x_num.CompareTo((new UInt32Box(5 ))).Equals(0));
		CxAssert(x_num.Equals(5));
	...
	void UInt64TestRaw::UInt64MethodsTest()
	{
		UInt64 x_num = 5;
		CxAssert(x_num.CompareTo(5).Equals(0));
		CxAssert(x_num.CompareTo((new UInt64Box(5 ))).Equals(0));
		CxAssert(x_num.Equals(5));
	...
	void UInt64TestRaw::UInt64Operators()
	{
		...
		CxAssert(x_num + x_num7.Equals(67));
		CxAssert(x_num + x_num8.Equals(67));
		CxAssert(x_num + x_num9.Equals(67));
		CxAssert(x_num - x_c.Equals(65));
		CxAssert(x_num - x_b.Equals(65));
		CxAssert(x_num - x_b2.Equals(65));
		CxAssert(x_num - x_num2.Equals(65));
		...
		CxAssert(x_num - x_num7.Equals(65));
		CxAssert(x_num - x_num8.Equals(65));
		CxAssert(x_num - x_num9.Equals(65));
		CxAssert(x_num * x_c.Equals(66));
		CxAssert(x_num * x_b.Equals(66));
		CxAssert(x_num * x_b2.Equals(66));
		CxAssert(x_num * x_num2.Equals(66));
		...
		CxAssert(x_num * x_num7.Equals(66));
		CxAssert(x_num * x_num8.Equals(66));
		CxAssert(x_num * x_num9.Equals(66));
		CxAssert(x_num / x_c.Equals(66));
		CxAssert(x_num / x_b.Equals(66));
		CxAssert(x_num / x_b2.Equals(66));
		CxAssert(x_num / x_num2.Equals(66));
		...
		CxAssert(x_num % x_num7.Equals(0));
		CxAssert(x_num % x_num8.Equals(0));
		CxAssert(x_num % x_num9.Equals(0));
		CxAssert(( x_num & x_c ) == 0);
		CxAssert(( x_num & x_b ) == 0);
		CxAssert(( x_num & x_b2 ) == 0);
		CxAssert(( x_num & x_num2 ) == 0);
