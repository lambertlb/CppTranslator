...
namespace CABlock_NS
{
	...
	void ArrayTestRaw::Test()
	{
		...
		CxAssert(!(x_num4).Equals((( Int32 ) 0)));
	...
	{
		CxAssert((x_int3dArray->GetLength(2)).Equals((( Int32 ) 4)));
		CxAssert((x_int3dArray->GetLowerBound(2)).Equals((( Int32 ) 0)));
		CxAssert((x_int3dArray->GetUpperBound(2)).Equals((( Int32 ) 3)));
	...
	void ArrayTestRaw::ArrayMethodTests()
	{
		...
		CxAssert((x_length).Equals((( Int32 ) 16)));
		CxAssert((x_int1dArray->get_Rank()).Equals((( Int32 ) 1)));
		CxAssert((x_int2dArray->get_Rank()).Equals((( Int32 ) 2)));
		CxAssert((x_int3dArray->get_Rank()).Equals((( Int32 ) 3)));
		...
		for ( Int32 x_i = (( Int32 ) 0) ;  x_i < x_dateTime1dArray->get_Length() ;   x_i++ )
		{
		...
		for ( Int32 x_j = (( Int32 ) 1) ;  x_j < x_array->get_Length() ;   x_j++ )
		{
		...
		CxAssert((x_num).Equals((( Double ) 22)));
		...
		CxAssert(((*x_array2->Address(1))).Equals((( Double ) 2)));
		x_array2->SetValue(2,1);
		CxAssert(((*x_array2->Address(1))).Equals((( Double ) 2)));
	}
	...
	void BasicTestRaw::SwitchTest()
	{
		...
		CxAssert((x_num).Equals((( Int32 ) 1)));
		CxAssert((x_field1).Equals((( Int32 ) 2)));
	}
	void BasicTestRaw::IfThenElseTest()
	{
		x_field1 = 1;
		if ( (x_field1).Equals((( Int32 ) 1)) )
		{
			x_field1 = 2;
			if ( (x_field1).Equals((( Int32 ) 3)) )
			{
				x_field1 = 4;
			}
			else
		...
		CxAssert((x_field1).Equals((( Int32 ) 5)));
		CxAssert(ObjectRaw::Equals(nullptr,nullptr));
	}
	void BasicTestRaw::StructTest()
	{
		TestStruct x_ts = TestStruct(2);
		CxAssert((x_ts.get_Data()).Equals((( Int32 ) 2)));
		x_ts.set_Data(3);
		CxAssert((x_ts.get_Data()).Equals((( Int32 ) 3)));
		x_ts = x_ts + 1;
		CxAssert((x_ts.get_Data()).Equals((( Int32 ) 4)));
		CxAssert((( x_ts & 1 ).get_Data()).Equals((( Int32 ) 0)));
	}
	void BasicTestRaw::StructTest2()
	{
		TestStruct3 x_testStruct = ( TestStruct3 ) TestStruct3();
		x_testStruct.x_ts.x_data = 6;
		CxAssert((x_testStruct.x_ts.x_data).Equals((( Int32 ) 6)));
		x_ts3.x_ts.x_data = 7;
		CxAssert((x_ts3.x_ts.x_data).Equals((( Int32 ) 7)));
	}
	void BasicTestRaw::VirtualMethodTest()
	{
		PointerType<TestAbstractRaw> x_testAbstract = new TestAbstractRaw();
		CxAssert((x_testAbstract->MustImplement()).Equals((( Int32 ) 2)));
		CxAssert((x_testAbstract->DidImplement()).Equals((( Int32 ) 1)));
	}
	void BasicTestRaw::PassByReferenceTest()
	{
		...
		RefMethod(x_data);
		CxAssert((x_data).Equals((( Int32 ) 1)));
		RefMethod(x_data2);
		CxAssert((x_data2.get_Ticks()).Equals((( Int64 ) 1000)));
		RefMethod(x_data3);
		CxAssert((x_data3.get_Ticks()).Equals((( Int64 ) 1000)));
		RefMethod(x_data4);
		CxAssert((x_data4)->Equals((new StringRaw("Test"))));
		RefMethod(x_data5);
		CxAssert((x_data5->MustImplement()).Equals((( Int32 ) 2)));
	}
	void BasicTestRaw::RefMethod(Int32&  x_data)
	{
		if ( (x_data).Equals((( Int32 ) 0)) )
		{
			x_data = 1;
		}
	}
	...
	void BasicTestRaw::ComplexConditions()
	{
		...
		CxAssert(!( ( x_flag || x_flag2 ) && x_flag3 ) || ( Boolean ) ( x_flag4 && x_flag5 && x_flag3 ) || x_flag2);
		CxAssert(!x_flag && !x_flag2 && x_flag3 && x_flag4 && x_flag5);
		CxAssert(x_flag || x_flag2 || ( Boolean ) ( x_flag3 && x_flag4 && x_flag5 ));
	...
	{
		return ( x_a < (( Int32 ) 5) && x_b < (( Int32 ) 3) ) || x_a + x_b > (( Int32 ) 20);
	}
	...
	{
		Boolean x_flag = true;
		Object x_obj = (new BooleanBox(new BooleanBox(x_flag) ));
	...
	void BooleanTestRaw::RunBooleanTest()
	{
		Boolean x_flag = true;
		Object x_obj = (new BooleanBox(new BooleanBox(x_flag) ));
		CxAssert((x_flag.CompareTo(true)).Equals((( Int32 ) 0)));
		CxAssert((x_flag.CompareTo(x_obj)).Equals((( Int32 ) 0)));
	...
	{
		Byte x_b = (( Byte ) 5);
		CxAssert((x_b.CompareTo(5)).Equals((( Int32 ) 0)));
		CxAssert((x_b.CompareTo((new ByteBox((( Byte ) 5) )))).Equals((( Int32 ) 0)));
		CxAssert(x_b.Equals(5));
		CxAssert(x_b.Equals((new ByteBox((( Byte ) 5) ))));
		CxAssert((ByteRaw::Parse((new StringRaw("77")))).Equals((( Byte ) 77)));
		CxAssert(((new StringRaw("5")))->Equals(x_b.ToString()));
		x_b = ((Byte)255);
		CxAssert((((Byte)255)).Equals(x_b));
		x_b = 0;
		CxAssert((x_b).Equals((( Byte ) 0)));
		String x_text = ((Byte)255).ToString();
		CxAssert((x_text)->Equals((new StringRaw("255"))));
		CxAssert((ByteRaw::Parse(x_text)).Equals(((Byte)255)));
		String x_text2 = ( (( Byte ) 0) ).ToString();
		CxAssert((x_text2)->Equals((new StringRaw("0"))));
		CxAssert((ByteRaw::Parse(x_text2)).Equals((( Byte ) 0)));
	...
	void ByteTestRaw::DoUnSignedMath()
	{
		...
		CxAssert((x_b + x_b2).Equals((( Int32 ) 180)));
		Byte x_b5 = ( Byte ) ( x_b - x_b2 );
		CxAssert((x_b5).Equals((( Byte ) 196)));
		CxAssert((( Byte ) ( x_b - x_b2 )).Equals((( Byte ) 196)));
		CxAssert((x_b3 * x_b4).Equals((( Int32 ) 72)));
		CxAssert((x_b2 / x_b).Equals((( Int32 ) 2)));
		CxAssert((x_b >> (( Byte ) 2)).Equals((( Int32 ) 15)));
		CxAssert((x_b << (( Byte ) 1)).Equals((( Int32 ) 120)));
		Int32 x_num2 = (( Int32 ) 11);
		CxAssert((x_num2 % (( Int32 ) 5)).Equals((( Int32 ) 1)));
		x_num2 = 8;
		CxAssert(( x_num2 | (( Int32 ) 1) ) == 9);
		CxAssert(( x_num2 & (( Int32 ) 1) ) == 0);
		CxAssert((++x_num2).Equals((( Int32 ) 9)));
		CxAssert((--x_num2).Equals((( Int32 ) 8)));
		...
		CxAssert((x_b).Equals((( Byte ) 60)));
		Byte x_b6 = (( Byte ) 0);
		CxAssert((( Byte ) ( ~x_b6 )).Equals(((Byte)255)));
		CxAssert(( x_b6 = ( Byte ) ( x_b6 + (( Byte ) 1) ) ) == 1);
		CxAssert(( x_b6 = ( Byte ) ( x_b6 - (( Byte ) 1) ) ) == 0);
	}
	void ByteTestRaw::ByteOperators()
	{
		...
		CxAssert((x_b).Equals((( Byte ) 66)));
		CxAssert((x_b + x_c).Equals((( Int32 ) 67)));
		CxAssert((x_b + x_b2).Equals((( Int32 ) 67)));
		CxAssert((x_b + x_b3).Equals((( Int32 ) 67)));
		CxAssert((x_b + x_num).Equals((( Int32 ) 67)));
		CxAssert((x_b + x_num2).Equals((( Int32 ) 67)));
		CxAssert((x_b + x_num3).Equals((( Int64 ) 67)));
		CxAssert((x_b + x_num4).Equals((( Int32 ) 67)));
		CxAssert((x_b + x_num5).Equals((( UInt32 ) 67)));
		CxAssert((x_b + x_num6).Equals((( UInt64 ) 67)));
		CxAssert((x_b + x_num7).Equals((( Single ) 67)));
		CxAssert((x_b + x_num8).Equals((( Double ) 67)));
		CxAssert((x_b - x_c).Equals((( Int32 ) 65)));
		CxAssert((x_b - x_b2).Equals((( Int32 ) 65)));
		CxAssert((x_b - x_b3).Equals((( Int32 ) 65)));
		CxAssert((x_b - x_num).Equals((( Int32 ) 65)));
		CxAssert((x_b - x_num2).Equals((( Int32 ) 65)));
		CxAssert((x_b - x_num3).Equals((( Int64 ) 65)));
		CxAssert((x_b - x_num4).Equals((( Int32 ) 65)));
		CxAssert((x_b - x_num5).Equals((( UInt32 ) 65)));
		CxAssert((x_b - x_num6).Equals((( UInt64 ) 65)));
		CxAssert((x_b - x_num7).Equals((( Single ) 65)));
		CxAssert((x_b - x_num8).Equals((( Double ) 65)));
		CxAssert((x_b * x_c).Equals((( Int32 ) 66)));
		CxAssert((x_b * x_b2).Equals((( Int32 ) 66)));
		CxAssert((x_b * x_b3).Equals((( Int32 ) 66)));
		CxAssert((x_b * x_num).Equals((( Int32 ) 66)));
		CxAssert((x_b * x_num2).Equals((( Int32 ) 66)));
		CxAssert((x_b * x_num3).Equals((( Int64 ) 66)));
		CxAssert((x_b * x_num4).Equals((( Int32 ) 66)));
		CxAssert((x_b * x_num5).Equals((( UInt32 ) 66)));
		CxAssert((x_b * x_num6).Equals((( UInt64 ) 66)));
		CxAssert((x_b * x_num7).Equals((( Single ) 66)));
		CxAssert((x_b * x_num8).Equals((( Double ) 66)));
		CxAssert((x_b / x_c).Equals((( Int32 ) 66)));
		CxAssert((x_b / x_b2).Equals((( Int32 ) 66)));
		CxAssert((x_b / x_b3).Equals((( Int32 ) 66)));
		CxAssert((x_b / x_num).Equals((( Int32 ) 66)));
		...
		CxAssert((x_b / x_num7).Equals((( Single ) 66)));
		CxAssert((x_b / x_num8).Equals((( Double ) 66)));
		CxAssert((x_b % x_c).Equals((( Int32 ) 0)));
		CxAssert((x_b % x_b2).Equals((( Int32 ) 0)));
		CxAssert((x_b % x_b3).Equals((( Int32 ) 0)));
		CxAssert((x_b % x_num).Equals((( Int32 ) 0)));
		CxAssert((x_b % x_num2).Equals((( Int32 ) 0)));
		CxAssert((x_b % x_num3).Equals((( Int64 ) 0)));
		CxAssert((x_b % x_num4).Equals((( Int32 ) 0)));
		CxAssert((x_b % x_num5).Equals((( UInt32 ) 0)));
		CxAssert((x_b % x_num6).Equals((( UInt64 ) 0)));
		CxAssert((x_b % x_num7).Equals((( Single ) 0)));
		CxAssert((x_b % x_num8).Equals((( Double ) 0)));
		CxAssert(( x_b & x_c ) == 0);
		CxAssert(( x_b & x_b2 ) == 0);
		CxAssert(( x_b & x_b3 ) == 0);
		...
		CxAssert(( x_b ^ x_num5 ) == 67);
		CxAssert(( x_b ^ x_num6 ) == 67);
		CxAssert((( Byte ) ( ~x_b )).Equals((( Byte ) 189)));
		CxAssert(x_c < x_b);
		CxAssert(x_b2 < x_b);
		CxAssert(x_b3 < x_b);
		CxAssert(x_num < x_b);
		...
		CxAssert(( x_b = ( Byte ) ( x_b + (( Byte ) 1) ) ) == 67);
		CxAssert(( x_b = ( Byte ) ( x_b - (( Byte ) 1) ) ) == 66);
		CxAssert((x_b++).Equals((( Byte ) 66)));
		CxAssert((x_b--).Equals((( Byte ) 67)));
		CxAssert((x_b << (( Byte ) 1)).Equals((( Int32 ) 132)));
		CxAssert((x_b >> (( Byte ) 1)).Equals((( Int32 ) 33)));
		...
		CxAssert((x_num7).Equals(x_b),false);
		CxAssert((x_num8).Equals(x_b),false);
		...
		CxAssert(!(x_num7).Equals(x_b));
		CxAssert(!(x_num8).Equals(x_b));
		CxAssert(x_c <= x_b);
		CxAssert(x_b2 <= x_b);
		CxAssert(x_b3 <= x_b);
		CxAssert(x_num <= x_b);
		...
		CxAssert(x_num7 >= x_b,false);
		CxAssert(x_num8 >= x_b,false);
		CxAssert(( x_b = ( Byte ) ( x_b + x_c ) ) == 67);
		CxAssert(( x_b = ( Byte ) ( x_b - x_c ) ) == 66);
		CxAssert(( x_b = ( Byte ) ( x_b + x_num5 ) ) == 67);
		CxAssert(( x_b = ( Byte ) ( x_b - x_num5 ) ) == 66);
		CxAssert(( x_b = ( Byte ) ( x_b * x_c ) ) == 66);
		CxAssert(( x_b = ( Byte ) ( x_b / x_c ) ) == 66);
		CxAssert(( x_b = ( Byte ) ( x_b * x_num5 ) ) == 66);
		CxAssert(( x_b = ( Byte ) ( x_b / x_num5 ) ) == 66);
		CxAssert(( x_b = ( Byte ) ( x_b % x_c ) ) == 0);
		x_b = 66;
		CxAssert(( x_b = ( Byte ) ( x_b % x_num5 ) ) == 0);
		x_b = 66;
		CxAssert(( x_b = ( Byte ) ( x_b & x_c ) ) == 0);
		x_b = 66;
		CxAssert(( x_b = ( Byte ) ( x_b & x_num5 ) ) == 0);
		...
		CxAssert(( x_b = ( Byte ) ( x_b ^ x_num5 ) ) == 67);
		x_b = 66;
		CxAssert(( x_b = ( Byte ) ( x_b << x_c ) ) == 132);
		x_b = 66;
		CxAssert(( x_b = ( Byte ) ( x_b << x_num2 ) ) == 132);
		x_b = 66;
		CxAssert(( x_b = ( Byte ) ( x_b >> x_c ) ) == 33);
		x_b = 66;
		CxAssert(( x_b = ( Byte ) ( x_b >> x_num2 ) ) == 33);
		x_b = 66;
		Char x_c2 = 'B';
		CxAssert(( x_c2 = ( Char ) ( x_c2 << x_c ) ) == '');
	}
	void ByteTestRaw::ByteArrayTests()
	{
		...
		CxAssert(((*x_array2->Address(0))).Equals((( Byte ) 0)));
		CxAssert(((*x_array2->Address(9))).Equals((( Byte ) 9)));
	...
	void ByteTestRaw::ByteMiscTests()
	{
		Byte x_b = (( Byte ) 0);
		Byte x_val = (( Byte ) 1);
		CxAssert((MathRaw::Max(x_b,x_val)).Equals((( Byte ) 1)));
		CxAssert((MathRaw::Min(x_b,x_val)).Equals((( Byte ) 0)));
	...
	void CharTestRaw::CharMethodsTest()
	{
		...
		CxAssert((new StringRaw("a"))->Equals('a'.ToString()));
		CxAssert((new StringRaw("a"))->Equals(CharRaw::ToString('a')));
		CxAssert('a'.Equals(CharRaw::Parse((new StringRaw("a")))));
		Object x_obj = (new CharBox(new CharBox(x_c) ));
		CxAssert('A'.Equals(( Char ) x_obj->get_AsChar()));
		CxAssert('A'.Equals(x_obj));
		CxAssert(('A'.CompareTo(x_obj)).Equals((( Int32 ) 0)));
	...
	void CharTestRaw::CharOperators()
	{
		...
		CxAssert((x_c + x_c2).Equals((( Int32 ) 67)));
		CxAssert((x_c + x_num).Equals((( Int32 ) 67)));
		CxAssert((x_c + x_num2).Equals((( UInt32 ) 67)));
		CxAssert((x_c + x_num3).Equals((( Int64 ) 67)));
		CxAssert((x_c + x_num4).Equals((( Double ) 67)));
		CxAssert((x_c - x_c2).Equals((( Int32 ) 65)));
		CxAssert((x_c - x_num).Equals((( Int32 ) 65)));
		CxAssert((x_c - x_num2).Equals((( UInt32 ) 65)));
		CxAssert((x_c - x_num3).Equals((( Int64 ) 65)));
		CxAssert((x_c - x_num4).Equals((( Double ) 65)));
		CxAssert((x_c * x_c2).Equals((( Int32 ) 66)));
		CxAssert((x_c * x_num).Equals((( Int32 ) 66)));
		CxAssert((x_c * x_num2).Equals((( UInt32 ) 66)));
		CxAssert((x_c * x_num3).Equals((( Int64 ) 66)));
		CxAssert((x_c * x_num4).Equals((( Double ) 66)));
		CxAssert((x_c / x_c2).Equals((( Int32 ) 66)));
		CxAssert((x_c / x_num).Equals((( Int32 ) 66)));
		CxAssert((x_c / x_num2).Equals((( UInt32 ) 66)));
		CxAssert((x_c / x_num3).Equals((( Int64 ) 66)));
		CxAssert((x_c / x_num4).Equals((( Double ) 66)));
		CxAssert((x_c % x_c2).Equals((( Int32 ) 0)));
		CxAssert((x_c % x_num).Equals((( Int32 ) 0)));
		CxAssert((x_c % x_num2).Equals((( UInt32 ) 0)));
		CxAssert((x_c % x_num3).Equals((( Int64 ) 0)));
		CxAssert((x_c % x_num4).Equals((( Double ) 0)));
		CxAssert(( x_c & x_c2 ) == 0);
		...
		CxAssert(( x_c ^ x_num2 ) == 67);
		CxAssert(( x_c ^ x_num3 ) == 67);
		CxAssert((~x_c).Equals((( UInt32 ) 4294967229)));
		CxAssert(x_c2 < x_c);
		CxAssert(x_num < x_c);
		CxAssert(x_num2 < x_c);
		CxAssert(x_num3 < x_c);
		...
		CxAssert(( x_c = ( Char ) ( x_c + (( Char ) 1) ) ) == 'C');
		CxAssert(( x_c = ( Char ) ( x_c - (( Char ) 1) ) ) == 'B');
		CxAssert((x_c++).Equals('B'));
		CxAssert((x_c--).Equals('C'));
		CxAssert((x_c << (( UInt32 ) 1)).Equals((( UInt32 ) 132)));
		CxAssert((x_c >> (( Int32 ) 1)).Equals((( Int32 ) 33)));
		...
		CxAssert(( x_c = ( Char ) ( x_c ^ x_c2 ) ) == 'C');
		x_c = 'B';
		CxAssert(( x_c = ( Char ) ( x_c << (( UInt32 ) 1) ) ) == '');
		x_c = 'B';
		CxAssert(( x_c = ( Char ) ( x_c >> (( Int32 ) 1) ) ) == '!');
	}
	void CharTestRaw::CharArrayTests()
	{
		...
		CxAssert((x_array->get_Length()).Equals((( Int32 ) 5)));
	...
	void CharTestRaw::CharMiscTests()
	{
		Char x_c = '0';
		Char x_val = '1';
		CxAssert((MathRaw::Max(x_c,x_val)).Equals((( UInt16 ) 49)));
		CxAssert((MathRaw::Min(x_c,x_val)).Equals((( UInt16 ) 48)));
		PointerType<StringBuilderRaw> x_stringBuilder = new StringBuilderRaw();
	...
	void DoubleTestRaw::DoDoubleMethodsTest()
	{
		...
		CxAssert((x_num.CompareTo(3.159)).Equals((( Int32 ) 0)));
		CxAssert((x_num.CompareTo((new DoubleBox(3.159 )))).Equals((( Int32 ) 0)));
		CxAssert(x_num.Equals(3.159));
		CxAssert((DoubleRaw::Parse((new StringRaw("3.159")))).Equals((( Double ) 3.159)));
		CxAssert((x_num.ToString())->Equals((new StringRaw("3.159"))));
		...
		x_num = 10000;
		CxAssert((x_num).Equals((( Int64 ) 10000)));
		CxAssert((x_num).Equals((( Int32 ) 10000)));
		CxAssert((x_num).Equals((( UInt32 ) 10000)));
		Object x_obj = (new DoubleBox(new DoubleBox(x_num) ));
		CxAssert((( Double ) x_obj->get_AsDouble()).Equals((( Double ) 10000)));
		x_num = Double::Epsilon;
		CxAssert((x_num).Equals(Double::Epsilon));
		x_num = ((Double)1.79769313486232E+308);
		CxAssert((x_num).Equals(((Double)1.79769313486232E+308)));
		x_num = ((Double)-1.79769313486232E+308);
		CxAssert((x_num).Equals(((Double)-1.79769313486232E+308)));
		x_obj.Assign(5);
	...
	void DoubleTestRaw::DoDoubleMath()
	{
		...
		CxAssert((x_num2).Equals((( Double ) 2)));
		x_num = 2;
		x_num2 = x_num + (( Double ) 4.94065645841247E-24);
		CxAssert((x_num2).Equals((( Double ) 2)));
	}
	void DoubleTestRaw::DoubleOperators()
	{
		...
		CxAssert((x_num).Equals((( Double ) 66)));
		CxAssert((x_num + x_c).Equals((( Double ) 67)));
		CxAssert((x_num + x_num2).Equals((( Double ) 67)));
		CxAssert((x_num + x_num3).Equals((( Double ) 67)));
		CxAssert((x_num + x_num4).Equals((( Double ) 67)));
		CxAssert((x_num + x_num5).Equals((( Double ) 67)));
		CxAssert((x_num - x_c).Equals((( Double ) 65)));
		CxAssert((x_num - x_num2).Equals((( Double ) 65)));
		CxAssert((x_num - x_num3).Equals((( Double ) 65)));
		CxAssert((x_num - x_num4).Equals((( Double ) 65)));
		CxAssert((x_num - x_num5).Equals((( Double ) 65)));
		CxAssert((x_num * x_c).Equals((( Double ) 66)));
		CxAssert((x_num * x_num2).Equals((( Double ) 66)));
		CxAssert((x_num * x_num3).Equals((( Double ) 66)));
		CxAssert((x_num * x_num4).Equals((( Double ) 66)));
		CxAssert((x_num * x_num5).Equals((( Double ) 66)));
		CxAssert((x_num / x_c).Equals((( Double ) 66)));
		CxAssert((x_num / x_num2).Equals((( Double ) 66)));
		CxAssert((x_num / x_num3).Equals((( Double ) 66)));
		CxAssert((x_num / x_num4).Equals((( Double ) 66)));
		CxAssert((x_num / x_num5).Equals((( Double ) 66)));
		CxAssert((x_num % x_c).Equals((( Double ) 0)));
		CxAssert((x_num % x_num2).Equals((( Double ) 0)));
		CxAssert((x_num % x_num3).Equals((( Double ) 0)));
		CxAssert((x_num % x_num4).Equals((( Double ) 0)));
		CxAssert((x_num % x_num5).Equals((( Double ) 0)));
		CxAssert(x_c < x_num);
		...
		CxAssert((x_num++).Equals((( Double ) 66)));
		CxAssert((x_num--).Equals((( Double ) 67)));
	...
	void DoubleTestRaw::DoubleMiscTests()
	{
		...
		CxAssert((MathRaw::Abs(x_num)).Equals((( Double ) 1)));
		CxAssert((MathRaw::Max(x_num,x_val)).Equals((( Double ) 1)));
	...
	void EncodingTestRaw::EncodingMethodsTest()
	{
		...
		CxAssert((x_aSCII->GetByteCount(x_s)).Equals((( Int32 ) 7)));
		...
		CxAssert((x_aSCII->GetByteCount(x_s2)).Equals((( Int32 ) 13)));
	...
	{
		for ( Int32 x_i = (( Int32 ) 0) ;  x_i < x_bytes->get_Length() ;   x_i++ )
		{
	...
	void EnumTestRaw::Test1(TestEnum x_testEnum)
	{
		...
		if ( !(x_num).Equals((( Int32 ) 5)) )
		{
			EnumTestFailed();
		}
		Double x_num2 = ( Double ) x_testEnum;
		if ( !(x_num2).Equals((( Double ) 5)) )
		{
			EnumTestFailed();
		}
	}
	...
	{
		Int16 x_num = (( Int16 ) 5);
		CxAssert((x_num.CompareTo(5)).Equals((( Int32 ) 0)));
		CxAssert((x_num.CompareTo((new Int16Box((( Int16 ) 5) )))).Equals((( Int32 ) 0)));
		CxAssert(x_num.Equals(5));
		CxAssert(x_num.Equals((new Int16Box((( Int16 ) 5) ))));
		...
		CxAssert((Int16Raw::Parse(x_text)).Equals(((Int16)32767)));
		String x_text2 = ((Int16)-32768).ToString();
		CxAssert((x_text2)->Equals((new StringRaw("-32768"))));
		CxAssert((Int16Raw::Parse(x_text2)).Equals(((Int16)-32768)));
		Int64 x_num2 = ((Int64)9223372036854775807);
		x_num = x_num2;
	...
	void Int16TestRaw::Int16MathTest()
	{
		...
		CxAssert((x_num + x_num2).Equals((( Int32 ) 1800)));
		CxAssert((x_num - x_num2).Equals(-600));
		CxAssert((x_num * x_num2).Equals((( Int32 ) 720000)));
		CxAssert((x_num2 / x_num).Equals((( Int32 ) 2)));
		CxAssert((x_num >> (( Int16 ) 2)).Equals((( Int32 ) 150)));
		CxAssert((x_num << (( Int16 ) 1)).Equals((( Int32 ) 1200)));
		Int32 x_num3 = (( Int32 ) 11);
		CxAssert((x_num3 % (( Int32 ) 5)).Equals((( Int32 ) 1)));
		x_num3 = 8;
		CxAssert(( x_num3 | (( Int32 ) 1) ) == 9);
		CxAssert(( x_num3 & (( Int32 ) 1) ) == 0);
		CxAssert((++x_num3).Equals((( Int32 ) 9)));
		CxAssert((--x_num3).Equals((( Int32 ) 8)));
		...
		CxAssert((x_num).Equals((( Int16 ) 600)));
		x_num3 = 0;
		CxAssert((~x_num3).Equals(-1));
		CxAssert((++x_num3).Equals((( Int32 ) 1)));
		CxAssert((--x_num3).Equals((( Int32 ) 0)));
	...
	void Int16TestRaw::Int16Operators()
	{
		...
		Float x_num7 = (( Single ) 1);
		Double x_num8 = (( Double ) 1);
		CxAssert((x_num).Equals((( Int16 ) 66)));
		CxAssert((x_num + x_c).Equals((( Int32 ) 67)));
		CxAssert((x_num + x_b).Equals((( Int32 ) 67)));
		CxAssert((x_num + x_b2).Equals((( Int32 ) 67)));
		CxAssert((x_num + x_num2).Equals((( Int32 ) 67)));
		CxAssert((x_num + x_num3).Equals((( Int32 ) 67)));
		CxAssert((x_num + x_num4).Equals((( Int64 ) 67)));
		CxAssert((x_num + x_num5).Equals((( Int32 ) 67)));
		CxAssert((x_num + x_num6).Equals((( Int64 ) 67)));
		CxAssert((x_num + x_num7).Equals((( Single ) 67)));
		CxAssert((x_num + x_num8).Equals((( Double ) 67)));
		CxAssert((x_num - x_c).Equals((( Int32 ) 65)));
		CxAssert((x_num - x_b).Equals((( Int32 ) 65)));
		CxAssert((x_num - x_b2).Equals((( Int32 ) 65)));
		CxAssert((x_num - x_num2).Equals((( Int32 ) 65)));
		CxAssert((x_num - x_num3).Equals((( Int32 ) 65)));
		CxAssert((x_num - x_num4).Equals((( Int64 ) 65)));
		CxAssert((x_num - x_num5).Equals((( Int32 ) 65)));
		CxAssert((x_num - x_num6).Equals((( Int64 ) 65)));
		CxAssert((x_num - x_num7).Equals((( Single ) 65)));
		CxAssert((x_num - x_num8).Equals((( Double ) 65)));
		CxAssert((x_num * x_c).Equals((( Int32 ) 66)));
		CxAssert((x_num * x_b).Equals((( Int32 ) 66)));
		CxAssert((x_num * x_b2).Equals((( Int32 ) 66)));
		CxAssert((x_num * x_num2).Equals((( Int32 ) 66)));
		CxAssert((x_num * x_num3).Equals((( Int32 ) 66)));
		CxAssert((x_num * x_num4).Equals((( Int64 ) 66)));
		CxAssert((x_num * x_num5).Equals((( Int32 ) 66)));
		CxAssert((x_num * x_num6).Equals((( Int64 ) 66)));
		CxAssert((x_num * x_num7).Equals((( Single ) 66)));
		CxAssert((x_num * x_num8).Equals((( Double ) 66)));
		CxAssert((x_num / x_c).Equals((( Int32 ) 66)));
		CxAssert((x_num / x_b).Equals((( Int32 ) 66)));
		CxAssert((x_num / x_b2).Equals((( Int32 ) 66)));
		CxAssert((x_num / x_num2).Equals((( Int32 ) 66)));
		...
		CxAssert((x_num / x_num7).Equals((( Single ) 66)));
		CxAssert((x_num / x_num8).Equals((( Double ) 66)));
		CxAssert((x_num % x_c).Equals((( Int32 ) 0)));
		CxAssert((x_num % x_b).Equals((( Int32 ) 0)));
		CxAssert((x_num % x_b2).Equals((( Int32 ) 0)));
		CxAssert((x_num % x_num2).Equals((( Int32 ) 0)));
		CxAssert((x_num % x_num3).Equals((( Int32 ) 0)));
		CxAssert((x_num % x_num4).Equals((( Int64 ) 0)));
		CxAssert((x_num % x_num5).Equals((( Int32 ) 0)));
		CxAssert((x_num % x_num6).Equals((( Int64 ) 0)));
		CxAssert((x_num % x_num7).Equals((( Single ) 0)));
		CxAssert((x_num % x_num8).Equals((( Double ) 0)));
		...
		CxAssert(( x_num = ( Int16 ) ( x_num + (( Int16 ) 1) ) ) == 67);
		CxAssert(( x_num = ( Int16 ) ( x_num - (( Int16 ) 1) ) ) == 66);
		CxAssert((x_num++).Equals((( Int16 ) 66)));
		CxAssert((x_num--).Equals((( Int16 ) 67)));
		CxAssert((x_num << (( Int16 ) 1)).Equals((( Int32 ) 132)));
		CxAssert((x_num >> (( Int16 ) 1)).Equals((( Int32 ) 33)));
		CxAssert((x_c).Equals(x_num),false);
		...
		CxAssert((x_num8).Equals(x_num),false);
		CxAssert(!(x_c).Equals(x_num));
		...
		CxAssert(x_num7 >= x_num,false);
		CxAssert(x_num8 >= x_num,false);
		CxAssert(( x_num = ( Int16 ) ( x_num + x_c ) ) == 67);
		CxAssert(( x_num = ( Int16 ) ( x_num - x_c ) ) == 66);
		CxAssert(( x_num = ( Int16 ) ( x_num + x_num3 ) ) == 67);
		CxAssert(( x_num = ( Int16 ) ( x_num - x_num3 ) ) == 66);
		CxAssert(( x_num = ( Int16 ) ( x_num * x_c ) ) == 66);
		CxAssert(( x_num = ( Int16 ) ( x_num / x_c ) ) == 66);
		CxAssert(( x_num = ( Int16 ) ( x_num * x_num3 ) ) == 66);
		CxAssert(( x_num = ( Int16 ) ( x_num / x_num3 ) ) == 66);
		CxAssert(( x_num = ( Int16 ) ( x_num % x_c ) ) == 0);
		x_num = 66;
		CxAssert(( x_num = ( Int16 ) ( x_num % x_num3 ) ) == 0);
		x_num = 66;
		CxAssert(( x_num = ( Int16 ) ( x_num & x_c ) ) == 0);
		x_num = 66;
		CxAssert(( x_num = ( Int16 ) ( x_num & x_num3 ) ) == 0);
		...
		CxAssert(( x_num = ( Int16 ) ( x_num ^ x_num3 ) ) == 67);
		x_num = 66;
		CxAssert(( x_num = ( Int16 ) ( x_num << x_b ) ) == 132);
		x_num = 66;
		CxAssert(( x_num = ( Int16 ) ( x_num << x_num2 ) ) == 132);
		x_num = 66;
		CxAssert(( x_num = ( Int16 ) ( x_num << x_c ) ) == 132);
		x_num = 66;
		CxAssert(( x_num = ( Int16 ) ( x_num << x_num3 ) ) == 132);
		x_num = 66;
		CxAssert(( x_num = ( Int16 ) ( x_num >> x_c ) ) == 33);
		x_num = 66;
		CxAssert(( x_num = ( Int16 ) ( x_num >> x_num3 ) ) == 33);
		x_num = 66;
		Int16 x_num9 = (( Int16 ) 0);
		CxAssert((x_num9).Equals((( Int16 ) 0)));
		CxAssert((x_num9).Equals((( Int16 ) 0)));
	...
	void Int16TestRaw::Int16MiscTests()
	{
		Int16 x_num = -1;
		Int16 x_val = (( Int16 ) 1);
		CxAssert((MathRaw::Abs(x_num)).Equals((( Int16 ) 1)));
		CxAssert((MathRaw::Max(x_num,x_val)).Equals((( Int16 ) 1)));
		CxAssert((MathRaw::Min(x_num,x_val)).Equals(-1));
		CxAssert(MathRaw::Sign(x_num) < (( Int32 ) 0));
		PointerType<StringBuilderRaw> x_stringBuilder = new StringBuilderRaw();
		x_stringBuilder->Append(x_num);
	...
	void Int32TestRaw::Int32Conversion()
	{
		...
		Int32 x_num3 = x_num;
		CxAssert((x_num3).Equals((( Int32 ) 3)));
	}
	void Int32TestRaw::Int32MethodsTest()
	{
		Int32 x_num = (( Int32 ) 5);
		CxAssert((x_num.CompareTo(5)).Equals((( Int32 ) 0)));
		CxAssert((x_num.CompareTo((new Int32Box(5 )))).Equals((( Int32 ) 0)));
		CxAssert(x_num.Equals(5));
		CxAssert(x_num.Equals((new Int32Box(5 ))));
		...
		CxAssert((Int32Raw::Parse(x_text)).Equals(((Int32)2147483647)));
		String x_text2 = ((Int32)-2147483648).ToString();
		CxAssert((x_text2)->Equals((new StringRaw("-2147483648"))));
		CxAssert((Int32Raw::Parse(x_text2)).Equals(((Int32)-2147483648)));
		Int64 x_num2 = ((Int64)9223372036854775807);
		x_num = x_num2;
		CxAssert((x_num).Equals(-1));
	...
	void Int32TestRaw::Int32MathTest()
	{
		...
		CxAssert((x_num + x_num2).Equals((( Int32 ) 180000)));
		CxAssert((x_num - x_num2).Equals(-60000));
		CxAssert((x_num * x_num2).Equals(-1389934592));
		CxAssert((x_num2 / x_num).Equals((( Int32 ) 2)));
		CxAssert((x_num >> (( Int32 ) 2)).Equals((( Int32 ) 15000)));
		CxAssert((x_num << (( Int32 ) 1)).Equals((( Int32 ) 120000)));
		Int32 x_num3 = (( Int32 ) 11);
		CxAssert((x_num3 % (( Int32 ) 5)).Equals((( Int32 ) 1)));
		x_num3 = 8;
		CxAssert(( x_num3 | (( Int32 ) 1) ) == 9);
		...
		CxAssert((x_num).Equals((( Int32 ) 60000)));
		x_num3 = 0;
		CxAssert((~x_num3).Equals(-1));
		CxAssert((++x_num3).Equals((( Int32 ) 1)));
		CxAssert((--x_num3).Equals((( Int32 ) 0)));
	...
	void Int32TestRaw::Int32Operators()
	{
		...
		Int64 x_num4 = (( Int64 ) 1);
		Double x_num5 = (( Double ) 1);
		CxAssert((x_num).Equals((( Int32 ) 66)));
		CxAssert((x_num + x_c).Equals((( Int32 ) 67)));
		CxAssert((x_num + x_num2).Equals((( Int32 ) 67)));
		CxAssert((x_num + x_num3).Equals((( Int64 ) 67)));
		CxAssert((x_num + x_num4).Equals((( Int64 ) 67)));
		CxAssert((( Int64 ) ( x_num + x_num5 )).Equals((( Int64 ) 67)));
		CxAssert((x_num - x_c).Equals((( Int32 ) 65)));
		CxAssert((x_num - x_num2).Equals((( Int32 ) 65)));
		CxAssert((x_num - x_num3).Equals((( Int64 ) 65)));
		CxAssert((x_num - x_num4).Equals((( Int64 ) 65)));
		CxAssert((( Int64 ) ( x_num - x_num5 )).Equals((( Int64 ) 65)));
		CxAssert((x_num * x_c).Equals((( Int32 ) 66)));
		CxAssert((x_num * x_num2).Equals((( Int32 ) 66)));
		CxAssert((x_num * x_num3).Equals((( Int64 ) 66)));
		CxAssert((x_num * x_num4).Equals((( Int64 ) 66)));
		CxAssert((( Int64 ) ( x_num * x_num5 )).Equals((( Int64 ) 66)));
		CxAssert((x_num / x_c).Equals((( Int32 ) 66)));
		CxAssert((x_num / x_num2).Equals((( Int32 ) 66)));
		CxAssert((x_num / x_num3).Equals((( Int64 ) 66)));
		CxAssert((x_num / x_num4).Equals((( Int64 ) 66)));
		...
		CxAssert((x_num % x_c).Equals((( Int32 ) 0)));
		CxAssert((x_num % x_num2).Equals((( Int32 ) 0)));
		CxAssert((x_num % x_num3).Equals((( Int64 ) 0)));
		CxAssert((x_num % x_num4).Equals((( Int64 ) 0)));
		CxAssert((( Int64 ) ( x_num % x_num5 )).Equals((( Int64 ) 0)));
		CxAssert(( x_num & x_c ) == 0);
		CxAssert(( x_num & x_num2 ) == 0);
		CxAssert(( x_num & x_num3 ) == 0);
		CxAssert(( x_num & x_num4 ) == 0);
		...
		CxAssert(x_num4 > x_num,false);
		CxAssert(x_num5 > x_num,false);
		CxAssert((++x_num).Equals((( Int32 ) 67)));
		CxAssert((--x_num).Equals((( Int32 ) 66)));
		CxAssert((x_num++).Equals((( Int32 ) 66)));
		CxAssert((x_num--).Equals((( Int32 ) 67)));
		CxAssert((x_num << (( Int32 ) 1)).Equals((( Int32 ) 132)));
		CxAssert((x_num >> (( Int32 ) 1)).Equals((( Int32 ) 33)));
		CxAssert((x_c).Equals(x_num),false);
		CxAssert((x_num2).Equals(x_num),false);
		CxAssert((x_num3).Equals(x_num),false);
		CxAssert((x_num4).Equals(x_num),false);
		...
		CxAssert((x_num6).Equals((( Int32 ) 0)));
		CxAssert((x_num6).Equals((( Int32 ) 0)));
	...
	void Int32TestRaw::Int32ArrayTests()
	{
		...
		CxAssert((x_array->get_Length()).Equals((( Int32 ) 5)));
		CxAssert(((*x_array->Address(3))).Equals((( Int32 ) 4)));
		PointerType<ArrayRaw<Int32>> x_array2 = (new ArrayRaw<Int32>(4))->Initialize((Int32*) Int32ArrayTestsArray1);
		CxAssert(((*x_array2->Address(1))).Equals((( Int32 ) 2)));
		PointerType<ArrayRaw<Int32>> x_array3 = (new ArrayRaw<Int32>(2,4))->Initialize((Int32*) Int32ArrayTestsArray2);
		CxAssert(((*x_array3->Address(0,2))).Equals((( Int32 ) 3)));
		PointerType<ArrayRaw<Int32>> x_array4 = (new ArrayRaw<Int32>(2,2,4))->Initialize((Int32*) Int32ArrayTestsArray3);
		CxAssert(((*x_array4->Address(0,0,3))).Equals((( Int32 ) 4)));
		(*x_array4->Address(0,0,3)) = 6;
		CxAssert(((*x_array4->Address(0,0,3))).Equals((( Int32 ) 6)));
		x_array4->SetValue(4,0,0,3);
		CxAssert(((*x_array4->Address(0,0,3))).Equals((( Int32 ) 4)));
		CxAssert(((*x_array4->Address(0,0,3)).ToString())->Equals((new StringRaw("4"))));
	}
	void Int32TestRaw::Int32MiscTests()
	{
		Int32 x_num = -1;
		Int32 x_val = (( Int32 ) 1);
		CxAssert((MathRaw::Abs(x_num)).Equals((( Int32 ) 1)));
		CxAssert((MathRaw::Max(x_num,x_val)).Equals((( Int32 ) 1)));
		CxAssert((MathRaw::Min(x_num,x_val)).Equals(-1));
		CxAssert(MathRaw::Sign(x_num) < (( Int32 ) 0));
		PointerType<StringBuilderRaw> x_stringBuilder = new StringBuilderRaw();
		x_stringBuilder->Append(x_num);
	...
	void Int64TestRaw::Int64MethodsTest()
	{
		Int64 x_num = (( Int64 ) 5);
		CxAssert((x_num.CompareTo(5)).Equals((( Int32 ) 0)));
		CxAssert((x_num.CompareTo((new Int64Box(5 )))).Equals((( Int32 ) 0)));
		CxAssert(x_num.Equals(5));
		CxAssert(x_num.Equals((new Int64Box(5 ))));
		...
		CxAssert((Int64Raw::Parse(x_text)).Equals(((Int64)9223372036854775807)));
		String x_text2 = ((Int64)-9223372036854775808).ToString();
		CxAssert((x_text2)->Equals((new StringRaw("-9223372036854775808"))));
		CxAssert((Int64Raw::Parse(x_text2)).Equals(((Int64)-9223372036854775808)));
	...
	void Int64TestRaw::Int64MathTest()
	{
		...
		CxAssert((x_num + x_num2).Equals((( Int64 ) 180000000)));
		CxAssert((x_num - x_num2).Equals(-60000000));
		CxAssert((x_num * x_num2).Equals((( Int64 ) 7200000000000000)));
		CxAssert((x_num * x_num2).Equals((( Int64 ) 7200000000000000)));
		CxAssert((x_num2 / x_num).Equals((( Int64 ) 2)));
		CxAssert((x_num << (( Int64 ) 1)).Equals((( Int64 ) 120000000)));
		Int32 x_num3 = (( Int32 ) 11);
		CxAssert((x_num3 % (( Int32 ) 5)).Equals((( Int32 ) 1)));
		x_num3 = 8;
		CxAssert(( x_num3 | (( Int32 ) 1) ) == 9);
		...
		CxAssert((x_num).Equals((( Int64 ) 60000000)));
		x_num3 = 0;
		CxAssert((~x_num3).Equals(-1));
		CxAssert((++x_num3).Equals((( Int32 ) 1)));
		CxAssert((--x_num3).Equals((( Int32 ) 0)));
	...
	void Int64TestRaw::Int64Operators()
	{
		...
		Int64 x_num4 = (( Int64 ) 1);
		Double x_num5 = (( Double ) 1);
		CxAssert((x_num).Equals((( Int64 ) 66)));
		CxAssert((x_num + x_c).Equals((( Int64 ) 67)));
		CxAssert((x_num + x_num2).Equals((( Int64 ) 67)));
		CxAssert((x_num + x_num3).Equals((( Int64 ) 67)));
		CxAssert((x_num + x_num4).Equals((( Int64 ) 67)));
		CxAssert((x_num + x_num5).Equals((( Double ) 67)));
		CxAssert((x_num - x_c).Equals((( Int64 ) 65)));
		CxAssert((x_num - x_num2).Equals((( Int64 ) 65)));
		CxAssert((x_num - x_num3).Equals((( Int64 ) 65)));
		CxAssert((x_num - x_num4).Equals((( Int64 ) 65)));
		CxAssert((x_num - x_num5).Equals((( Double ) 65)));
		CxAssert((x_num * x_c).Equals((( Int64 ) 66)));
		CxAssert((x_num * x_num2).Equals((( Int64 ) 66)));
		CxAssert((x_num * x_num3).Equals((( Int64 ) 66)));
		CxAssert((x_num * x_num4).Equals((( Int64 ) 66)));
		CxAssert((x_num * x_num5).Equals((( Double ) 66)));
		CxAssert((x_num / x_c).Equals((( Int64 ) 66)));
		...
		CxAssert((x_num / x_num4).Equals((( Int64 ) 66)));
		CxAssert((x_num / x_num5).Equals((( Double ) 66)));
		CxAssert((x_num % x_c).Equals((( Int64 ) 0)));
		CxAssert((x_num % x_num2).Equals((( Int64 ) 0)));
		CxAssert((x_num % x_num3).Equals((( Int64 ) 0)));
		CxAssert((x_num % x_num4).Equals((( Int64 ) 0)));
		CxAssert((x_num % x_num5).Equals((( Double ) 0)));
		CxAssert(( x_num & x_c ) == 0);
		...
		CxAssert(x_num4 > x_num,false);
		CxAssert(x_num5 > x_num,false);
		CxAssert((++x_num).Equals((( Int64 ) 67)));
		CxAssert((--x_num).Equals((( Int64 ) 66)));
		CxAssert((x_num++).Equals((( Int64 ) 66)));
		CxAssert((x_num--).Equals((( Int64 ) 67)));
		CxAssert((x_num << (( Int64 ) 1)).Equals((( Int64 ) 132)));
		CxAssert((x_num >> (( Int64 ) 1)).Equals((( Int64 ) 33)));
		CxAssert((x_c).Equals(x_num),false);
		CxAssert((x_num2).Equals(x_num),false);
		CxAssert((x_num3).Equals(x_num),false);
		CxAssert((x_num4).Equals(x_num),false);
	...
	void Int64TestRaw::Int64MiscTests()
	{
		Int64 x_num = -1;
		Int64 x_val = (( Int64 ) 1);
		CxAssert((MathRaw::Abs(x_num)).Equals((( Int64 ) 1)));
		CxAssert((MathRaw::Max(x_num,x_val)).Equals((( Int64 ) 1)));
		CxAssert((MathRaw::Min(x_num,x_val)).Equals(-1));
		CxAssert(MathRaw::Sign(x_num) < (( Int32 ) 0));
		PointerType<StringBuilderRaw> x_stringBuilder = new StringBuilderRaw();
		x_stringBuilder->Append(x_num);
	...
	void MathTestRaw::DoMathTest()
	{
		...
		CxAssert(MathRaw::Abs(1),1);
		CxAssert((MathRaw::Abs(-1)).Equals((( Int32 ) 1)));
		CxAssert((MathRaw::Abs(1)).Equals((( Int32 ) 1)));
		CxAssert((MathRaw::Abs(-1)).Equals((( Int64 ) 1)));
		CxAssert((MathRaw::Abs(1)).Equals((( Int64 ) 1)));
		CxAssert(MathRaw::Acos(0.5),Math::PI / (( Double ) 3));
		...
		CxAssert((MathRaw::Max(1,2)).Equals((( Int32 ) 2)));
		CxAssert((MathRaw::Max(1,2)).Equals((( Int64 ) 2)));
		CxAssert((MathRaw::Max(1,2)).Equals((( UInt32 ) 2)));
		CxAssert(MathRaw::Min(1.1,1.2),1.1);
		CxAssert((MathRaw::Min(1,2)).Equals((( Int32 ) 1)));
		CxAssert((MathRaw::Min(1,2)).Equals((( Int64 ) 1)));
		CxAssert((MathRaw::Min(1,2)).Equals((( UInt32 ) 1)));
		...
		CxAssert(MathRaw::Round(((Double)-1.79769313486232E+308)),((Double)-1.79769313486232E+308));
		CxAssert((MathRaw::Sign(2)).Equals((( Int32 ) 1)));
		CxAssert((MathRaw::Sign(0)).Equals((( Int32 ) 0)));
		...
		CxAssert((MathRaw::Sign(0)).Equals((( Int32 ) 0)));
		CxAssert((MathRaw::Sign(-2)).Equals(-1));
		CxAssert((MathRaw::Sign(Double::Epsilon)).Equals((( Int32 ) 1)));
		...
		CxAssert((MathRaw::Truncate(x_num2)).Equals((( Double ) 3)));
	}
	...
	void SByteTestRaw::SByteMethodsTest()
	{
		SByte x_b = (( SByte ) 5);
		CxAssert((x_b.CompareTo(5)).Equals((( Int32 ) 0)));
		CxAssert((x_b.CompareTo((new SByteBox((( SByte ) 5) )))).Equals((( Int32 ) 0)));
		CxAssert(x_b.Equals(5));
		CxAssert(x_b.Equals((new SByteBox((( SByte ) 5) ))));
		...
		CxAssert((SByteRaw::Parse(x_text)).Equals(((SByte)127)));
		String x_text2 = ((SByte)-128).ToString();
		CxAssert((x_text2)->Equals((new StringRaw("-128"))));
		CxAssert((SByteRaw::Parse(x_text2)).Equals(((SByte)-128)));
		Int64 x_num = ((Int64)9223372036854775807);
		x_b = x_num;
	...
	void SByteTestRaw::SByteMathTest()
	{
		SByte x_b = (( SByte ) 6);
		SByte x_b2 = (( SByte ) 12);
		CxAssert((x_b + x_b2).Equals((( Int32 ) 18)));
		CxAssert((x_b - x_b2).Equals(-6));
		CxAssert((x_b * x_b2).Equals((( Int32 ) 72)));
		CxAssert((x_b2 / x_b).Equals((( Int32 ) 2)));
		CxAssert((x_b >> (( SByte ) 2)).Equals((( Int32 ) 1)));
		CxAssert((x_b << (( SByte ) 1)).Equals((( Int32 ) 12)));
		Int32 x_num = (( Int32 ) 11);
		CxAssert((x_num % (( Int32 ) 5)).Equals((( Int32 ) 1)));
		x_num = 8;
		CxAssert(( x_num | (( Int32 ) 1) ) == 9);
		CxAssert(( x_num & (( Int32 ) 1) ) == 0);
		CxAssert((++x_num).Equals((( Int32 ) 9)));
		CxAssert((--x_num).Equals((( Int32 ) 8)));
		...
		CxAssert((x_b).Equals((( SByte ) 6)));
		x_num = 0;
		CxAssert((~x_num).Equals(-1));
		CxAssert((++x_num).Equals((( Int32 ) 1)));
		CxAssert((--x_num).Equals((( Int32 ) 0)));
		CxAssert(x_b < x_b2);
		CxAssert(x_b <= x_b2);
		CxAssert(x_b2 > x_b);
		CxAssert(x_b2 >= x_b);
	...
	void SByteTestRaw::SByteOperators()
	{
		...
		CxAssert((x_b).Equals((( SByte ) 66)));
		CxAssert((x_b + x_c).Equals((( Int32 ) 67)));
		CxAssert((x_b + x_b2).Equals((( Int32 ) 67)));
		CxAssert((x_b + x_b3).Equals((( Int32 ) 67)));
		CxAssert((x_b + x_b4).Equals((( Int32 ) 67)));
		CxAssert((x_b + x_num).Equals((( Int32 ) 67)));
		CxAssert((x_b + x_num2).Equals((( Int64 ) 67)));
		CxAssert((x_b + x_num3).Equals((( Int32 ) 67)));
		CxAssert((x_b + x_num4).Equals((( Int64 ) 67)));
		CxAssert((x_b + x_num5).Equals((( Single ) 67)));
		CxAssert((x_b + x_num6).Equals((( Double ) 67)));
		CxAssert((x_b - x_c).Equals((( Int32 ) 65)));
		CxAssert((x_b - x_b2).Equals((( Int32 ) 65)));
		CxAssert((x_b - x_b3).Equals((( Int32 ) 65)));
		CxAssert((x_b - x_b4).Equals((( Int32 ) 65)));
		CxAssert((x_b - x_num).Equals((( Int32 ) 65)));
		CxAssert((x_b - x_num2).Equals((( Int64 ) 65)));
		CxAssert((x_b - x_num3).Equals((( Int32 ) 65)));
		CxAssert((x_b - x_num4).Equals((( Int64 ) 65)));
		CxAssert((x_b - x_num5).Equals((( Single ) 65)));
		CxAssert((x_b - x_num6).Equals((( Double ) 65)));
		CxAssert((x_b * x_c).Equals((( Int32 ) 66)));
		CxAssert((x_b * x_b2).Equals((( Int32 ) 66)));
		CxAssert((x_b * x_b3).Equals((( Int32 ) 66)));
		CxAssert((x_b * x_b4).Equals((( Int32 ) 66)));
		CxAssert((x_b * x_num).Equals((( Int32 ) 66)));
		CxAssert((x_b * x_num2).Equals((( Int64 ) 66)));
		CxAssert((x_b * x_num3).Equals((( Int32 ) 66)));
		CxAssert((x_b * x_num4).Equals((( Int64 ) 66)));
		CxAssert((x_b * x_num5).Equals((( Single ) 66)));
		CxAssert((x_b * x_num6).Equals((( Double ) 66)));
		CxAssert((x_b / x_c).Equals((( Int32 ) 66)));
		CxAssert((x_b / x_b2).Equals((( Int32 ) 66)));
		CxAssert((x_b / x_b3).Equals((( Int32 ) 66)));
		CxAssert((x_b / x_b4).Equals((( Int32 ) 66)));
		...
		CxAssert((x_b % x_b2).Equals((( Int32 ) 0)));
		CxAssert((x_b % x_b3).Equals((( Int32 ) 0)));
		CxAssert((x_b % x_b4).Equals((( Int32 ) 0)));
		CxAssert((x_b % x_num).Equals((( Int32 ) 0)));
		CxAssert((x_b % x_num2).Equals((( Int64 ) 0)));
		CxAssert((x_b % x_num3).Equals((( Int32 ) 0)));
		CxAssert((x_b % x_num4).Equals((( Int64 ) 0)));
		CxAssert((x_b % x_num5).Equals((( Single ) 0)));
		CxAssert((x_b % x_num6).Equals((( Double ) 0)));
		CxAssert(( x_b & x_c ) == 0);
		CxAssert(( x_b & x_b2 ) == 0);
		CxAssert(( x_b & x_b3 ) == 0);
		CxAssert(( x_b & x_b4 ) == 0);
		...
		CxAssert(x_num5 > x_b,false);
		CxAssert(x_num6 > x_b,false);
		CxAssert(( x_b = ( SByte ) ( x_b + (( SByte ) 1) ) ) == 67);
		CxAssert(( x_b = ( SByte ) ( x_b - (( SByte ) 1) ) ) == 66);
		CxAssert((x_b++).Equals((( SByte ) 66)));
		CxAssert((x_b--).Equals((( SByte ) 67)));
		CxAssert((x_b << (( SByte ) 1)).Equals((( Int32 ) 132)));
		CxAssert((x_b >> (( SByte ) 1)).Equals((( Int32 ) 33)));
		CxAssert((x_c).Equals(x_b),false);
		CxAssert((x_b2).Equals(x_b),false);
		CxAssert((x_b3).Equals(x_b),false);
		...
		CxAssert(x_num5 >= x_b,false);
		CxAssert(x_num6 >= x_b,false);
		CxAssert(( x_b = ( SByte ) ( x_b + x_c ) ) == 67);
		CxAssert(( x_b = ( SByte ) ( x_b - x_c ) ) == 66);
		CxAssert(( x_b = ( SByte ) ( x_b + x_num ) ) == 67);
		CxAssert(( x_b = ( SByte ) ( x_b - x_num ) ) == 66);
		CxAssert(( x_b = ( SByte ) ( x_b * x_c ) ) == 66);
		CxAssert(( x_b = ( SByte ) ( x_b / x_c ) ) == 66);
		CxAssert(( x_b = ( SByte ) ( x_b * x_num ) ) == 66);
		CxAssert(( x_b = ( SByte ) ( x_b / x_num ) ) == 66);
		CxAssert(( x_b = ( SByte ) ( x_b % x_c ) ) == 0);
		x_b = 66;
		CxAssert(( x_b = ( SByte ) ( x_b % x_num ) ) == 0);
		x_b = 66;
		CxAssert(( x_b = ( SByte ) ( x_b & x_c ) ) == 0);
		x_b = 66;
		CxAssert(( x_b = ( SByte ) ( x_b & x_num ) ) == 0);
		...
		CxAssert(( x_b = ( SByte ) ( x_b ^ x_num ) ) == 67);
		x_b = 66;
		CxAssert(( x_b = ( SByte ) ( x_b << x_b2 ) ) == -124);
		x_b = 66;
		CxAssert(( x_b = ( SByte ) ( x_b << x_b4 ) ) == -124);
		x_b = 66;
		CxAssert(( x_b = ( SByte ) ( x_b << x_c ) ) == -124);
		x_b = 66;
		CxAssert(( x_b = ( SByte ) ( x_b << x_num ) ) == -124);
		x_b = 66;
		CxAssert(( x_b = ( SByte ) ( x_b >> x_c ) ) == 33);
		x_b = 66;
		CxAssert(( x_b = ( SByte ) ( x_b >> x_num ) ) == 33);
		x_b = 66;
		SByte x_b5 = (( SByte ) 0);
		CxAssert((x_b5).Equals((( SByte ) 0)));
		CxAssert((x_b5).Equals((( SByte ) 0)));
	...
	void SByteTestRaw::SByteMiscTests()
	{
		SByte x_b = -1;
		SByte x_val = (( SByte ) 1);
		CxAssert((MathRaw::Abs(x_b)).Equals((( SByte ) 1)));
		CxAssert((MathRaw::Max(x_b,x_val)).Equals((( SByte ) 1)));
	...
	void SingleTestRaw::DoSingleMethodsTest()
	{
		...
		CxAssert((x_num.CompareTo(3.159)).Equals((( Int32 ) 0)));
		CxAssert((x_num.CompareTo((new SingleBox(3.159 )))).Equals((( Int32 ) 0)));
		CxAssert(x_num.Equals(3.159));
		...
		CxAssert((x_num).Equals((( Int32 ) 10000)));
		CxAssert((x_num).Equals((( UInt32 ) 10000)));
		Object x_obj = (new SingleBox(new SingleBox(x_num) ));
		CxAssert((( Single ) x_obj->get_AsSingle()).Equals((( Double ) 10000)));
		x_num = Float::Epsilon;
		CxAssert((x_num).Equals(Float::Epsilon));
		x_num = ((Single)3.402823E+38);
		CxAssert((x_num).Equals(((Single)3.402823E+38)));
		x_num = ((Single)-3.402823E+38);
		CxAssert((x_num).Equals(((Single)-3.402823E+38)));
		x_obj.Assign(5);
		CxAssert(x_obj->Equals(5));
	...
	void SingleTestRaw::DoSingleMath()
	{
		...
		CxAssert((x_num2).Equals((( Double ) 1)));
	}
	void SingleTestRaw::SingleOperators()
	{
		...
		Int64 x_num4 = (( Int64 ) 1);
		Double x_num5 = (( Double ) 1);
		CxAssert((x_num).Equals((( Single ) 66)));
		CxAssert((x_num + x_c).Equals((( Single ) 67)));
		CxAssert((x_num + x_num2).Equals((( Single ) 67)));
		CxAssert((x_num + x_num3).Equals((( Single ) 67)));
		CxAssert((x_num + x_num4).Equals((( Single ) 67)));
		CxAssert((x_num + x_num5).Equals((( Double ) 67)));
		CxAssert((x_num - x_c).Equals((( Single ) 65)));
		CxAssert((x_num - x_num2).Equals((( Single ) 65)));
		CxAssert((x_num - x_num3).Equals((( Single ) 65)));
		CxAssert((x_num - x_num4).Equals((( Single ) 65)));
		CxAssert((x_num - x_num5).Equals((( Double ) 65)));
		CxAssert((x_num * x_c).Equals((( Single ) 66)));
		CxAssert((x_num * x_num2).Equals((( Single ) 66)));
		CxAssert((x_num * x_num3).Equals((( Single ) 66)));
		CxAssert((x_num * x_num4).Equals((( Single ) 66)));
		CxAssert((x_num * x_num5).Equals((( Double ) 66)));
		CxAssert((x_num / x_c).Equals((( Single ) 66)));
		CxAssert((x_num / x_num2).Equals((( Single ) 66)));
		CxAssert((x_num / x_num3).Equals((( Single ) 66)));
		CxAssert((x_num / x_num4).Equals((( Single ) 66)));
		CxAssert((x_num / x_num5).Equals((( Double ) 66)));
		CxAssert((x_num % x_c).Equals((( Single ) 0)));
		CxAssert((x_num % x_num2).Equals((( Single ) 0)));
		CxAssert((x_num % x_num3).Equals((( Single ) 0)));
		CxAssert((x_num % x_num4).Equals((( Single ) 0)));
		CxAssert((x_num % x_num5).Equals((( Double ) 0)));
		CxAssert(x_c < x_num);
		CxAssert(x_num2 < x_num);
		CxAssert(x_num3 < x_num);
		...
		CxAssert(( x_num = x_num - 1 ) == 66);
		CxAssert((x_num++).Equals((( Single ) 66)));
		CxAssert((x_num--).Equals((( Single ) 67)));
		CxAssert((x_c).Equals(x_num),false);
		CxAssert((x_num2).Equals(x_num),false);
		CxAssert((x_num3).Equals(x_num),false);
		CxAssert((x_num4).Equals(x_num),false);
	...
	void SingleTestRaw::SingleMiscTests()
	{
		...
		CxAssert((MathRaw::Abs(x_num)).Equals((( Single ) 1)));
		CxAssert((MathRaw::Max(x_num,x_val)).Equals((( Single ) 1)));
		CxAssert((MathRaw::Min(x_num,x_val)).Equals(-1));
		CxAssert(MathRaw::Sign(x_num) < (( Int32 ) 0));
		PointerType<StringBuilderRaw> x_stringBuilder = new StringBuilderRaw();
		x_stringBuilder->Append(x_num);
...
','"',''','Â'};
		CxAssert((x_sb->get_Length()).Equals((( Int32 ) 0)));
		x_sb.Assign(new StringBuilderRaw(100));
		CxAssert((x_sb->get_Capacity()).Equals((( Int32 ) 100)));
		...
		CxAssert((x_sb->get_Capacity()).Equals((( Int32 ) 20)) && (x_sb->get_MaxCapacity()).Equals((( Int32 ) 25)));
		x_sb.Assign(new StringBuilderRaw((new StringRaw("Test")),20));
		CxAssert((x_sb->ToString())->Equals((new StringRaw("Test"))) && (x_sb->get_Capacity()).Equals((( Int32 ) 20)));
		x_sb.Assign(new StringBuilderRaw((new StringRaw("test1234")),1,4,20));
		CxAssert((x_sb->ToString())->Equals((new StringRaw("est1"))) && (x_sb->get_Capacity()).Equals((( Int32 ) 20)));
	...
	void StringBuilderTestRaw::DoSBPropertyTest()
	{
		...
		CxAssert((x_sb->get_Capacity()).Equals((( Int32 ) 20)) && (x_sb->get_MaxCapacity()).Equals(((Int32)2147483647)));
		CxAssert(((*x_sb->Address(7))).Equals('1'));
		CxAssert((x_sb->get_Length()).Equals((( Int32 ) 10)));
		x_sb->set_Length(7);
		CxAssert((x_sb->get_Length()).Equals((( Int32 ) 7)));
		x_sb->set_Capacity(22);
		CxAssert((x_sb->get_Capacity()).Equals((( Int32 ) 22)));
		(*x_sb->Address(0)) = 't';
	...
	void StringTestRaw::DoIndexTest()
	{
		...
		CxAssert((x_text->get_Length()).Equals((( Int32 ) 5)));
	...
	void StringTestRaw::DoMiscTest()
	{
		...
		CxAssert((x_text->get_Length()).Equals((( Int32 ) 10)));
		...
		CxAssert((StringRaw::Compare((new StringRaw("abc")),(new StringRaw("ABC")),true)).Equals((( Int32 ) 0)));
		CxAssert((StringRaw::Compare((new StringRaw("1abce")),1,(new StringRaw("abc")),0,3)).Equals((( Int32 ) 0)));
		CxAssert((StringRaw::Compare((new StringRaw("1abce")),1,(new StringRaw("ABC")),0,3,true)).Equals((( Int32 ) 0)));
		CxAssert((StringRaw::CompareOrdinal((new StringRaw("abc")),(new StringRaw("abc")))).Equals((( Int32 ) 0)));
		CxAssert((StringRaw::CompareOrdinal((new StringRaw("1abce")),1,(new StringRaw("abc")),0,3)).Equals((( Int32 ) 0)));
	...
	void StringTestRaw::DoParsingTest()
	{
		...
		CxAssert((x_array->get_Length()).Equals((( Int32 ) 3)));
		...
		CxAssert((x_array->get_Length()).Equals((( Int32 ) 2)));
		CxAssert(((new StringRaw("42")))->Equals((*x_array->Address(0))));
		...
		CxAssert((x_text->IndexOfAny(x_array2)).Equals((( Int32 ) 3)));
		CxAssert((x_text->IndexOfAny(x_array2,1)).Equals((( Int32 ) 3)));
		CxAssert((x_text->IndexOfAny(x_array2,1,3)).Equals((( Int32 ) 3)));
		CxAssert((x_text->IndexOf('5')).Equals((( Int32 ) 6)));
		CxAssert((x_text->IndexOf(' ',3)).Equals((( Int32 ) 5)));
		CxAssert((x_text->IndexOf(' ',3,3)).Equals((( Int32 ) 5)));
		CxAssert((x_text->IndexOf((new StringRaw("56")))).Equals((( Int32 ) 6)));
		CxAssert((x_text->IndexOf((new StringRaw(" ")),3)).Equals((( Int32 ) 5)));
		CxAssert((x_text->IndexOf((new StringRaw(" ")),3,3)).Equals((( Int32 ) 5)));
		String x_text6 = (new StringRaw("11223311"));
		CxAssert((x_text6->LastIndexOf('1')).Equals((( Int32 ) 7)));
		CxAssert((x_text6->LastIndexOf('1',4)).Equals((( Int32 ) 1)));
		CxAssert((x_text6->LastIndexOf('1',4,4)).Equals((( Int32 ) 1)));
		CxAssert((x_text6->LastIndexOf((new StringRaw("11")))).Equals((( Int32 ) 6)));
		CxAssert((x_text6->LastIndexOf((new StringRaw("11")),4)).Equals((( Int32 ) 0)));
		CxAssert((x_text6->LastIndexOf((new StringRaw("11")),4,5)).Equals((( Int32 ) 0)));
		(*x_array2->Address(0)) = '1';
		(*x_array2->Address(1)) = '2';
		CxAssert((x_text6->LastIndexOfAny(x_array2)).Equals((( Int32 ) 7)));
		CxAssert((x_text6->LastIndexOfAny(x_array2,4)).Equals((( Int32 ) 3)));
		CxAssert((x_text6->LastIndexOfAny(x_array2,4,4)).Equals((( Int32 ) 3)));
		...
		if ( !(x_text7->CompareTo((new StringRaw("3.33")))).Equals((( Int32 ) 0)) )
		{
			CxAssert(false);
		}
	}
	...
	void TimeTestRaw::TestTimeSpan()
	{
		...
		CxAssert((x_timeSpan2.get_Ticks()).Equals((( Int64 ) 200)));
		CxAssert(TimeSpanRaw::Compare(x_timeSpan,x_timeSpan2) < (( Int32 ) 0));
		CxAssert(x_timeSpan.CompareTo((new TimeSpanBox(new TimeSpanBox(x_timeSpan2) ))) < (( Int32 ) 0));
		CxAssert(x_timeSpan.CompareTo(x_timeSpan2) < (( Int32 ) 0));
		x_timeSpan = x_timeSpan2.Duration();
		CxAssert((x_timeSpan.get_Ticks()).Equals((( Int64 ) 200)));
		CxAssert(TimeSpanRaw::Equals(x_timeSpan,x_timeSpan2));
		CxAssert(x_timeSpan.Equals(x_timeSpan2));
		CxAssert((TimeSpanRaw::FromDays(22).get_Ticks()).Equals((( Int64 ) 19008000000000)));
		CxAssert((TimeSpanRaw::FromHours(10).get_Ticks()).Equals((( Int64 ) 360000000000)));
		CxAssert((TimeSpanRaw::FromMilliseconds(100).get_Ticks()).Equals((( Int64 ) 1000000)));
		CxAssert((TimeSpanRaw::FromMinutes(25).get_Ticks()).Equals((( Int64 ) 15000000000)));
		CxAssert((TimeSpanRaw::FromSeconds(18).get_Ticks()).Equals((( Int64 ) 180000000)));
		x_timeSpan = TimeSpanRaw::FromTicks(6500000);
		CxAssert((x_timeSpan.get_Ticks()).Equals((( Int64 ) 6500000)));
		x_timeSpan = x_timeSpan.Negate();
		CxAssert((x_timeSpan.get_Ticks()).Equals(-6500000));
		CxAssert((x_timeSpan.Subtract(x_timeSpan2).get_Ticks()).Equals(-6500200));
		CxAssert((TimeSpanRaw::Parse((new StringRaw("1.1:1:1"))).get_Ticks()).Equals((( Int64 ) 900610000000)));
		CxAssert((TimeSpanRaw::Parse((new StringRaw("1.1:1:1.200"))).get_Ticks()).Equals((( Int64 ) 900612000000)));
		CxAssert((TimeSpanRaw::Parse((new StringRaw("1:1:1"))).get_Ticks()).Equals((( Int64 ) 36610000000)));
		CxAssert((TimeSpanRaw::Parse((new StringRaw("22"))).get_Ticks()).Equals((( Int64 ) 19008000000000)));
		...
		CxAssert((x_timeSpan.get_Days()).Equals((( Int32 ) 1)));
		CxAssert((x_timeSpan.get_Hours()).Equals((( Int32 ) 2)));
		CxAssert((x_timeSpan.get_Minutes()).Equals((( Int32 ) 3)));
		CxAssert((x_timeSpan.get_Seconds()).Equals((( Int32 ) 4)));
		CxAssert((x_timeSpan.get_Milliseconds()).Equals((( Int32 ) 200)));
		CxAssert((x_timeSpan.get_Ticks()).Equals((( Int64 ) 937842000000)));
		...
		CxAssert((( x_timeSpan2 + x_timeSpan2 ).get_Ticks()).Equals((( Int64 ) 400)));
		...
		CxAssert((x_timeSpan.get_Ticks()).Equals((( Int64 ) 100)));
		x_timeSpan = -x_timeSpan;
		CxAssert((x_timeSpan.get_Ticks()).Equals(-100));
		CxAssert((( +x_timeSpan ).get_Ticks()).Equals(-100));
		CxAssert((TimeSpan(1000).get_Ticks()).Equals((( Int64 ) 1000)));
		CxAssert((TimeSpan(10,11,30).get_Ticks()).Equals((( Int64 ) 366900000000)));
		CxAssert((TimeSpan(3,10,11,30).get_Ticks()).Equals((( Int64 ) 2958900000000)));
		CxAssert((TimeSpan(3,10,11,30,100).get_Ticks()).Equals((( Int64 ) 2958901000000)));
		CxAssert((TimeSpan(3,10,11,30,100).get_Ticks()).Equals((( Int64 ) 2958901000000)));
		x_timeSpan = TimeSpan(71,3,12,13);
		CxAssert((x_timeSpan.get_Ticks()).Equals((( Int64 ) 61459330000000)));
		...
		CxAssert((TimeSpan::MinValue.CompareTo(x_obj)).Equals((( Int32 ) 0)));
	...
	{
		CxAssert((DateTime().get_Ticks()).Equals((( Int64 ) 0)));
		CxAssert((DateTime(1200).get_Ticks()).Equals((( Int64 ) 1200)));
		CxAssert((DateTime(2003,7,23).get_Ticks()).Equals((( Int64 ) 631945152000000000)));
		CxAssert((DateTime(2003,7,23,12,30,30).get_Ticks()).Equals((( Int64 ) 631945602300000000)));
		DateTime x_dateTime = DateTime(2003,7,23,12,30,30,100);
		CxAssert((x_dateTime.get_Ticks()).Equals((( Int64 ) 631945602301000000)));
		CxAssert((x_dateTime.get_Date().get_Ticks()).Equals((( Int64 ) 631945152000000000)));
		Int32 x_day = x_dateTime.get_Day();
		CxAssert((x_day).Equals((( Int32 ) 23)));
		...
		CxAssert((x_dayOfYear).Equals((( Int32 ) 204)));
		Int32 x_hour = x_dateTime.get_Hour();
		CxAssert((x_hour).Equals((( Int32 ) 12)));
		Int32 x_millisecond = x_dateTime.get_Millisecond();
		CxAssert((x_millisecond).Equals((( Int32 ) 100)));
		Int32 x_minute = x_dateTime.get_Minute();
		CxAssert((x_minute).Equals((( Int32 ) 30)));
		Int32 x_month = x_dateTime.get_Month();
		CxAssert((x_month).Equals((( Int32 ) 7)));
		...
		CxAssert((x_second).Equals((( Int32 ) 30)));
		CxAssert((x_dateTime.get_TimeOfDay().get_Ticks()).Equals((( Int64 ) 450301000000)));
		...
		CxAssert((x_year).Equals((( Int32 ) 2003)));
	}
	void TimeTestRaw::DateTimeMethodTests()
	{
		DateTime x_dateTime = DateTime(2003,7,23,12,30,30,100);
		TimeSpan x_timeSpan = TimeSpan(0,2,0,0);
		CxAssert((x_dateTime.Add(x_timeSpan).get_Ticks()).Equals((( Int64 ) 631945674301000000)));
		CxAssert((x_dateTime.AddDays(1.5).get_Ticks()).Equals((( Int64 ) 631946898301000000)));
		CxAssert((x_dateTime.AddHours(2.5).get_Ticks()).Equals((( Int64 ) 631945692301000000)));
		CxAssert((x_dateTime.AddMilliseconds(159).get_Ticks()).Equals((( Int64 ) 631945602302590000)));
		CxAssert((x_dateTime.AddMinutes(3.2).get_Ticks()).Equals((( Int64 ) 631945604221000000)));
		CxAssert((x_dateTime.AddMonths(5).get_Ticks()).Equals((( Int64 ) 632077794301000000)));
		CxAssert((x_dateTime.AddSeconds(6.66).get_Ticks()).Equals((( Int64 ) 631945602367600000)));
		CxAssert((x_dateTime.AddTicks(666).get_Ticks()).Equals((( Int64 ) 631945602301000666)));
		DateTime x_dateTime2 = x_dateTime.AddYears(3);
		CxAssert((x_dateTime2.get_Ticks()).Equals((( Int64 ) 632892546301000000)));
		CxAssert(DateTimeRaw::Compare(x_dateTime2,x_dateTime) > (( Int32 ) 0));
		CxAssert(x_dateTime.CompareTo(x_dateTime2) < (( Int32 ) 0));
		CxAssert((DateTimeRaw::DaysInMonth(2003,1)).Equals((( Int32 ) 31)));
		...
		CxAssert((x_dateTime2.get_Ticks()).Equals((( Int64 ) 631945530301000000)));
		CxAssert((x_dateTime.Subtract(x_dateTime2).get_Ticks()).Equals((( Int64 ) 72000000000)));
		x_dateTime2 = x_dateTime.ToLocalTime();
		x_dateTime2 = x_dateTime.ToUniversalTime();
		x_dateTime2 = x_dateTime + x_timeSpan;
		CxAssert((x_dateTime2.get_Ticks()).Equals((( Int64 ) 631945674301000000)));
		...
		x_dateTime2 = x_dateTime - x_timeSpan;
		CxAssert((x_dateTime2.get_Ticks()).Equals((( Int64 ) 631945530301000000)));
		CxAssert((( x_dateTime - x_dateTime2 ).get_Ticks()).Equals((( Int64 ) 72000000000)));
		x_dateTime2 = DateTime(2003,7,23,14,2,30,100);
		CxAssert((x_dateTime2.get_Ticks()).Equals((( Int64 ) 631945657501000000)));
		CxAssert((x_dateTime2.get_Hour()).Equals((( Int32 ) 14)));
		...
		CxAssert((x_dateTime2.get_Ticks()).Equals((( Int64 ) 631945236011000000)));
		CxAssert((x_dateTime2.get_Hour()).Equals((( Int32 ) 2)));
		x_text.Assign(x_dateTime2.ToString());
		CxAssert(x_text->Equals((new StringRaw("7/23/2003 2:20:01 AM"))));
		CxAssert((((DateTime)0).get_Ticks()).Equals((( Int64 ) 0)));
		CxAssert((((DateTime)3155378975999999999).get_Ticks()).Equals((( Int64 ) 3155378975999999999)));
		Object x_obj = (new DateTimeBox(((DateTime)0) ));
		CxAssert((( ( DateTime ) x_obj->get_AsDateTime() ).get_Ticks()).Equals((( Int64 ) 0)));
		CxAssert(((DateTime)0).Equals(x_obj));
		CxAssert((((DateTime)0).CompareTo(x_obj)).Equals((( Int32 ) 0)));
	...
	{
		if ( MathRaw::Abs(x_x - x_y) > (( Double ) 1E-05) )
		{
	...
	Int32 TimingTestRaw::DoTimingTest(Int32 x_a,Int32 x_b,Int32 x_c)
	{
		...
		for ( Int32 x_i = (( Int32 ) 0) ;  x_i < x_a ;   x_i++ )
		{
			for ( Int32 x_j = (( Int32 ) 0) ;  x_j < x_b ;   x_j++ )
			{
	...
	void UInt16TestRaw::UInt16MethodsTest()
	{
		...
		CxAssert((x_num.CompareTo(5)).Equals((( Int32 ) 0)));
		CxAssert((x_num.CompareTo((new UInt16Box((( UInt16 ) 5) )))).Equals((( Int32 ) 0)));
		CxAssert(x_num.Equals(5));
		CxAssert(x_num.Equals((new UInt16Box((( UInt16 ) 5) ))));
		CxAssert((UInt16Raw::Parse((new StringRaw("77")))).Equals((( UInt16 ) 77)));
		CxAssert(((new StringRaw("5")))->Equals(x_num.ToString()));
		x_num = ((UInt16)65535);
		CxAssert((((UInt16)65535)).Equals(x_num));
		x_num = 0;
		CxAssert((x_num).Equals((( UInt16 ) 0)));
		String x_text = ((UInt16)65535).ToString();
		CxAssert((x_text)->Equals((new StringRaw("65535"))));
		CxAssert((UInt16Raw::Parse(x_text)).Equals(((UInt16)65535)));
		String x_text2 = ( (( UInt16 ) 0) ).ToString();
		CxAssert((x_text2)->Equals((new StringRaw("0"))));
		CxAssert((UInt16Raw::Parse(x_text2)).Equals((( UInt16 ) 0)));
	...
	void UInt16TestRaw::DoUnSignedMath()
	{
		...
		Int32 x_num3 = (( Int32 ) 1);
		CxAssert(1 <= x_num);
		CxAssert(x_num >= (( UInt16 ) 1));
		CxAssert(x_num >= x_num3);
		CxAssert(x_num3 <= x_num);
		x_num3 = x_num3 + x_num;
		CxAssert((x_num3).Equals((( Int32 ) 601)));
		CxAssert((x_num + x_num2).Equals((( Int32 ) 1800)));
		CxAssert((x_num - x_num2).Equals(-600));
		CxAssert((x_num * x_num2).Equals((( Int32 ) 720000)));
		CxAssert((x_num2 / x_num).Equals((( Int32 ) 2)));
		CxAssert((x_num >> (( UInt16 ) 2)).Equals((( Int32 ) 150)));
		CxAssert((x_num << (( UInt16 ) 1)).Equals((( Int32 ) 1200)));
		Int32 x_num4 = (( Int32 ) 11);
		CxAssert((x_num4 % (( Int32 ) 5)).Equals((( Int32 ) 1)));
		x_num4 = 8;
		CxAssert(( x_num4 | (( Int32 ) 1) ) == 9);
		CxAssert(( x_num4 & (( Int32 ) 1) ) == 0);
		CxAssert((++x_num4).Equals((( Int32 ) 9)));
		CxAssert((--x_num4).Equals((( Int32 ) 8)));
		...
		CxAssert(( x_num4 = x_num4 & 4 ) == 4);
		CxAssert((-x_num).Equals(-600));
		CxAssert((x_num).Equals((( UInt16 ) 600)));
		UInt32 x_num5 = (( UInt32 ) 0);
		CxAssert((~x_num5).Equals(((UInt32)4294967295)));
		CxAssert((++x_num5).Equals((( UInt32 ) 1)));
		CxAssert((--x_num5).Equals((( UInt32 ) 0)));
	}
	void UInt16TestRaw::UInt16Operators()
	{
		...
		Int64 x_num4 = (( Int64 ) 1);
		Double x_num5 = (( Double ) 1);
		CxAssert((x_num).Equals((( UInt16 ) 66)));
		CxAssert((x_num + x_c).Equals((( Int32 ) 67)));
		CxAssert((x_num + x_num2).Equals((( Int32 ) 67)));
		CxAssert((x_num + x_num3).Equals((( Int32 ) 67)));
		CxAssert((x_num + x_num4).Equals((( Int64 ) 67)));
		...
		CxAssert(x_num4 > x_num,false);
		CxAssert(x_num5 > x_num,false);
		CxAssert(( x_num = ( UInt16 ) ( x_num + (( UInt16 ) 1) ) ) == 67);
		CxAssert(( x_num = ( UInt16 ) ( x_num - (( UInt16 ) 1) ) ) == 66);
		CxAssert((x_num++).Equals((( UInt16 ) 66)));
		CxAssert((x_num--).Equals((( UInt16 ) 67)));
		CxAssert((x_num << (( UInt16 ) 1)).Equals((( Int32 ) 132)));
		CxAssert((x_num >> (( UInt16 ) 1)).Equals((( Int32 ) 33)));
		CxAssert((x_c).Equals(x_num),false);
		CxAssert((x_num2).Equals(x_num),false);
		CxAssert((x_num3).Equals(x_num),false);
		CxAssert((x_num4).Equals(x_num),false);
		...
		CxAssert(( x_num = ( UInt16 ) ( x_num ^ x_num3 ) ) == 67);
		x_num = 66;
		CxAssert(( x_num = ( UInt16 ) ( x_num << x_c ) ) == 132);
		x_num = 66;
		CxAssert(( x_num = ( UInt16 ) ( x_num << x_num2 ) ) == 132);
		x_num = 66;
		CxAssert(( x_num = ( UInt16 ) ( x_num >> x_c ) ) == 33);
		x_num = 66;
	...
	void UInt16TestRaw::UInt16MiscTests()
	{
		...
		CxAssert((MathRaw::Max(x_num,x_num2)).Equals((( UInt16 ) 1)));
		CxAssert((MathRaw::Min(x_num,x_num2)).Equals((( UInt16 ) 0)));
		PointerType<StringBuilderRaw> x_stringBuilder = new StringBuilderRaw();
	...
	void UInt32TestRaw::UInt32MethodsTest()
	{
		...
		CxAssert((x_num.CompareTo(5)).Equals((( Int32 ) 0)));
		CxAssert((x_num.CompareTo((new UInt32Box(5 )))).Equals((( Int32 ) 0)));
		CxAssert(x_num.Equals(5));
		CxAssert(x_num.Equals((new UInt32Box(5 ))));
		CxAssert((UInt32Raw::Parse((new StringRaw("77")))).Equals((( UInt32 ) 77)));
		CxAssert(((new StringRaw("5")))->Equals(x_num.ToString()));
		x_num = ((UInt32)4294967295);
		CxAssert((-1).Equals(x_num));
		x_num = 0;
		CxAssert((x_num).Equals((( UInt32 ) 0)));
		String x_text = ((UInt32)4294967295).ToString();
		CxAssert((x_text)->Equals((new StringRaw("4294967295"))));
		CxAssert((UInt32Raw::Parse(x_text)).Equals(((UInt32)4294967295)));
		String x_text2 = (( UInt32 ) 0).ToString();
		CxAssert((x_text2)->Equals((new StringRaw("0"))));
		CxAssert((UInt32Raw::Parse(x_text2)).Equals((( UInt32 ) 0)));
	...
	void UInt32TestRaw::DoUnSignedMath()
	{
		...
		Int32 x_num3 = (( Int32 ) 1);
		CxAssert(1 <= x_num);
		CxAssert(x_num >= (( UInt32 ) 1));
		CxAssert(x_num >= x_num3);
		CxAssert(x_num3 <= x_num);
		x_num3 = x_num3 + x_num;
		CxAssert((x_num3).Equals((( Int32 ) 60001)));
		CxAssert((x_num + x_num2).Equals((( UInt32 ) 180000)));
		CxAssert((x_num - x_num2).Equals((( UInt32 ) 4294907296)));
		CxAssert((x_num * x_num2).Equals((( UInt32 ) 2905032704)));
		CxAssert((x_num2 / x_num).Equals((( UInt32 ) 2)));
		CxAssert((x_num >> (( UInt32 ) 2)).Equals((( UInt32 ) 15000)));
		CxAssert((x_num << (( UInt32 ) 1)).Equals((( UInt32 ) 120000)));
		Int32 x_num4 = (( Int32 ) 11);
		CxAssert((x_num4 % (( Int32 ) 5)).Equals((( Int32 ) 1)));
		x_num4 = 8;
		CxAssert(( x_num4 | (( Int32 ) 1) ) == 9);
		...
		CxAssert((x_num).Equals((( UInt32 ) 60000)));
		UInt32 x_num5 = (( UInt32 ) 0);
		CxAssert((~x_num5).Equals(((UInt32)4294967295)));
		CxAssert((++x_num5).Equals((( UInt32 ) 1)));
		CxAssert((--x_num5).Equals((( UInt32 ) 0)));
	...
	void UInt32TestRaw::UInt32Operators()
	{
		...
		Int64 x_num4 = (( Int64 ) 1);
		Double x_num5 = (( Double ) 1);
		CxAssert((x_num).Equals((( UInt32 ) 66)));
		CxAssert((x_num + x_c).Equals((( UInt32 ) 67)));
		CxAssert((x_num + x_num2).Equals((( Int64 ) 67)));
		CxAssert((x_num + x_num3).Equals((( UInt32 ) 67)));
		CxAssert((x_num + x_num4).Equals((( Int64 ) 67)));
		CxAssert((x_num + x_num5).Equals((( Double ) 67)));
		CxAssert((x_num - x_c).Equals((( UInt32 ) 65)));
		CxAssert((x_num - x_num2).Equals((( Int64 ) 65)));
		CxAssert((x_num - x_num3).Equals((( UInt32 ) 65)));
		CxAssert((x_num - x_num4).Equals((( Int64 ) 65)));
		CxAssert((x_num - x_num5).Equals((( Double ) 65)));
		CxAssert((x_num * x_c).Equals((( UInt32 ) 66)));
		CxAssert((x_num * x_num2).Equals((( Int64 ) 66)));
		CxAssert((x_num * x_num3).Equals((( UInt32 ) 66)));
		CxAssert((x_num * x_num4).Equals((( Int64 ) 66)));
		CxAssert((x_num * x_num5).Equals((( Double ) 66)));
		CxAssert((x_num / x_c).Equals((( UInt32 ) 66)));
		CxAssert((x_num / x_num2).Equals((( Int64 ) 66)));
		...
		CxAssert((x_num / x_num4).Equals((( Int64 ) 66)));
		CxAssert((x_num / x_num5).Equals((( Double ) 66)));
		CxAssert((x_num % x_c).Equals((( UInt32 ) 0)));
		CxAssert((x_num % x_num2).Equals((( Int64 ) 0)));
		CxAssert((x_num % x_num3).Equals((( UInt32 ) 0)));
		CxAssert((x_num % x_num4).Equals((( Int64 ) 0)));
		CxAssert((x_num % x_num5).Equals((( Double ) 0)));
		CxAssert(( x_num & x_c ) == 0);
		CxAssert(( x_num & x_num2 ) == 0);
		...
		CxAssert(( x_num ^ x_num3 ) == 67);
		CxAssert(( x_num ^ x_num4 ) == 67);
		CxAssert((~x_num).Equals((( UInt32 ) 4294967229)));
		CxAssert(x_c < x_num);
		CxAssert(x_num2 < x_num);
		CxAssert(x_num3 < x_num);
		CxAssert(x_num4 < x_num);
		...
		CxAssert(x_num4 > x_num,false);
		CxAssert(x_num5 > x_num,false);
		CxAssert((++x_num).Equals((( UInt32 ) 67)));
		CxAssert((--x_num).Equals((( UInt32 ) 66)));
		CxAssert((x_num++).Equals((( UInt32 ) 66)));
		CxAssert((x_num--).Equals((( UInt32 ) 67)));
		CxAssert((x_num << (( UInt32 ) 1)).Equals((( UInt32 ) 132)));
		CxAssert((x_num >> (( UInt32 ) 1)).Equals((( UInt32 ) 33)));
		CxAssert((x_c).Equals(x_num),false);
		CxAssert((x_num2).Equals(x_num),false);
		CxAssert((x_num3).Equals(x_num),false);
		CxAssert((x_num4).Equals(x_num),false);
	...
	void UInt32TestRaw::UInt32MiscTests()
	{
		...
		CxAssert((MathRaw::Max(x_val,x_num)).Equals((( UInt32 ) 1)));
		CxAssert((MathRaw::Min(x_val,x_num)).Equals((( UInt32 ) 0)));
		PointerType<StringBuilderRaw> x_stringBuilder = new StringBuilderRaw();
		x_stringBuilder->Append(x_num);
		CxAssert((x_stringBuilder->ToString())->Equals((new StringRaw("1"))));
	}
	...
	void UInt64TestRaw::UInt64MethodsTest()
	{
		...
		CxAssert((x_num.CompareTo(5)).Equals((( Int32 ) 0)));
		CxAssert((x_num.CompareTo((new UInt64Box(5 )))).Equals((( Int32 ) 0)));
		CxAssert(x_num.Equals(5));
		CxAssert(x_num.Equals((new UInt64Box(5 ))));
		CxAssert((UInt64Raw::Parse((new StringRaw("77")))).Equals((( UInt64 ) 77)));
		CxAssert(((new StringRaw("5")))->Equals(x_num.ToString()));
		x_num = ((UInt64)18446744073709551615);
		CxAssert((((UInt64)18446744073709551615)).Equals(x_num));
		x_num = 0;
		CxAssert((x_num).Equals((( UInt64 ) 0)));
		String x_text = ((UInt64)18446744073709551615).ToString();
		CxAssert((x_text)->Equals((new StringRaw("18446744073709551615"))));
		CxAssert((UInt64Raw::Parse(x_text)).Equals(((UInt64)18446744073709551615)));
		String x_text2 = (( UInt64 ) 0).ToString();
		CxAssert((x_text2)->Equals((new StringRaw("0"))));
		CxAssert((UInt64Raw::Parse(x_text2)).Equals((( UInt64 ) 0)));
	...
	void UInt64TestRaw::UInt64UnSignedMath()
	{
		...
		CxAssert(1 <= x_num);
		CxAssert(x_num >= (( UInt64 ) 1));
		CxAssert(x_num >= x_num3);
		CxAssert(x_num3 <= x_num);
		x_num3 = x_num3 + x_num;
		CxAssert((x_num3).Equals((( UInt64 ) 60001)));
		CxAssert((x_num + x_num2).Equals((( UInt64 ) 180000)));
		UInt64 x_num4 = x_num - x_num2;
		CxAssert((x_num - x_num2).Equals((( UInt64 ) 18446744073709491616)));
		UInt64 x_num5 = x_num * x_num2;
		CxAssert((x_num * x_num2).Equals((( UInt64 ) 7200000000)));
		CxAssert((x_num2 / x_num).Equals((( UInt64 ) 2)));
		CxAssert((x_num >> (( UInt64 ) 2)).Equals((( UInt64 ) 15000)));
		CxAssert((x_num << (( UInt64 ) 1)).Equals((( UInt64 ) 120000)));
		Int32 x_num6 = (( Int32 ) 11);
		CxAssert((x_num6 % (( Int32 ) 5)).Equals((( Int32 ) 1)));
		x_num6 = 8;
		CxAssert(( x_num6 | (( Int32 ) 1) ) == 9);
		CxAssert(( x_num6 & (( Int32 ) 1) ) == 0);
		CxAssert((++x_num6).Equals((( Int32 ) 9)));
		CxAssert((--x_num6).Equals((( Int32 ) 8)));
		CxAssert(( x_num6 = x_num6 * 2 ) == 16);
		CxAssert(( x_num6 = x_num6 / 2 ) == 8);
		CxAssert(( x_num6 = x_num6 % 2 ) == 0);
		CxAssert(( x_num6 = x_num6 | 4 ) == 4);
		CxAssert(( x_num6 = x_num6 & 4 ) == 4);
		CxAssert((x_num).Equals((( UInt64 ) 60000)));
		UInt32 x_num7 = (( UInt32 ) 0);
		CxAssert((~x_num7).Equals(((UInt32)4294967295)));
		CxAssert((++x_num7).Equals((( UInt32 ) 1)));
		CxAssert((--x_num7).Equals((( UInt32 ) 0)));
	}
	void UInt64TestRaw::UInt64Operators()
	{
		...
		CxAssert((x_num).Equals((( UInt64 ) 66)));
		CxAssert((x_num + x_c).Equals((( UInt64 ) 67)));
		CxAssert((x_num + x_b).Equals((( UInt64 ) 67)));
		CxAssert((x_num + x_b2).Equals((( Int64 ) 67)));
		CxAssert((x_num + x_num2).Equals((( Int64 ) 67)));
		CxAssert((x_num + x_num3).Equals((( Int64 ) 67)));
		CxAssert((x_num + x_num4).Equals((( Int64 ) 67)));
		CxAssert((x_num + x_num5).Equals((( UInt64 ) 67)));
		CxAssert((x_num + x_num6).Equals((( UInt64 ) 67)));
		CxAssert((x_num + x_num7).Equals((( UInt64 ) 67)));
		CxAssert((x_num + x_num8).Equals((( Single ) 67)));
		CxAssert((x_num + x_num9).Equals((( Double ) 67)));
		CxAssert((x_num - x_c).Equals((( UInt64 ) 65)));
		CxAssert((x_num - x_b).Equals((( UInt64 ) 65)));
		CxAssert((x_num - x_b2).Equals((( Int64 ) 65)));
		CxAssert((x_num - x_num2).Equals((( Int64 ) 65)));
		CxAssert((x_num - x_num3).Equals((( Int64 ) 65)));
		CxAssert((x_num - x_num4).Equals((( Int64 ) 65)));
		CxAssert((x_num - x_num5).Equals((( UInt64 ) 65)));
		CxAssert((x_num - x_num6).Equals((( UInt64 ) 65)));
		CxAssert((x_num - x_num7).Equals((( UInt64 ) 65)));
		CxAssert((x_num - x_num8).Equals((( Single ) 65)));
		CxAssert((x_num - x_num9).Equals((( Double ) 65)));
		CxAssert((x_num * x_c).Equals((( UInt64 ) 66)));
		CxAssert((x_num * x_b).Equals((( UInt64 ) 66)));
		CxAssert((x_num * x_b2).Equals((( Int64 ) 66)));
		CxAssert((x_num * x_num2).Equals((( Int64 ) 66)));
		CxAssert((x_num * x_num3).Equals((( Int64 ) 66)));
		CxAssert((x_num * x_num4).Equals((( Int64 ) 66)));
		CxAssert((x_num * x_num5).Equals((( UInt64 ) 66)));
		CxAssert((x_num * x_num6).Equals((( UInt64 ) 66)));
		CxAssert((x_num * x_num7).Equals((( UInt64 ) 66)));
		CxAssert((x_num * x_num8).Equals((( Single ) 66)));
		CxAssert((x_num * x_num9).Equals((( Double ) 66)));
		CxAssert((x_num / x_c).Equals((( UInt64 ) 66)));
		CxAssert((x_num / x_b).Equals((( UInt64 ) 66)));
		CxAssert((x_num / x_b2).Equals((( UInt64 ) 66)));
		CxAssert((x_num / x_num2).Equals((( UInt64 ) 66)));
		CxAssert((x_num / x_num3).Equals((( UInt64 ) 66)));
		CxAssert((x_num / x_num4).Equals((( UInt64 ) 66)));
		CxAssert((x_num / x_num5).Equals((( UInt64 ) 66)));
		CxAssert((x_num / x_num6).Equals((( UInt64 ) 66)));
		CxAssert((x_num / x_num7).Equals((( UInt64 ) 66)));
		CxAssert((x_num / x_num8).Equals((( Single ) 66)));
		CxAssert((x_num / x_num9).Equals((( Double ) 66)));
		CxAssert((x_num % x_c).Equals((( UInt64 ) 0)));
		CxAssert((x_num % x_b).Equals((( UInt64 ) 0)));
		CxAssert((x_num % x_b2).Equals((( UInt64 ) 0)));
		CxAssert((x_num % x_num2).Equals((( UInt64 ) 0)));
		CxAssert((x_num % x_num3).Equals((( UInt64 ) 0)));
		CxAssert((x_num % x_num4).Equals((( UInt64 ) 0)));
		CxAssert((x_num % x_num5).Equals((( UInt64 ) 0)));
		CxAssert((x_num % x_num6).Equals((( UInt64 ) 0)));
		CxAssert((x_num % x_num7).Equals((( UInt64 ) 0)));
		CxAssert((x_num % x_num8).Equals((( Single ) 0)));
		CxAssert((x_num % x_num9).Equals((( Double ) 0)));
		CxAssert(( x_num & x_c ) == 0);
		CxAssert(( x_num & x_b ) == 0);
		CxAssert(( x_num & x_b2 ) == 0);
		CxAssert(( x_num & x_num2 ) == 0);
		...
		CxAssert(( x_num ^ x_num6 ) == 67);
		CxAssert(( x_num ^ x_num7 ) == 67);
		CxAssert((( Byte ) ( ~x_num )).Equals((( Byte ) 189)));
		CxAssert(x_c < x_num);
		CxAssert(x_b < x_num);
		CxAssert(x_b2 < x_num);
		CxAssert(x_num2 < x_num);
		...
		CxAssert((++x_num).Equals((( UInt64 ) 67)));
		CxAssert((--x_num).Equals((( UInt64 ) 66)));
		CxAssert((x_num++).Equals((( UInt64 ) 66)));
		CxAssert((x_num--).Equals((( UInt64 ) 67)));
		CxAssert((x_num << (( UInt64 ) 1)).Equals((( UInt64 ) 132)));
		CxAssert((x_num >> (( UInt64 ) 1)).Equals((( UInt64 ) 33)));
		CxAssert((x_c).Equals(x_num),false);
		CxAssert((x_b).Equals(x_num),false);
		CxAssert((x_b2).Equals(x_num),false);
		CxAssert((x_num2).Equals(x_num),false);
		...
		CxAssert((x_num7).Equals(x_num),false);
		CxAssert((x_num8).Equals(x_num),false);
		CxAssert((x_num9).Equals(x_num),false);
		CxAssert(!(x_c).Equals(x_num));
		CxAssert(!(x_b).Equals(x_num));
		CxAssert(!(x_b2).Equals(x_num));
		CxAssert(!(x_num2).Equals(x_num));
	...
	void UInt64TestRaw::UInt64MiscTests()
	{
		...
		CxAssert((MathRaw::Max(x_num,x_num2)).Equals((( UInt64 ) 1)));
		CxAssert((MathRaw::Min(x_num,x_num2)).Equals((( UInt64 ) 0)));
		PointerType<StringBuilderRaw> x_stringBuilder = new StringBuilderRaw();
		x_stringBuilder->Append(x_num2);
		CxAssert((x_stringBuilder->ToString())->Equals((new StringRaw("1"))));
		x_stringBuilder->Insert(1,x_num);
