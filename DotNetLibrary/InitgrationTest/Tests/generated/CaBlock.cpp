...
namespace CABlock_NS
{
	...
	void BigEndianBitConverterTestRaw::Test()
	{
		...
		CxAssert(BigEndianBitConverterRaw::ToChar(x_array,1).Equals('A'));
		CxAssert(BigEndianBitConverterRaw::ToDouble(x_array,3).Equals(66.66));
		CxAssert(BigEndianBitConverterRaw::ToInt16(x_array,11).Equals(6666));
		CxAssert(BigEndianBitConverterRaw::ToInt32(x_array,13).Equals(-6666));
		CxAssert(BigEndianBitConverterRaw::ToInt64(x_array,17).Equals(666666666));
		CxAssert(( Double ) BigEndianBitConverterRaw::ToSingle(x_array,25).Equals(55));
		CxAssert(BigEndianBitConverterRaw::ToUInt16(x_array,29).Equals(5555));
		CxAssert(BigEndianBitConverterRaw::ToUInt32(x_array,31).Equals(5555555));
		CxAssert(BigEndianBitConverterRaw::ToUInt64(x_array,35).Equals(555555555));
		CxAssert(BigEndianBitConverterRaw::DoubleToInt64Bits(7777).Equals(4665272916630306816));
		CxAssert(BigEndianBitConverterRaw::Int64BitsToDouble(4665272916630306816).Equals(7777));
	...
	void BigEndianBitConverterTestRaw::CompareBits(PointerType<ArrayRaw<Byte>> x_converted,Int32 x_startingIndex,PointerType<ArrayRaw<Byte>> x_bytes)
	{
		...
		{
			CxAssert((*x_converted->Address(x_i)).Equals((*x_bytes->Address(x_i + x_startingIndex))));
		}
	}
	...
	void BooleanTestRaw::BoolOperators()
	{
		...
		x_flag = ( !( Byte ) x_num.Equals(0) );
		CxAssert(!( Byte ) x_num.Equals(0));
		CxAssert(x_flag = x_flag);
	}
	...
	void BufferTestRaw::Test()
	{
		...
		{
			if ( !(*x_in1dArray->Address(x_i)).Equals((*x_out1dArray->Address(x_i))) )
			{
				x_x = false;
				break;
			}
	...
	void ByteTestRaw::ByteMethodsTest()
	{
		...
		CxAssert(((Byte)x_b).CompareTo(( Object ) ( Byte ) 5).Equals(0));
	...
	void DoubleTestRaw::DoDoubleMethodsTest()
	{
		...
		CxAssert(((Double)x_num).CompareTo(( Object ) 3.159).Equals(0));
	...
	void Int16TestRaw::Int16MethodsTest()
	{
		...
		CxAssert(((Int16)x_num).CompareTo(( Object ) ( Int16 ) 5).Equals(0));
	...
	void Int32TestRaw::Int32MethodsTest()
	{
		...
		CxAssert(((Int32)x_num).CompareTo(( Object ) 5).Equals(0));
	...
	void Int64TestRaw::Int64MethodsTest()
	{
		...
		CxAssert(((Int64)x_num).CompareTo(( Object ) 5).Equals(0));
	...
	void SByteTestRaw::SByteMethodsTest()
	{
		...
		CxAssert(((SByte)x_b).CompareTo(( Object ) ( SByte ) 5).Equals(0));
	...
	void SingleTestRaw::DoSingleMethodsTest()
	{
		...
		CxAssert(((Single)x_num).CompareTo(( Object ) 3.159).Equals(0));
		...
		CxAssert(( UInt32 ) x_num.Equals(10000));
		Object x_obj = x_num;
		CxAssert(( Double ) ( Float ) x_obj.Equals(10000));
		x_num = Float::Epsilon;
...
','"',''','Â'};
	...
	void TimeTestRaw::TestTimeSpan()
	{
		...
		CxAssert(( ( TimeSpan ) x_obj ).get_Ticks().Equals(TimeSpan::MinValue.get_Ticks()));
	...
	void TimeTestRaw::DateTimeMethodTests()
	{
		...
		Object x_obj = 0;
		CxAssert(( ( DateTime ) x_obj ).get_Ticks().Equals(0));
	...
	void UInt16TestRaw::UInt16MethodsTest()
	{
		...
		CxAssert(((UInt16)x_num).CompareTo(( Object ) ( UInt16 ) 5).Equals(0));
	...
	void UInt32TestRaw::UInt32MethodsTest()
	{
		...
		CxAssert(((UInt32)x_num).CompareTo(( Object ) 5).Equals(0));
	...
	void UInt64TestRaw::UInt64MethodsTest()
	{
		...
		CxAssert(((UInt64)x_num).CompareTo(( Object ) 5).Equals(0));
